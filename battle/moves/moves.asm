...
if DEF(FAITHFUL)
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         90, NORMAL,    100, 15,   0, PHYSICAL
endc
	...
	move FIRE_SPIN,    EFFECT_TRAP,               15, FIRE,       85, 35,   0, SPECIAL
...
endc
	...
	move METAL_SOUND,  EFFECT_SP_DEF_DOWN_2,       0, STEEL,      85, 40,   0, STATUS
...
if DEF(FAITHFUL)
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,      95, 10,  50, SPECIAL
endc
...
if DEF(FAITHFUL)
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING,  100, 15,  50, PHYSICAL
endc
	move WHIRLPOOL,    EFFECT_TRAP,               35, WATER,      70, 15,   0, SPECIAL
