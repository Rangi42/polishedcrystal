...
UniqueWildMoves:
	...
	db GROUP_QUIET_CAVE_B1F, MAP_QUIET_CAVE_B1F, MAGIKARP, DRAGON_RAGE, DRAGON_RAGE
	db GROUP_QUIET_CAVE_B2F, MAP_QUIET_CAVE_B2F, MAGIKARP, DRAGON_RAGE, DRAGON_RAGE
	db GROUP_QUIET_CAVE_B3F, MAP_QUIET_CAVE_B3F, MAGIKARP, DRAGON_RAGE, DRAGON_RAGE
	db -1, -1, -1, -1, -1
