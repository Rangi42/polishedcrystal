...
.Sprites:
	...
	db SPRITE_LAWRENCE
	db SPRITE_GIOVANNI
	db SPRITE_COOLTRAINER_M ; TODO: STEVEN
	db SPRITE_COOLTRAINER_F ; TODO: CYNTHIA
	db SPRITE_COOLTRAINER_M ; TODO: TOWERTYCOON
	db SPRITE_COOLTRAINER_F ; TODO: VALERIE
	db SPRITE_SABRINA
