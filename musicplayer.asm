...
SongInfo:
	...
	db "Viridian City@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	...
	db "Victory! Champion@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	...
	db "Professor Oak@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	...
	db "Vs. Rocket Grunt@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	db "Elm's Lab@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	db "Dark Cave@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	...
	db "Ruins of Alph Inside@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	db "Team Rocket@", ORIGIN_GS, COMPOSER_GO_ICHINOSE, 0
	db "Dancing Hall@", ORIGIN_GS, COMPOSER_GO_ICHINOSE, 0
	db "Bug Contest Ranking@", ORIGIN_GS, COMPOSER_GO_ICHINOSE, 0
	db "Bug Contest@", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, 0
	...
	db "Nugget Bridge@", ORIGIN_HGSS, COMPOSER_JUNICHI_MASUDA, COMPOSER_FROGGESTSPIRIT
	...
	db "Vs. World Championship Finals@", ORIGIN_B2W2, COMPOSER_JUNICHI_MASUDA, COMPOSER_PIGU
