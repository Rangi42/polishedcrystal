...
.enemy_hp_bar
	lb bc, $80 | palette PAL_BATTLE_BG_ENEMY_HP color 2, 0
	ld hl, wBGPals2 palette PAL_BATTLE_BG_ENEMY_HP color 2
	jr .finish

.player_hp_bar
	lb bc, $80 | palette PAL_BATTLE_BG_PLAYER_HP color 2, 1
	ld hl, wBGPals2 palette PAL_BATTLE_BG_PLAYER_HP palettes color 2
.finish
	xor a
	ldh [hCGBPalUpdate], a
	ld a, c
