...
TMHMMoves: ; 1167a
	...
	db BULLDOZE     ; MT03 (TODO: Mt. Mortar)
	db COUNTER      ; MT04 (Celadon Dept. Store)
	db DEFENSE_CURL ; MT05 (TODO: ?)
	db DOUBLE_EDGE  ; MT06 (Safari Zone)
	db DREAM_EATER  ; MT07 (Viridian City)
	db EARTH_POWER  ; MT08 (Cherrygrove Bay)
	db FIRE_PUNCH   ; MT09 (Goldenrod City)
	db HEADBUTT     ; MT10 (Ilex Forest)
	db HYPER_VOICE  ; MT11 (Goldenrod Harbor)
	db ICE_PUNCH    ; MT12 (Goldenrod City)
	db ICY_WIND     ; MT13 (Ice Path)
	db IRON_HEAD    ; MT14 (Route 4)
	...
	db SUBSTITUTE   ; MT20 (Dim Cave)
	db SUCKER_PUNCH ; MT21 (Scary Cave)
	db SWAGGER      ; MT22 (Celadon City)
	db THUNDERPUNCH ; MT23 (Goldenrod City)
	db VOLT_SWITCH  ; MT24 (Vermilion City)
	db WATER_PULSE  ; MT25 (Battle Tower)
	db ZAP_CANNON   ; MT26 (Power Plant)
	db ZEN_HEADBUTT ; MT27 (Saffron City)
