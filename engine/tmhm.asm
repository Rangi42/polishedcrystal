...
TMHMMoves: ; 1167a
	...
	db VOLT_SWITCH  ; TM67 (TODO: Dim/Scary Cave)
	...
	db WATERFALL    ; HM05 (Ice Path)
	db WHIRLPOOL    ; HM06 (Route 42)
	db AQUA_TAIL    ; MT01 (Route 4)
	db BODY_SLAM    ; MT02 (TODO: Fuchsia City, in Safari Zone HQ)
	...
	db ROLLOUT      ; MT14 (Route 46)
	db SEED_BOMB    ; MT15 (Yellow Forest)
	db SEISMIC_TOSS ; MT16 (Pewter City)
	db SLEEP_TALK   ; MT17 (Route 31)
	db SUBSTITUTE   ; MT18 (TODO: Cerulean Cape, on sandbar)
	db SWAGGER      ; MT19 (Celadon City)
	db THUNDERPUNCH ; MT20 (Goldenrod City)
	db WATER_PULSE  ; MT21 (Battle Tower)
	db ZAP_CANNON   ; MT22 (Power Plant)
	db ZEN_HEADBUTT ; MT23 (Saffron City)
