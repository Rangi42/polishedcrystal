...
TMHMMoves: ; 1167a
	...
	db HONE_CLAWS   ; TM12 (TODO: Route 35)
	...
	db FLASH_CANNON ; TM34 (TODO: Route 9)
	...
	db ENERGY_BALL  ; TM53 (TODO: Olivine Lighthouse)
