...
TMHMMoves: ; 1167a
	...
	db VENOSHOCK    ; TM09 (TODO: Route 11) (like HGSS)
	...
	db SUBSTITUTE   ; TM41 (TODO: Route 8) (like HGSS)
	...
	db SCALD        ; TM55 (TODO: Route 19) (like HGSS)
	...
	db VOLT_SWITCH  ; TM72 (TODO: Route 39) (like HGSS)
	db THUNDER_WAVE ; TM73 (Rock Tunnel)
	db BULLDOZE     ; TM74 (TODO: Route 10) (like HGSS)
	...
	db KNOCK_OFF    ; MT14 (TODO: Route 40) (like HGSS's TM)
