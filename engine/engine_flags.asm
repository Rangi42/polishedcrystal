...
ENDM
	...
	engine_flag StatusFlags2, 2 ; bug contest timer ; $10
	...
	engine_flag BikeFlags, 2 ; downhill (cycling road) ; $18
	...
	engine_flag JohtoBadges, 7 ; risingbadge ; $20
	...
	engine_flag KantoBadges, 7 ; earthbadge ; $28
	...
	engine_flag UnlockedUnowns, 5 ; 6
	engine_flag UnlockedUnowns, 6 ; 7
	engine_flag UnlockedUnowns, 7 ; 8 ; $30
	...
	engine_flag VisitedSpawns, 7     ; vermilion ; $38
	...
	engine_flag VisitedSpawns + 1, 7 ; cherrygrove ; $40
	...
	engine_flag VisitedSpawns + 2, 7 ; mahogany ; $48
	...
	engine_flag DailyFlags, 1 ; daily bug contest?
	engine_flag DailyFlags, 2 ; special wilddata?
	engine_flag DailyFlags, 3 ; valeries morning walk ; $50
	...
	engine_flag DailyFlags2, 3 ; daily photograph ; $58
	...
	engine_flag DailyFlags3, 1 ; unused
	engine_flag DailyFlags3, 2 ; unused
	engine_flag DailyFlags3, 3 ; unused ; $60
	...
	engine_flag WeeklyFlags, 3 ; goldenrod mall happiness event floor05 person07 ; $68
	...
	engine_flag PlayerGender, 0 ; player is female ; $70
	...
	engine_flag wDailyRematchFlags, 6 ; joey ; $78
	...
	engine_flag wDailyRematchFlags + 1, 6 ; alan ; $80
	...
	engine_flag wDailyRematchFlags + 2, 6 ; parry ; $88
	...
	engine_flag wDailyPhoneItemFlags, 6 ; derek has nugget ; $90
	...
	engine_flag wDailyPhoneTimeOfDayFlags, 4 ; jose saturday night ; $98
	...
	engine_flag wDailyPhoneTimeOfDayFlags + 1, 2 ; anthony fiday night
	engine_flag wDailyPhoneTimeOfDayFlags + 1, 3 ; todd saturday morning
	engine_flag wDailyPhoneTimeOfDayFlags + 1, 4 ; gina sunday afternoon ; $a0
	...
	engine_flag wDailyPhoneTimeOfDayFlags + 2, 2 ; brent monday morning
	engine_flag wDailyPhoneTimeOfDayFlags + 2, 3 ; tiffany tuesday afternoon
	engine_flag wDailyPhoneTimeOfDayFlags + 2, 4 ; vance wednesday night ; $a8
	...
	engine_flag SwarmFlags, 3 ; yanma swarm ; $ae
