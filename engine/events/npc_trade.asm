...
ConnectLinkCableText:
	...
	text_jump _NPCTradeCableText
	text_end

TradedForText:
	; traded givemon for getmon
	text_jump Text_NPCTraded
	start_asm
	ld de, MUSIC_NONE
	call PlayMusic
	call DelayFrame
