...
; ZINC
	item_attribute 9800, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RARE CANDY
	item_attribute 4800, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP UP
	item_attribute 9800, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PP MAX
	item_attribute 9800, 0, 0, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; LEMONADE
	item_attribute 400, 0, 70, CANT_SELECT, MEDICINE, ITEMMENU_PARTY, ITEMMENU_PARTY
; MOOMOO MILK
...
; X DEFEND
	item_attribute 1100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; X SPEED
...
; # DOLL
	item_attribute 1000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; ABILITY CAP.
	item_attribute 10000, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; LEAF STONE
...
; QUICK CLAW
	item_attribute 100, HELD_QUICK_CLAW, 48, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; KING'S ROCK
...
; QUICK POWDER
	item_attribute 10, HELD_QUICK_POWDER, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ARMOR SUIT
	item_attribute 0, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AIR BALLOON
	item_attribute 200, HELD_AIR_BALLOON, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ASSAULT VEST
	item_attribute 1000, HELD_ASSAULT_VEST, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BIG ROOT
	item_attribute 200, HELD_BIG_ROOT, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BINDING BAND
	item_attribute 200, HELD_BINDING_BAND, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DESTINY KNOT
	item_attribute 200, HELD_DESTINY_KNOT, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EVIOLITE
	item_attribute 200, HELD_EVIOLITE, 50, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXPERT BELT
	item_attribute 200, HELD_EXPERT_BELT, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS SASH
	item_attribute 200, HELD_FOCUS_SASH, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GRIP CLAW
	item_attribute 200, HELD_PROLONG_WRAP, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIFE ORB
	item_attribute 200, HELD_LIFE_ORB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIGHT CLAY
	item_attribute 200, HELD_PROLONG_SCREENS, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METRONOME
	item_attribute 1000, HELD_METRONOME, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MUSCLE BAND
	item_attribute 200, HELD_PHYSICAL_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PROTECT PADS
	item_attribute 200, HELD_PROTECTIVE_PADS, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ROCKY HELMET
	item_attribute 200, HELD_ROCKY_HELMET, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SAFE GOGGLES
	item_attribute 1000, HELD_SAFETY_GOGGLES, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHED SHELL
	item_attribute 100, HELD_SHED_SHELL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHELL BELL
	item_attribute 200, HELD_SHELL_BELL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SOOTHE BELL
	item_attribute 100, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WEAK POLICY
...
; ZOOM LENS
	item_attribute 200, HELD_ZOOM_LENS, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MENTAL HERB
	item_attribute 100, HELD_MENTAL_HERB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POWER HERB
	item_attribute 100, HELD_POWER_HERB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHITE HERB
	item_attribute 100, HELD_WHITE_HERB, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DAMP ROCK
	item_attribute 200, HELD_PROLONG_RAIN, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HEAT ROCK
	item_attribute 200, HELD_PROLONG_SUN, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOOTH ROCK
	item_attribute 200, HELD_PROLONG_SANDSTORM, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ICY ROCK
	item_attribute 200, HELD_PROLONG_HAIL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE BAND
	item_attribute 100, HELD_CHOICE_ATK, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE SCARF
	item_attribute 200, HELD_CHOICE_SPD, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHOICE SPECS
	item_attribute 200, HELD_CHOICE_SAT, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FLAME ORB
	item_attribute 200, HELD_SELF_BRN, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TOXIC ORB
	item_attribute 200, HELD_SELF_PSN, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BLACK SLUDGE
...
; BALMMUSHROOM
	item_attribute 12500, 0, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PEARL
