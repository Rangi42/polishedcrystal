...
* SoupPotato (aka SourApple) for many Pokémon sprites, move animations, the Ace Duo and Soldier sprites, and overworld weather sprites.
...
* Avoman for editing many Pokémon sprites and Crys's back sprite.
