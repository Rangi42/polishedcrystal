...
DEF rLCDC_BG_PRIORITY    EQU 7 ; 0=Off, 1=On
DEF rLCDC_SPRITES_ENABLE EQU 6 ; 0=Off, 1=On
DEF rLCDC_SPRITE_SIZE    EQU 5 ; 0=8x8, 1=8x16
DEF rLCDC_BG_TILEMAP     EQU 4 ; 0=9800-9BFF, 1=9C00-9FFF
DEF rLCDC_TILE_DATA      EQU 3 ; 0=8800-97FF, 1=8000-8FFF
DEF rLCDC_WINDOW_ENABLE  EQU 2 ; 0=Off, 1=On
DEF rLCDC_WINDOW_TILEMAP EQU 1 ; 0=9800-9BFF, 1=9C00-9FFF
DEF rLCDC_ENABLE         EQU 0 ; 0=Off, 1=On
...
DEF rSTAT_INT_LYC        EQU 1 ; LYC=LY interrupt
DEF rSTAT_INT_MODE_2     EQU 2 ; Mode 2 interrupt (OAM search)
DEF rSTAT_INT_MODE_1     EQU 3 ; Mode 1 interrupt (VBlank)
DEF rSTAT_INT_MODE_0     EQU 4 ; Mode 0 interrupt (HBlank)
DEF rSTAT_LYC_CMP        EQU 5 ; LYC=LY flag
DEF rSTAT_MODE_0         EQU %00000000 ; HBlank
DEF rSTAT_MODE_1         EQU %10000000 ; VBlank
DEF rSTAT_MODE_2         EQU %01000000 ; Searching OAM
DEF rSTAT_MODE_3         EQU %11000000 ; Transferring data to LCD
DEF rSTAT_MODE_MASK      EQU %11000000
