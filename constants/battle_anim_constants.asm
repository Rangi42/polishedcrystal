...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_DRAGON_PULSE     ; 19
	const PAL_BTLCUSTOM_SNOW             ; 1a
	const PAL_BTLCUSTOM_REFLECT          ; 1b
	const PAL_BTLCUSTOM_MIRROR_COAT      ; 1c
	const PAL_BTLCUSTOM_ACID             ; 1d
	const PAL_BTLCUSTOM_MOON             ; 1e
	const PAL_BTLCUSTOM_MOONBLAST        ; 1f
	const PAL_BTLCUSTOM_VERY_BRIGHT      ; 20
	const PAL_BTLCUSTOM_ATTACK           ; 21
	const PAL_BTLCUSTOM_DEFENSE          ; 22
	const PAL_BTLCUSTOM_SP_ATTACK        ; 23
	const PAL_BTLCUSTOM_SP_DEFENSE       ; 24
	const PAL_BTLCUSTOM_SPEED            ; 25
	const PAL_BTLCUSTOM_ACCURACY         ; 26
	const PAL_BTLCUSTOM_EVASION          ; 27
