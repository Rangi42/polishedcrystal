...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_DRAGON_PULSE     ; 1c
	const PAL_BTLCUSTOM_SNOW             ; 1d
	const PAL_BTLCUSTOM_REFLECT          ; 1e
	const PAL_BTLCUSTOM_MIRROR_COAT      ; 1f
	const PAL_BTLCUSTOM_ACID             ; 20
	const PAL_BTLCUSTOM_MOON             ; 21
	const PAL_BTLCUSTOM_MOONBLAST        ; 22
	const PAL_BTLCUSTOM_VERY_BRIGHT      ; 23
	const PAL_BTLCUSTOM_ATTACK           ; 24
	const PAL_BTLCUSTOM_DEFENSE          ; 25
	const PAL_BTLCUSTOM_SP_ATTACK        ; 26
	const PAL_BTLCUSTOM_SP_DEFENSE       ; 27
	const PAL_BTLCUSTOM_SPEED            ; 28
	const PAL_BTLCUSTOM_ACCURACY         ; 29
	const PAL_BTLCUSTOM_EVASION          ; 2a
