...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_SIGNAL_BEAM_BLUE ; 18
	const PAL_BTLCUSTOM_BULK_UP          ; 19
	const PAL_BTLCUSTOM_PSYCHO_BOOST_2   ; 1a
	const PAL_BTLCUSTOM_DARK_PULSE       ; 1b
	const PAL_BTLCUSTOM_GLOW_LIME        ; 1c
	const PAL_BTLCUSTOM_DRAGON_PULSE     ; 1d
	const PAL_BTLCUSTOM_SNOW             ; 1e
	const PAL_BTLCUSTOM_REFLECT          ; 1f
	const PAL_BTLCUSTOM_MIRROR_COAT      ; 20
	const PAL_BTLCUSTOM_ACID             ; 21
	const PAL_BTLCUSTOM_MOON             ; 22
	const PAL_BTLCUSTOM_MOONBLAST        ; 23
	const PAL_BTLCUSTOM_VERY_BRIGHT      ; 24
	const PAL_BTLCUSTOM_ATTACK           ; 25
	const PAL_BTLCUSTOM_DEFENSE          ; 26
	const PAL_BTLCUSTOM_SP_ATTACK        ; 27
	const PAL_BTLCUSTOM_SP_DEFENSE       ; 28
	const PAL_BTLCUSTOM_SPEED            ; 29
	const PAL_BTLCUSTOM_ACCURACY         ; 2a
	const PAL_BTLCUSTOM_EVASION          ; 2b
