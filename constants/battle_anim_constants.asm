...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_REFLECT       ; 12
	const PAL_BTLCUSTOM_ACID          ; 13
	const PAL_BTLCUSTOM_MOON          ; 14
	const PAL_BTLCUSTOM_MOONBLAST     ; 15
	const PAL_BTLCUSTOM_VERY_BRIGHT   ; 16
	const PAL_BTLCUSTOM_ATTACK        ; 17
	const PAL_BTLCUSTOM_DEFENSE       ; 18
	const PAL_BTLCUSTOM_SP_ATTACK     ; 19
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 1a
	const PAL_BTLCUSTOM_SPEED         ; 1b
	const PAL_BTLCUSTOM_ACCURACY      ; 1c
	const PAL_BTLCUSTOM_EVASION       ; 1d
