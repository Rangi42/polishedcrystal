...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_GLOW_LIME        ; 20
	...
	const PAL_BTLCUSTOM_VERY_BRIGHT_PINK ; 2a
	const PAL_BTLCUSTOM_ATTACK           ; 2b
	const PAL_BTLCUSTOM_DEFENSE          ; 2c
	const PAL_BTLCUSTOM_SP_ATTACK        ; 2d
	const PAL_BTLCUSTOM_SP_DEFENSE       ; 2e
	const PAL_BTLCUSTOM_SPEED            ; 2f
	const PAL_BTLCUSTOM_ACCURACY         ; 30
	const PAL_BTLCUSTOM_EVASION          ; 31
