...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_SHADOW_BALL      ; 2e
	const PAL_BTLCUSTOM_ATTACK           ; 2f
	const PAL_BTLCUSTOM_DEFENSE          ; 30
	const PAL_BTLCUSTOM_SP_ATTACK        ; 31
	const PAL_BTLCUSTOM_SP_DEFENSE       ; 32
	const PAL_BTLCUSTOM_SPEED            ; 33
	const PAL_BTLCUSTOM_ACCURACY         ; 34
	const PAL_BTLCUSTOM_EVASION          ; 35
