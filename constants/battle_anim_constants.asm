...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_LIGHT_SCREEN  ; f
	const PAL_BTLCUSTOM_WILL_O_WISP   ; 10
	const PAL_BTLCUSTOM_GLOW_YELLOW   ; 11
	const PAL_BTLCUSTOM_SNOW          ; 12
	const PAL_BTLCUSTOM_REFLECT       ; 13
	const PAL_BTLCUSTOM_ACID          ; 14
	const PAL_BTLCUSTOM_MOON          ; 15
	const PAL_BTLCUSTOM_MOONBLAST     ; 16
	const PAL_BTLCUSTOM_VERY_BRIGHT   ; 17
	const PAL_BTLCUSTOM_ATTACK        ; 18
	const PAL_BTLCUSTOM_DEFENSE       ; 19
	const PAL_BTLCUSTOM_SP_ATTACK     ; 1a
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 1b
	const PAL_BTLCUSTOM_SPEED         ; 1c
	const PAL_BTLCUSTOM_ACCURACY      ; 1d
	const PAL_BTLCUSTOM_EVASION       ; 1e
