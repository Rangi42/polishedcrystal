...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_BERRY         ; 10
	const PAL_BTLCUSTOM_LIGHT_SCREEN  ; 11
	const PAL_BTLCUSTOM_WILL_O_WISP   ; 12
	const PAL_BTLCUSTOM_GLOW_YELLOW   ; 13
	const PAL_BTLCUSTOM_DRAGON_PULSE  ; 14
	const PAL_BTLCUSTOM_SNOW          ; 15
	const PAL_BTLCUSTOM_REFLECT       ; 16
	const PAL_BTLCUSTOM_ACID          ; 17
	const PAL_BTLCUSTOM_MOON          ; 18
	const PAL_BTLCUSTOM_MOONBLAST     ; 19
	const PAL_BTLCUSTOM_VERY_BRIGHT   ; 1a
	const PAL_BTLCUSTOM_ATTACK        ; 1b
	const PAL_BTLCUSTOM_DEFENSE       ; 1c
	const PAL_BTLCUSTOM_SP_ATTACK     ; 1d
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 1e
	const PAL_BTLCUSTOM_SPEED         ; 1f
	const PAL_BTLCUSTOM_ACCURACY      ; 20
	const PAL_BTLCUSTOM_EVASION       ; 21
