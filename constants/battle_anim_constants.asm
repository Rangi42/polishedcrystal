...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_WATER_RIPPLE
	const ANIM_OBJ_CLEAR_SMOG
	const ANIM_OBJ_CLEAR_SMOG_RISE
	const ANIM_OBJ_FIRE_BG
	const ANIM_OBJ_STRUGGLE_BUG
	const ANIM_OBJ_STRUGGLE_BUG_DOWN
	const ANIM_OBJ_DRILL_RUN
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW_CLAMP
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_CLAMP_1                    ;  3A
	const BATTLEANIMFRAMESET_CLAMP_2                    ;  3B
	...
	const BATTLEANIMFRAMESET_DROPLET_R                  ;  F4
	const BATTLEANIMFRAMESET_DROPLET_L                  ;  F5
	const BATTLEANIMFRAMESET_SMELLINGSALT_SURPRISED     ;  F6
	const BATTLEANIMFRAMESET_SPINNING_TRIANGLE          ;  F7
	const BATTLEANIMFRAMESET_SPINNING_TRIANGLE_SLOW     ;  F8
	const BATTLEANIMFRAMESET_BOUNCING_MUSHROOM          ;  F9
	const BATTLEANIMFRAMESET_MEDIUM_HORN                ;  FA
	const BATTLEANIMFRAMESET_MINIMIZE                   ;  FB
	const BATTLEANIMFRAMESET_ICICLE_CRASH               ;  FC
	const BATTLEANIMFRAMESET_ENERGY_ORB_LONG            ;  FD
	const BATTLEANIMFRAMESET_VOLT_SWITCH                ;  FE
	const BATTLEANIMFRAMESET_DISCHARGE_SPARKS_N         ;  FF
	const BATTLEANIMFRAMESET_HONE_CLAWS_LEFT            ; 100
	const BATTLEANIMFRAMESET_HONE_CLAWS_RIGHT           ; 101
	const BATTLEANIMFRAMESET_HURRICANE                  ; 102
	const BATTLEANIMFRAMESET_GROWING_HEART              ; 103
	const BATTLEANIMFRAMESET_WATER_BALL                 ; 104
	const BATTLEANIMFRAMESET_GROWING_BALL               ; 105
	const BATTLEANIMFRAMESET_RECYCLE                    ; 106
	const BATTLEANIMFRAMESET_ICE_BALL                   ; 107
	const BATTLEANIMFRAMESET_WEATHER_BALL               ; 108
	const BATTLEANIMFRAMESET_BURNED_SHORT               ; 109
	const BATTLEANIMFRAMESET_BIG_RED_X                  ; 10A
	const BATTLEANIMFRAMESET_BIG_RED_X_FLASHING         ; 10B
	const BATTLEANIMFRAMESET_WATER_SPOUT_RISING         ; 10C
	const BATTLEANIMFRAMESET_WATER_SPOUT_FALLING        ; 10D
	const BATTLEANIMFRAMESET_CUT_LONG_UP_RIGHT          ; 10E
	const BATTLEANIMFRAMESET_CUT_LONG_UP_LEFT           ; 10F
	const BATTLEANIMFRAMESET_SHOCK_WAVE_SPARKS          ; 110
	const BATTLEANIMFRAMESET_VERTICAL_AGILITY           ; 111
	const BATTLEANIMFRAMESET_METAL_BURST                ; 112
	const BATTLEANIMFRAMESET_DEPRESSION                 ; 113
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_R         ; 114
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_R        ; 115
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_R        ; 116
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_L         ; 117
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_L        ; 118
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_L        ; 119
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_R_Y_FLIP  ; 11A
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_R_Y_FLIP ; 11B
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_R_Y_FLIP ; 11C
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_L_Y_FLIP  ; 11D
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_L_Y_FLIP ; 11E
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_L_Y_FLIP ; 11F
	const BATTLEANIMFRAMESET_VACUUM_SHRINKING           ; 120
	const BATTLEANIMFRAMESET_SHADOW_SNEAK               ; 121
	const BATTLEANIMFRAMESET_MUD_BOMB                   ; 122
	const BATTLEANIMFRAMESET_BIG_WHIP_NE                ; 123
	const BATTLEANIMFRAMESET_METEOR_BIG                 ; 124
	const BATTLEANIMFRAMESET_METEOR_SMALL               ; 125
	const BATTLEANIMFRAMESET_LEAF_STORM_BIG_LEAF        ; 126
	const BATTLEANIMFRAMESET_LEAF_STORM_SMALL_LEAF      ; 127
	const BATTLEANIMFRAMESET_MAGNET_BOMB                ; 128
	const BATTLEANIMFRAMESET_EXPLOSION_SMALL            ; 129
	const BATTLEANIMFRAMESET_GRASS_KNOT                 ; 12A
	const BATTLEANIMFRAMESET_WOOD_HAMMER                ; 12B
	const BATTLEANIMFRAMESET_CLEAR_SMOG                 ; 12C
	const BATTLEANIMFRAMESET_STRUGGLE_BUG               ; 12D
	const BATTLEANIMFRAMESET_DRILL_RUN                  ; 12E
	const BATTLEANIMFRAMESET_UPROAR_NOTE                ; 12F
	const BATTLEANIMFRAMESET_BIG_WHIP_2                 ; 130
	const BATTLEANIMFRAMESET_GROWING_BUBBLE             ; 131
	const BATTLEANIMFRAMESET_TORMENT                    ; 132
	const BATTLEANIMFRAMESET_TAUNT                      ; 133
	const BATTLEANIMFRAMESET_ROOT_R                     ; 134
	const BATTLEANIMFRAMESET_ROOT_L                     ; 135
	const BATTLEANIMFRAMESET_ENERGY_ORB_INGRAIN         ; 136
	const BATTLEANIMFRAMESET_DROWZINESS                 ; 137
	const BATTLEANIMFRAMESET_IMPRISON_RING              ; 138
	const BATTLEANIMFRAMESET_COSMIC_POWER_BG            ; 139
	const BATTLEANIMFRAMESET_BIG_GLOW_SPIKED            ; 13A
	const BATTLEANIMFRAMESET_METAL_BURST_GEM            ; 13B
	const BATTLEANIMFRAMESET_MAGNET_RISE                ; 13C
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLEANIMOAMSET_TORMENT
	const BATTLEANIMOAMSET_ROOTS_1
	const BATTLEANIMOAMSET_ROOTS_2
	const BATTLEANIMOAMSET_ROOTS_3
	const BATTLEANIMOAMSET_CP_BG
	const BATTLEANIMOAMSET_BIG_GLOW_SPIKED_1
	const BATTLEANIMOAMSET_BIG_GLOW_SPIKED_2
	const BATTLEANIMOAMSET_MAGNET_RISE
...
; AnimObjGFX indexes (see data/battle_anims/object_gfx.asm)
	...
	const ANIM_GFX_OBJECTS_3
	const ANIM_GFX_DRILL
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_HEAT_BG          ; 3c
	const PAL_BTLCUSTOM_SIMPLE_BEAM      ; 3d
	const PAL_BTLCUSTOM_STRUGGLE_BUG     ; 3e
	const PAL_BTLCUSTOM_HEAT_WAVE        ; 3f
	const PAL_BTLCUSTOM_REFRESH          ; 40
	const PAL_BTLCUSTOM_COSMIC           ; 41
