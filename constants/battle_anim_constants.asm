...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_ATTACK        ; 14
	const PAL_BTLCUSTOM_DEFENSE       ; 15
	const PAL_BTLCUSTOM_SP_ATTACK     ; 16
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 17
	const PAL_BTLCUSTOM_SPEED         ; 18
	const PAL_BTLCUSTOM_ACCURACY      ; 19
	const PAL_BTLCUSTOM_EVASION       ; 1a
