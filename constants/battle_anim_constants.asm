...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_GLOW_YELLOW   ; 10
	const PAL_BTLCUSTOM_REFLECT       ; 11
	const PAL_BTLCUSTOM_ATTACK        ; 12
	const PAL_BTLCUSTOM_DEFENSE       ; 13
	const PAL_BTLCUSTOM_SP_ATTACK     ; 14
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 15
	const PAL_BTLCUSTOM_SPEED         ; 16
	const PAL_BTLCUSTOM_ACCURACY      ; 17
	const PAL_BTLCUSTOM_EVASION       ; 18
