...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_ATTACK        ; 13
	const PAL_BTLCUSTOM_DEFENSE       ; 14
	const PAL_BTLCUSTOM_SP_ATTACK     ; 15
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 16
	const PAL_BTLCUSTOM_SPEED         ; 17
	const PAL_BTLCUSTOM_ACCURACY      ; 18
	const PAL_BTLCUSTOM_EVASION       ; 19
