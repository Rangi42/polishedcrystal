...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_REFLECT       ; 10
	const PAL_BTLCUSTOM_ATTACK        ; 11
	const PAL_BTLCUSTOM_DEFENSE       ; 12
	const PAL_BTLCUSTOM_SP_ATTACK     ; 13
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 14
	const PAL_BTLCUSTOM_SPEED         ; 15
	const PAL_BTLCUSTOM_ACCURACY      ; 16
	const PAL_BTLCUSTOM_EVASION       ; 17
