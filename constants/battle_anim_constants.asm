...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_RECOVER
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_DRAGON_PULSE  ; 15
	const PAL_BTLCUSTOM_SNOW          ; 16
	const PAL_BTLCUSTOM_MIRROR_COAT   ; 17
	const PAL_BTLCUSTOM_ACID          ; 18
	const PAL_BTLCUSTOM_MOON          ; 19
	const PAL_BTLCUSTOM_MOONBLAST     ; 1a
	const PAL_BTLCUSTOM_VERY_BRIGHT   ; 1b
	const PAL_BTLCUSTOM_ATTACK        ; 1c
	const PAL_BTLCUSTOM_DEFENSE       ; 1d
	const PAL_BTLCUSTOM_SP_ATTACK     ; 1e
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 1f
	const PAL_BTLCUSTOM_SPEED         ; 20
	const PAL_BTLCUSTOM_ACCURACY      ; 21
	const PAL_BTLCUSTOM_EVASION       ; 22
