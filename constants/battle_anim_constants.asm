...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_KICK
	const ANIM_OBJ_OPEN_HAND
	const ANIM_OBJ_FANG
	const ANIM_OBJ_ELEMENTAL_PUNCH
	...
	const ANIM_OBJ_EXPLOSION
	const ANIM_OBJ_EGG_BOMB
	const ANIM_OBJ_ACID
	const ANIM_OBJ_SLUDGE
	const ANIM_OBJ_PLAYER_BALL_POOF
	...
	const ANIM_OBJ_LIGHTNING_DOUBLE
	const ANIM_OBJ_LIGHTNING_BOLT
	const ANIM_OBJ_LIGHTNING_SINGLE
	const ANIM_OBJ_THUNDERSHOCK
	...
	const ANIM_OBJ_METRONOME_FLASH
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_THROW_PLAYER_TO_ENEMY
	const BATTLEANIMFUNC_THROW_PLAYER_TO_ENEMY_DISAPPEAR
	...
	const BATTLEANIMFUNC_POKE_BALL
	const BATTLEANIMFUNC_POKE_BALL_BLOCKED
