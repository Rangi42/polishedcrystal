...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_BIG_GLOW_CLEAR             ;  D6
	const BATTLEANIMFRAMESET_BERRY                      ;  D7
	const BATTLEANIMFRAMESET_STAT_UP                    ;  D8
	const BATTLEANIMFRAMESET_STAT_DOWN                  ;  D9
	const BATTLEANIMFRAMESET_SPARKLE_LONG               ;  DA
	const BATTLEANIMFRAMESET_FLASH_CANNON_CHARGE_ORB    ;  DB
	const BATTLEANIMFRAMESET_SLOW_GROWING_GLOW          ;  DC
	const BATTLEANIMFRAMESET_FLASH_CANNON_SPARKS        ;  DD
	const BATTLEANIMFRAMESET_TINY_GLOW                  ;  DE
	const BATTLEANIMFRAMESET_PULSING_SPARKLE            ;  DF
	const BATTLEANIMFRAMESET_OCTAZOOKA_SMOKE            ;  F0
	const BATTLEANIMFRAMESET_INK_SPLASH                 ;  F1
	const BATTLEANIMFRAMESET_SMOKE_PUFF                 ;  F2
	const BATTLEANIMFRAMESET_BUBBLE_SPLASH              ;  F3
