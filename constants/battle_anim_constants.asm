...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_SNOW          ; 14
	const PAL_BTLCUSTOM_REFLECT       ; 15
	const PAL_BTLCUSTOM_ACID          ; 16
	const PAL_BTLCUSTOM_MOON          ; 17
	const PAL_BTLCUSTOM_MOONBLAST     ; 18
	const PAL_BTLCUSTOM_VERY_BRIGHT   ; 19
	const PAL_BTLCUSTOM_ATTACK        ; 1a
	const PAL_BTLCUSTOM_DEFENSE       ; 1b
	const PAL_BTLCUSTOM_SP_ATTACK     ; 1c
	const PAL_BTLCUSTOM_SP_DEFENSE    ; 1d
	const PAL_BTLCUSTOM_SPEED         ; 1e
	const PAL_BTLCUSTOM_ACCURACY      ; 1f
	const PAL_BTLCUSTOM_EVASION       ; 20
