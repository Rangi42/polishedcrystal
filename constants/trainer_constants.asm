...
KRIS EQU __enum__
	...
	trainerclass COSPLAYER ; 2d

	trainerclass SUPER_NERD ; 2e
	const STAN
	const ERIC
	const SAM
	const TOM
	...
	trainerclass ELDER ; 3a
	const LI
	const GAKU
	const MASA
	const KOJI

	trainerclass SR_AND_JR ; 3b
	const JOANDCATH1
	const JOANDCATH2
	const IVYANDAMY1
	const IVYANDAMY2
	...
	trainerclass COUPLE ; 3c
	const GAILANDELI1
	const GAILANDELI2
	const DUFFANDEDA1
	const DUFFANDEDA2

	trainerclass GENTLEMAN ; 3d
	const PRESTON
	const EDWARD
	const GREGORY
	const ALFRED
	...
	trainerclass RICH_BOY ; 3e
	const WINSTON
	const GERALD
	const IRVING

	trainerclass BREEDER ; 3f
	const JULIE
	const THERESA
	const JODY
	const CARLENE

	trainerclass BAKER ; 40

	trainerclass COWGIRL ; 41
	const ANNIE
	const APRIL
	const DANIELA

	trainerclass SAILOR ; 42
	const HUEY1
	const HUEY2
	const HUEY3
	const HUEY4
	...
	trainerclass TEACHER ; 4d
	const COLETTE
	const HILLARY
	const SHIRLEY
	const KATHRYN

	trainerclass GUITARISTM ; 4e
	const CLYDE
	const VINCENT

	trainerclass GUITARISTF ; 4f
	const JANET

	trainerclass BIKER ; 50
	const DWAYNE
	const HARRIS
	const ZEKE
	const CHARLES
	...
	trainerclass ROUGHNECK ; 51
	const BRIAN
	const THERON
	const MARKEY

	trainerclass SIGHTSEERM ; 52

	trainerclass SIGHTSEERF ; 53

	trainerclass COOLTRAINERM ; 54
	const GAVEN1
	const GAVEN2
	const GAVEN3
	const NICK
	...
	trainerclass VETERANM ; 57
	const MATT
	const REMY

	trainerclass VETERANF ; 58
	const JOANNE
	const SYLVIE

	trainerclass PROTON ; 59
	const PROTON1
	const PROTON2

	trainerclass PETREL ; 5a
	const PETREL1
	const PETREL2

	trainerclass ARCHER ; 5b
	const ARCHER1
	const ARCHER2

	trainerclass ARIANA ; 5c
	const ARIANA1
	const ARIANA2
	...
	trainerclass PROF_OAK ; 5e

	trainerclass PROF_ELM ; 5f

	trainerclass PROF_IVY ; 60
