...
; MapObjectPals indexes (see gfx/overworld/npc_sprites.pal)
	...
	ow_npc_pal_const SAILBOAT          ; 0d
DEF NUM_OW_TIME_OF_DAY_PALS EQU const_value
	ow_npc_pal_const EMOTE_GRAY        ; 0e
	ow_npc_pal_const EMOTE_BLACK       ; 0f
	ow_npc_pal_const EMOTE_GREEN       ; 10
	ow_npc_pal_const EMOTE_PURPLE      ; 11
	ow_npc_pal_const EMOTE_RED         ; 12
	ow_npc_pal_const EMOTE_ORANGE      ; 13
	ow_npc_pal_const EMOTE_BLUE        ; 14
	ow_npc_pal_const ELECTRIC_FENCE    ; 15
	ow_npc_pal_const LIGHTNING_CRYSTAL ; 16
	ow_npc_pal_const ROCK_CRYSTAL      ; 17
	ow_npc_pal_const N64               ; 18
	ow_npc_pal_const POKECOM_SIGN      ; 19
	ow_npc_pal_const RANGI             ; 1a
	ow_npc_pal_const DRILL             ; 1b
