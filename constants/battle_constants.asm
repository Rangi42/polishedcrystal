...
; wPlayerSubStatus5 or wEnemySubStatus5 bit flags
	const_def
	const SUBSTATUS_TORMENTED
	const SUBSTATUS_NIGHTMARE
	const SUBSTATUS_INGRAIN
	const SUBSTATUS_IMPRISON
	const_skip
	const_skip
	const_skip
	const_skip

; wPlayerSemiInvulnerableType or wEnemySemiInvulnerableType
	const_def
	const SEMI_INVULNERABLE_FLYING_F
	const SEMI_INVULNERABLE_DIGGING_F
	const SEMI_INVULNERABLE_DIVING_F

DEF SEMI_INVULNERABLE_NONE    EQU 0
DEF SEMI_INVULNERABLE_FLYING  EQU 1 << SEMI_INVULNERABLE_FLYING_F
DEF SEMI_INVULNERABLE_DIGGING EQU 1 << SEMI_INVULNERABLE_DIGGING_F
DEF SEMI_INVULNERABLE_DIVING  EQU 1 << SEMI_INVULNERABLE_DIVING_F

; wPlayerHazards or wEnemyHazards bit masks (stackable)
DEF HAZARDS_STICKY_WEB   EQU %00001000
...
DEF SUBSTATUS_EMBARGO     EQU %00001111
DEF SUBSTATUS_THROAT_CHOP EQU %11110000
...
endc
	...
	const_def
	const ENVIRONMENT_PLAIN
	const ENVIRONMENT_BUILDING
	const ENVIRONMENT_GRASS
	const ENVIRONMENT_WATER
	const ENVIRONMENT_PUDDLE
	const ENVIRONMENT_CAVE
	const ENVIRONMENT_SAND
	const ENVIRONMENT_SNOW
	const ENVIRONMENT_ICE
	const ENVIRONMENT_SWAMP
	const ENVIRONMENT_MOUNTAIN
	const ENVIRONMENT_MAGNETIZED
	const ENVIRONMENT_BURNED
DEF NUM_BATTLE_ENVIRONMENTS EQU const_value