...
; ability dvs
SPDSPCDV_ABILITY_1_MAX_SPD EQU $FE
SPDSPCDV_ABILITY_1_MAX_SPC EQU $EF
SPDSPCDV_ABILITY_2_MAX_SPD EQU $FD
SPDSPCDV_ABILITY_2_MAX_SPC EQU $DF
SPDSPCDV_HIDDEN_ABILITY    EQU $FF
