...
; hidden power dvs
ATKDEFDV_HP_FIGHTING EQU $CC
ATKDEFDV_HP_FLYING   EQU $CD
ATKDEFDV_HP_POISON   EQU $CE
ATKDEFDV_HP_GROUND   EQU $CF
ATKDEFDV_HP_ROCK     EQU $DC
ATKDEFDV_HP_BUG      EQU $DD
ATKDEFDV_HP_GHOST    EQU $DE
ATKDEFDV_HP_STEEL    EQU $DF
ATKDEFDV_HP_FIRE     EQU $EC
ATKDEFDV_HP_WATER    EQU $ED
ATKDEFDV_HP_GRASS    EQU $EE
ATKDEFDV_HP_ELECTRIC EQU $EF
ATKDEFDV_HP_PSYCHIC  EQU $FC
ATKDEFDV_HP_ICE      EQU $FD
...
SUBSTATUS_CURLED       EQU 0
	...
	enum SUBSTATUS_MIST
	enum SUBSTATUS_UNUSED_1 ; SUBSTATUS_X_ACCURACY
