...
; see data/sprites/map_objects.asm
	...
	const SPRITEMOVEDATA_RAIL_UPPER           ; 21
	const SPRITEMOVEDATA_RAIL_LOWER           ; 22
	const SPRITEMOVEDATA_RAIL_UPPER_FLIP      ; 23
	const SPRITEMOVEDATA_RAIL_LOWER_FLIP      ; 24
	const SPRITEMOVEDATA_EDGE                 ; 25
	const SPRITEMOVEDATA_ARCH_LEFT            ; 26
	const SPRITEMOVEDATA_ARCH_RIGHT           ; 27
	const SPRITEMOVEDATA_RAIL_LEFT            ; 28
	const SPRITEMOVEDATA_RAIL_RIGHT           ; 29
...
; see engine/map_objects.asm:MapObjectMovementPattern.Pointers
	...
	const SPRITEMOVEFN_RAIL_UPPER            ; 17
	const SPRITEMOVEFN_RAIL_LOWER            ; 18
	const SPRITEMOVEFN_RAIL_UPPER_FLIP       ; 19
	const SPRITEMOVEFN_RAIL_LOWER_FLIP       ; 1a
	const SPRITEMOVEFN_EDGE                  ; 1b
	const SPRITEMOVEFN_ARCH_LEFT             ; 1c
	const SPRITEMOVEFN_ARCH_RIGHT            ; 1d
	const SPRITEMOVEFN_RAIL_LEFT             ; 1e
	const SPRITEMOVEFN_RAIL_RIGHT            ; 1f
...
; see engine/map_object_action.asm:Pointers445f
	...
	const PERSON_ACTION_RAIL_UPPER      ; 13
	const PERSON_ACTION_RAIL_LOWER      ; 14
	const PERSON_ACTION_RAIL_UPPER_FLIP ; 15
	const PERSON_ACTION_RAIL_LOWER_FLIP ; 16
	const PERSON_ACTION_EDGE            ; 17
	const PERSON_ACTION_ARCH_LEFT       ; 18
	const PERSON_ACTION_ARCH_RIGHT      ; 19
	const PERSON_ACTION_RAIL_LEFT       ; 1a
	const PERSON_ACTION_RAIL_RIGHT      ; 1b
...
; see data/sprites/facings.asm:Facings
	...
	const FACING_RAIL_UPPER      ; 23
	const FACING_RAIL_LOWER      ; 24
	const FACING_RAIL_UPPER_FLIP ; 25
	const FACING_RAIL_LOWER_FLIP ; 26
	const FACING_EDGE            ; 27
	const FACING_ARCH_LEFT       ; 28
	const FACING_ARCH_RIGHT      ; 29
	const FACING_RAIL_LEFT       ; 2a
	const FACING_RAIL_RIGHT      ; 2b
