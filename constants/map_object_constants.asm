...
; see data/sprites/map_objects.asm
	...
	const SPRITEMOVEDATA_RAIL_UPPER_HI        ; 21
	const SPRITEMOVEDATA_RAIL_UPPER_LO        ; 22
	const SPRITEMOVEDATA_RAIL_LOWER_HI        ; 23
	const SPRITEMOVEDATA_RAIL_LOWER_LO        ; 24
	const SPRITEMOVEDATA_RAIL_UPPER_HI_FLIP   ; 25
	const SPRITEMOVEDATA_RAIL_UPPER_LO_FLIP   ; 26
	const SPRITEMOVEDATA_RAIL_LOWER_HI_FLIP   ; 27
	const SPRITEMOVEDATA_RAIL_LOWER_LO_FLIP   ; 28
	const SPRITEMOVEDATA_EDGE_HI              ; 29
	const SPRITEMOVEDATA_EDGE_LO              ; 2a
	const SPRITEMOVEDATA_ARCH_LEFT            ; 2b
	const SPRITEMOVEDATA_ARCH_RIGHT           ; 2c
...
; see engine/map_objects.asm:MapObjectMovementPattern.Pointers
	...
	const SPRITEMOVEFN_RAIL_UPPER_HI         ; 17
	const SPRITEMOVEFN_RAIL_UPPER_LO         ; 18
	const SPRITEMOVEFN_RAIL_LOWER_HI         ; 19
	const SPRITEMOVEFN_RAIL_LOWER_LO         ; 1a
	const SPRITEMOVEFN_RAIL_UPPER_HI_FLIP    ; 1b
	const SPRITEMOVEFN_RAIL_UPPER_LO_FLIP    ; 1c
	const SPRITEMOVEFN_RAIL_LOWER_HI_FLIP    ; 1d
	const SPRITEMOVEFN_RAIL_LOWER_LO_FLIP    ; 1e
	const SPRITEMOVEFN_EDGE_HI               ; 1f
	const SPRITEMOVEFN_EDGE_LO               ; 20
	const SPRITEMOVEFN_ARCH_LEFT             ; 21
	const SPRITEMOVEFN_ARCH_RIGHT            ; 22
...
; see engine/map_object_action.asm:Pointers445f
	...
	const PERSON_ACTION_RUN             ; 12
	const PERSON_ACTION_RAIL_UPPER_HI      ; 13
	const PERSON_ACTION_RAIL_UPPER_LO      ; 14
	const PERSON_ACTION_RAIL_LOWER_HI      ; 15
	const PERSON_ACTION_RAIL_LOWER_LO      ; 16
	const PERSON_ACTION_RAIL_UPPER_HI_FLIP ; 17
	const PERSON_ACTION_RAIL_UPPER_LO_FLIP ; 18
	const PERSON_ACTION_RAIL_LOWER_HI_FLIP ; 19
	const PERSON_ACTION_RAIL_LOWER_LO_FLIP ; 1a
	const PERSON_ACTION_EDGE_HI            ; 1b
	const PERSON_ACTION_EDGE_LO            ; 1c
	const PERSON_ACTION_ARCH_LEFT          ; 1d
	const PERSON_ACTION_ARCH_RIGHT         ; 1e
...
; see data/sprites/facings.asm:Facings
	...
	const FACING_RAIL_UPPER_HI      ; 23
	const FACING_RAIL_UPPER_LO      ; 24
	const FACING_RAIL_LOWER_HI      ; 25
	const FACING_RAIL_LOWER_LO      ; 26
	const FACING_RAIL_UPPER_HI_FLIP ; 27
	const FACING_RAIL_UPPER_LO_FLIP ; 28
	const FACING_RAIL_LOWER_HI_FLIP ; 29
	const FACING_RAIL_LOWER_LO_FLIP ; 2a
	const FACING_EDGE_HI            ; 2b
	const FACING_EDGE_LO            ; 2c
	const FACING_ARCH_LEFT          ; 2d
	const FACING_ARCH_RIGHT         ; 2e
