...
; SpriteMovementData indexes (see data/sprites/map_objects.asm)
	...
	const SPRITEMOVEDATA_FOLLOWEROBJ          ; 33
	const SPRITEMOVEDATA_POKEBALL_OPENING     ; 34
	const SPRITEMOVEDATA_POKEBALL_CLOSING     ; 35
...
; StepFunction_FromMovement.Pointers indexes (see engine/overworld/map_objects.asm)
	...
	const SPRITEMOVEFN_FOLLOWER_OBJ          ; 24
	const SPRITEMOVEFN_POKEBALL_OPENING      ; 25
	const SPRITEMOVEFN_POKEBALL_CLOSING      ; 26
