...
; see engine/map_objects.asm:MapObjectMovementPattern.Pointers
	...
	const SPRITEMOVEFN_ARCH_TREE             ; 19
...
; see engine/map_object_action.asm:Pointers445f
	...
	const PERSON_ACTION_ARCH_TREE     ; 14
...
; see data/sprites/facings.asm:Facings
	...
	const FACING_ARCH_TREE_DOWN  ; 27
	const FACING_ARCH_TREE_UP    ; 28
	const FACING_ARCH_TREE_LEFT  ; 29
	const FACING_ARCH_TREE_RIGHT ; 2a
