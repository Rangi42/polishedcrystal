	...
	const MUSIC_ROUTE_210_DPPT               ; 72
	const MUSIC_SUNYSHORE_CITY_DPPT          ; 73
	const MUSIC_STARK_MOUNTAIN_DPPT          ; 74
	const MUSIC_MOUNT_CORONET_DPPT           ; 75
	const MUSIC_ETERNA_FOREST_DPPT           ; 76
	const MUSIC_GAME_CORNER_DPPT             ; 77
	const MUSIC_CHAMPION_BATTLE_DPPT         ; 78
	const MUSIC_ROUTE_12_BW                  ; 79
	const MUSIC_TRAINER_BATTLE_BW            ; 7a
	const MUSIC_WCS_BATTLE_BW                ; 7b
	const MUSIC_FINAL_POKEMON_BW             ; 7c
	const MUSIC_REVERSAL_MOUNTAIN_W2         ; 7d
	const MUSIC_WHITE_TREEHOLLOW_W2          ; 7e
	const MUSIC_CHAMPION_BATTLE_B2W2         ; 7f
	const MUSIC_TITLE_XY                     ; 80
	const MUSIC_BICYCLE_XY                   ; 81
	const MUSIC_LAVERRE_CITY_XY              ; 82
	const MUSIC_POWER_PLANT_XY               ; 83
	const MUSIC_RIVAL_BATTLE_XY              ; 84
	const MUSIC_GYM_LEADER_BATTLE_XY         ; 85
	const MUSIC_POKEMON_TOWER_RBY            ; 86
	const MUSIC_CINNABAR_MANSION_RBY         ; 87
	const MUSIC_DIGLETTS_CAVE_RBY            ; 88
	const MUSIC_CERULEAN_CAVE_RBY            ; 89
	const MUSIC_MOUNT_CHIMNEY_RSE            ; 8a
	const MUSIC_MOUNT_PYRE_RSE               ; 8b
	const MUSIC_ABANDONED_SHIP_RSE           ; 8c
	const MUSIC_CHAMPION_BATTLE_RSE          ; 8d
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE    ; 8e
	const MUSIC_KANTO_LEGEND_BATTLE_XY       ; 8f
	const MUSIC_WALLY_BATTLE_ORAS            ; 90
	const MUSIC_ZINNIA_ENCOUNTER_ORAS        ; 91
	const MUSIC_ZINNIA_BATTLE_ORAS           ; 92
	const MUSIC_MOTHER_BEAST_BATTLE_SM       ; 93
	const MUSIC_LUGIAS_SONG_2000             ; 94
	; special
	const MUSIC_RADIO_TOWER                  ; 95
	const MUSIC_MAHOGANY_MART                ; 96
