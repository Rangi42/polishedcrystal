	...
	const MUSIC_ROUTE_210_DPPT               ; 71
	const MUSIC_MOUNT_CORONET_DPPT           ; 72
	const MUSIC_ETERNA_FOREST_DPPT           ; 73
	const MUSIC_GAME_CORNER_DPPT             ; 74
	const MUSIC_CHAMPION_BATTLE_DPPT         ; 75
	const MUSIC_ROUTE_12_BW                  ; 76
	const MUSIC_TRAINER_BATTLE_BW            ; 77
	const MUSIC_WCS_BATTLE_BW                ; 78
	const MUSIC_FINAL_POKEMON_BW             ; 79
	const MUSIC_REVERSAL_MOUNTAIN_W2         ; 7a
	const MUSIC_WHITE_TREEHOLLOW_W2          ; 7b
	const MUSIC_CHAMPION_BATTLE_B2W2         ; 7c
	const MUSIC_TITLE_XY                     ; 7d
	const MUSIC_BICYCLE_XY                   ; 7e
	const MUSIC_POWER_PLANT_XY               ; 7f
	const MUSIC_RIVAL_BATTLE_XY              ; 80
	const MUSIC_GYM_LEADER_BATTLE_XY         ; 81
	const MUSIC_POKEMON_TOWER_RBY            ; 82
	const MUSIC_CINNABAR_MANSION_RBY         ; 83
	const MUSIC_DIGLETTS_CAVE_RBY            ; 84
	const MUSIC_CERULEAN_CAVE_RBY            ; 85
	const MUSIC_MOUNT_CHIMNEY_RSE            ; 86
	const MUSIC_MOUNT_PYRE_RSE               ; 87
	const MUSIC_ABANDONED_SHIP_RSE           ; 88
	const MUSIC_CHAMPION_BATTLE_RSE          ; 89
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE    ; 8a
	const MUSIC_KANTO_LEGEND_BATTLE_XY       ; 8b
	const MUSIC_WALLY_BATTLE_ORAS            ; 8c
	const MUSIC_ZINNIA_ENCOUNTER_ORAS        ; 8d
	const MUSIC_ZINNIA_BATTLE_ORAS           ; 8e
	const MUSIC_MOTHER_BEAST_BATTLE_SM       ; 8f
	const MUSIC_LUGIAS_SONG_2000             ; 90
	; special
	const MUSIC_RADIO_TOWER                  ; 91
	const MUSIC_MAHOGANY_MART                ; 92
