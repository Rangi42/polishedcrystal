	...
	const MUSIC_LYRA_ENCOUNTER_HGSS          ; 68
	const MUSIC_LYRA_DEPARTURE_HGSS          ; 69
	const MUSIC_HO_OH_BATTLE_HGSS            ; 6a
	const MUSIC_LUGIA_BATTLE_HGSS            ; 6b
	const MUSIC_SUMMONING_DANCE_HGSS         ; 6c
	const MUSIC_SPIKY_EARED_PICHU_HGSS       ; 6d
	const MUSIC_ROUTE_210_DPPT               ; 6e
	const MUSIC_MOUNT_CORONET_DPPT           ; 6f
	const MUSIC_GAME_CORNER_DPPT             ; 70
	const MUSIC_ROUTE_12_BW                  ; 71
	const MUSIC_WCS_BATTLE_BW                ; 72
	const MUSIC_REVERSAL_MOUNTAIN_W2         ; 73
