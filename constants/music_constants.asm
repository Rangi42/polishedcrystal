	...
	const MUSIC_SPIKY_EARED_PICHU_HGSS         ; 70 ; unused
	const MUSIC_ROUTE_203_DPPT                 ; 71
	const MUSIC_ROUTE_205_DPPT                 ; 72
	const MUSIC_ROUTE_209_DPPT                 ; 73
	const MUSIC_ROUTE_210_DPPT                 ; 74
	const MUSIC_CANALAVE_CITY_DPPT             ; 75
	const MUSIC_SUNYSHORE_CITY_DPPT            ; 76
	const MUSIC_OREBURGH_GATE_DPPT             ; 77
	const MUSIC_STARK_MOUNTAIN_DPPT            ; 78
	const MUSIC_MOUNT_CORONET_DPPT             ; 79
	const MUSIC_ETERNA_FOREST_DPPT             ; 7a
	const MUSIC_GAME_CORNER_DPPT               ; 7b
	const MUSIC_TRAINER_BATTLE_DPPT            ; 7c
	const MUSIC_CHAMPION_BATTLE_DPPT           ; 7d
	const MUSIC_ROUTE_4_BW                     ; 7e
	const MUSIC_ROUTE_12_BW                    ; 7f
	...
	const MUSIC_METEOR_FALLS_RSE               ; 94
	const MUSIC_MOUNT_CHIMNEY_RSE              ; 95
	const MUSIC_MOUNT_PYRE_RSE                 ; 96
	const MUSIC_ABANDONED_SHIP_RSE             ; 97
	const MUSIC_GYM_LEADER_BATTLE_RSE          ; 98
	const MUSIC_GYM_LEADER_BATTLE_DPPT         ; 99
	const MUSIC_GYM_LEADER_BATTLE_BW           ; 9a
	const MUSIC_CHAMPION_BATTLE_RSE            ; 9b
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE      ; 9c
