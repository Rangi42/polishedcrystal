	...
	const MUSIC_CANALAVE_CITY_DPPT           ; 73
	const MUSIC_SUNYSHORE_CITY_DPPT          ; 74
	const MUSIC_STARK_MOUNTAIN_DPPT          ; 75
	const MUSIC_MOUNT_CORONET_DPPT           ; 76
	const MUSIC_ETERNA_FOREST_DPPT           ; 77
	const MUSIC_GAME_CORNER_DPPT             ; 78
	const MUSIC_CHAMPION_BATTLE_DPPT         ; 79
	const MUSIC_ROUTE_12_BW                  ; 7a
	const MUSIC_TRAINER_BATTLE_BW            ; 7b
	const MUSIC_WCS_BATTLE_BW                ; 7c
	const MUSIC_FINAL_POKEMON_BW             ; 7d
	const MUSIC_REVERSAL_MOUNTAIN_W2         ; 7e
	const MUSIC_WHITE_TREEHOLLOW_W2          ; 7f
	const MUSIC_CHAMPION_BATTLE_B2W2         ; 80
	const MUSIC_TITLE_XY                     ; 81
	const MUSIC_BICYCLE_XY                   ; 82
	const MUSIC_LAVERRE_CITY_XY              ; 83
	const MUSIC_POWER_PLANT_XY               ; 84
	const MUSIC_RIVAL_BATTLE_XY              ; 85
	const MUSIC_GYM_LEADER_BATTLE_XY         ; 86
	const MUSIC_LAVENDER_TOWN_RBY            ; 87
	const MUSIC_POKEMON_TOWER_RBY            ; 88
	...
	const MUSIC_GYM_LEADER_BATTLE_RSE        ; 90
	const MUSIC_GYM_LEADER_BATTLE_DPPT       ; 91
	const MUSIC_GYM_LEADER_BATTLE_BW         ; 92
	const MUSIC_CHAMPION_BATTLE_RSE          ; 93
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE    ; 94
	const MUSIC_KANTO_LEGEND_BATTLE_XY       ; 95
	const MUSIC_WALLY_BATTLE_ORAS            ; 96
	const MUSIC_ZINNIA_ENCOUNTER_ORAS        ; 97
	const MUSIC_ZINNIA_BATTLE_ORAS           ; 98
	const MUSIC_WILD_BATTLE_SM               ; 99
	const MUSIC_TRAINER_BATTLE_SM            ; 9a
	const MUSIC_ELITE_FOUR_BATTLE_SM         ; 9b
	const MUSIC_MOTHER_BEAST_BATTLE_SM       ; 9c
	const MUSIC_LUGIAS_SONG_2000             ; 9d
	; special
	const MUSIC_RADIO_TOWER                  ; 9e
	const MUSIC_MAHOGANY_MART                ; 9f
