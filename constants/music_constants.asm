	...
	const MUSIC_SPIKY_EARED_PICHU_HGSS         ; 70
	...
	const MUSIC_CHAMPION_BATTLE_DPPT           ; 7b
	const MUSIC_ROUTE_4_BW                     ; 7c ; unused
	const MUSIC_ROUTE_12_BW                    ; 7d ; unused
	const MUSIC_TRAINER_BATTLE_BW              ; 7e
	const MUSIC_WCS_BATTLE_BW                  ; 7f
	const MUSIC_FINAL_POKEMON_BW               ; 80
	const MUSIC_ROAD_TO_REVERSAL_MOUNTAIN_B2W2 ; 81 ; unused
	const MUSIC_REVERSAL_MOUNTAIN_W2           ; 82
	const MUSIC_WHITE_TREEHOLLOW_W2            ; 83
	const MUSIC_CHAMPION_BATTLE_B2W2           ; 84
	const MUSIC_TITLE_XY                       ; 85
	const MUSIC_BICYCLE_XY                     ; 86
	const MUSIC_LAVERRE_CITY_XY                ; 87
	const MUSIC_FROST_CAVERN_XY                ; 88
	const MUSIC_POWER_PLANT_XY                 ; 89
	const MUSIC_RIVAL_BATTLE_XY                ; 8a
	const MUSIC_GYM_LEADER_BATTLE_XY           ; 8b
	const MUSIC_LAVENDER_TOWN_RBY              ; 8c
	const MUSIC_POKEMON_TOWER_RBY              ; 8d
	const MUSIC_CINNABAR_MANSION_RBY           ; 8e
	const MUSIC_DIGLETTS_CAVE_RBY              ; 8f
	const MUSIC_CERULEAN_CAVE_RBY              ; 90
	const MUSIC_INDIGO_PLATEAU_RBY             ; 91
	const MUSIC_MOUNT_CHIMNEY_RSE              ; 92
	const MUSIC_MOUNT_PYRE_RSE                 ; 93
	const MUSIC_ABANDONED_SHIP_RSE             ; 94
	const MUSIC_GYM_LEADER_BATTLE_RSE          ; 95
	const MUSIC_GYM_LEADER_BATTLE_DPPT         ; 96
	const MUSIC_GYM_LEADER_BATTLE_BW           ; 97
	const MUSIC_CHAMPION_BATTLE_RSE            ; 98
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE      ; 99
	const MUSIC_KANTO_LEGEND_BATTLE_XY         ; 9a
	const MUSIC_WALLY_BATTLE_ORAS              ; 9b
	const MUSIC_ZINNIA_ENCOUNTER_ORAS          ; 9c
	const MUSIC_ZINNIA_BATTLE_ORAS             ; 9d
	const MUSIC_WILD_BATTLE_SM                 ; 9e
	const MUSIC_TRAINER_BATTLE_SM              ; 9f
	const MUSIC_ELITE_FOUR_BATTLE_SM           ; a0
	const MUSIC_MOTHER_BEAST_BATTLE_SM         ; a1
	const MUSIC_LUGIAS_SONG_2000               ; a2
	; special
	const MUSIC_RADIO_TOWER                    ; a3
	const MUSIC_MAHOGANY_MART                  ; a4
