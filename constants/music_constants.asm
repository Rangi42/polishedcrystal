	...
	const MUSIC_WCS_BATTLE_BW                  ; 81
	const MUSIC_FINAL_POKEMON_BW               ; 82
	const MUSIC_ROAD_TO_REVERSAL_MOUNTAIN_B2W2 ; 83
	const MUSIC_REVERSAL_MOUNTAIN_W2           ; 84
	const MUSIC_WHITE_TREEHOLLOW_W2            ; 85
	const MUSIC_CHAMPION_BATTLE_B2W2           ; 86
	const MUSIC_TITLE_XY                       ; 87
	const MUSIC_BICYCLE_XY                     ; 88
	const MUSIC_LAVERRE_CITY_XY                ; 89
	const MUSIC_FROST_CAVERN_XY                ; 8a
	const MUSIC_POWER_PLANT_XY                 ; 8b
	const MUSIC_RIVAL_BATTLE_XY                ; 8c
	const MUSIC_GYM_LEADER_BATTLE_XY           ; 8d
	const MUSIC_LAVENDER_TOWN_RBY              ; 8e
	const MUSIC_POKEMON_TOWER_RBY              ; 8f
	const MUSIC_CINNABAR_MANSION_RBY           ; 90
	const MUSIC_DIGLETTS_CAVE_RBY              ; 91
	const MUSIC_CERULEAN_CAVE_RBY              ; 92
	const MUSIC_INDIGO_PLATEAU_RBY             ; 93
	const MUSIC_ROUTE_101_RSE                  ; 94
	const MUSIC_DEWFORD_TOWN_RSE               ; 95
	const MUSIC_METEOR_FALLS_RSE               ; 96
	const MUSIC_MOUNT_CHIMNEY_RSE              ; 97
	const MUSIC_MOUNT_PYRE_RSE                 ; 98
	const MUSIC_ABANDONED_SHIP_RSE             ; 99
	const MUSIC_GYM_LEADER_BATTLE_RSE          ; 9a
	const MUSIC_GYM_LEADER_BATTLE_DPPT         ; 9b
	const MUSIC_GYM_LEADER_BATTLE_BW           ; 9c
	const MUSIC_CHAMPION_BATTLE_RSE            ; 9d
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE      ; 9e
	const MUSIC_KANTO_LEGEND_BATTLE_XY         ; 9f
	const MUSIC_WALLY_ENCOUNTER_ORAS           ; a0
	const MUSIC_WALLY_BATTLE_ORAS              ; a1
	const MUSIC_ZINNIA_ENCOUNTER_ORAS          ; a2
	const MUSIC_ZINNIA_BATTLE_ORAS             ; a3
	const MUSIC_WILD_BATTLE_SM                 ; a4
	const MUSIC_TRAINER_BATTLE_SM              ; a5
