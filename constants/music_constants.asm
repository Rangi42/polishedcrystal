	...
	const MUSIC_STARK_MOUNTAIN_DPPT          ; 76
	const MUSIC_MOUNT_CORONET_DPPT           ; 77
	const MUSIC_ETERNA_FOREST_DPPT           ; 78
	const MUSIC_GAME_CORNER_DPPT             ; 79
	const MUSIC_CHAMPION_BATTLE_DPPT         ; 7a
	const MUSIC_ROUTE_12_BW                  ; 7b
	const MUSIC_TRAINER_BATTLE_BW            ; 7c
	const MUSIC_WCS_BATTLE_BW                ; 7d
	const MUSIC_FINAL_POKEMON_BW             ; 7e
	const MUSIC_REVERSAL_MOUNTAIN_W2         ; 7f
	const MUSIC_WHITE_TREEHOLLOW_W2          ; 80
	const MUSIC_CHAMPION_BATTLE_B2W2         ; 81
	const MUSIC_TITLE_XY                     ; 82
	const MUSIC_BICYCLE_XY                   ; 83
	const MUSIC_LAVERRE_CITY_XY              ; 84
	const MUSIC_FROST_CAVERN_XY              ; 85
	const MUSIC_POWER_PLANT_XY               ; 86
	const MUSIC_RIVAL_BATTLE_XY              ; 87
	const MUSIC_GYM_LEADER_BATTLE_XY         ; 88
	const MUSIC_LAVENDER_TOWN_RBY            ; 89
	const MUSIC_POKEMON_TOWER_RBY            ; 8a
	const MUSIC_CINNABAR_MANSION_RBY         ; 8b
	const MUSIC_DIGLETTS_CAVE_RBY            ; 8c
	const MUSIC_CERULEAN_CAVE_RBY            ; 8d
	const MUSIC_INDIGO_PLATEAU_RBY           ; 8e
	const MUSIC_MOUNT_CHIMNEY_RSE            ; 8f
	const MUSIC_MOUNT_PYRE_RSE               ; 90
	const MUSIC_ABANDONED_SHIP_RSE           ; 91
	const MUSIC_GYM_LEADER_BATTLE_RSE        ; 92
	const MUSIC_GYM_LEADER_BATTLE_DPPT       ; 93
	const MUSIC_GYM_LEADER_BATTLE_BW         ; 94
	const MUSIC_CHAMPION_BATTLE_RSE          ; 95
	const MUSIC_FRONTIER_BRAIN_BATTLE_RSE    ; 96
	const MUSIC_KANTO_LEGEND_BATTLE_XY       ; 97
	const MUSIC_WALLY_BATTLE_ORAS            ; 98
	const MUSIC_ZINNIA_ENCOUNTER_ORAS        ; 99
	const MUSIC_ZINNIA_BATTLE_ORAS           ; 9a
	const MUSIC_WILD_BATTLE_SM               ; 9b
	const MUSIC_TRAINER_BATTLE_SM            ; 9c
	const MUSIC_ELITE_FOUR_BATTLE_SM         ; 9d
	const MUSIC_MOTHER_BEAST_BATTLE_SM       ; 9e
	const MUSIC_LUGIAS_SONG_2000             ; 9f
	; special
	const MUSIC_RADIO_TOWER                  ; a0
	const MUSIC_MAHOGANY_MART                ; a1
