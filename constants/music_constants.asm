	...
	const MUSIC_BATTLE_TOWER_THEME           ; 60
	const MUSIC_SUICUNE_BATTLE               ; 61
	const MUSIC_BATTLE_TOWER_LOBBY           ; 62
	const MUSIC_POKECOM_CENTER               ; 63
	...
	const MUSIC_SURFING_PIKACHU              ; 81
