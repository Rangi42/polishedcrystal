	...
	const YLW_APRICORN ; $83
	const GRN_APRICORN ; $84
	const WHT_APRICORN ; $85
	const BLK_APRICORN ; $86
	const PNK_APRICORN ; $87
...
; held item effects
	...
	const HELD_CHOICE_ATK
	const HELD_CHOICE_DEF ; $40
	const HELD_CHOICE_SPD
	const HELD_CHOICE_SAT
	const HELD_CHOICE_SDF

	const HELD_SELF_PSN
	const HELD_SELF_BRN
	const HELD_SELF_FRZ
	const HELD_SELF_PAR
	const HELD_SELF_SLP ; $48
