...
; - KeyItemEffects (see engine/items/item_effects.asm)
	...
	const SQUIRTBOTTLE ; 08
	const SECRETPOTION ; 09
	const RED_SCALE    ; 0a
	const CARD_KEY     ; 0b
	const BASEMENT_KEY ; 0c
	const S_S_TICKET   ; 0d
	const PASS         ; 0e
	const MACHINE_PART ; 0f
	const LOST_ITEM    ; 10
	const RAINBOW_WING ; 11
	const SILVER_WING  ; 12
	const CLEAR_BELL   ; 13
	const GS_BALL      ; 14
	const BLUE_CARD    ; 15
	const ORANGETICKET ; 16
	const MYSTICTICKET ; 17
	const OLD_SEA_MAP  ; 18
	const SHINY_CHARM  ; 19
	const OVAL_CHARM   ; 1a
	const CATCH_CHARM  ; 1b
	const SILPHSCOPE2  ; 1c
