	...
	const FRESH_WATER  ; $1f
	const SODA_POP     ; $20
	const LEMONADE     ; $21
	const MOOMOO_MILK  ; $22
	const RAGECANDYBAR ; $23

	const SACRED_ASH   ; $24
	const ENERGYPOWDER ; $25
	const ENERGY_ROOT  ; $26
	const HEAL_POWDER  ; $27
	const REVIVAL_HERB ; $28
	...
	const MAX_REPEL    ; $33
	const ESCAPE_ROPE  ; $34
	const POKE_DOLL    ; $35

	const ABILITY_CAP  ; $36

	const LEAF_STONE   ; $37
	const FIRE_STONE   ; $38
	const WATER_STONE  ; $39
	const THUNDERSTONE ; $3a
	const MOON_STONE   ; $3b
	const SUN_STONE    ; $3c
	const DUSK_STONE   ; $3d
	const SHINY_STONE  ; $3e
	const EVERSTONE    ; $3f
	...
	const ITEMFINDER   ; $45
	const EXP_SHARE    ; $46
	const MYSTERY_EGG  ; $47
	const SQUIRTBOTTLE ; $48
	const SECRETPOTION ; $49
	const RED_SCALE    ; $4a
	const CARD_KEY     ; $4b
	const BASEMENT_KEY ; $4c
	const S_S_TICKET   ; $4d
	const PASS         ; $4e
	const MACHINE_PART ; $4f
	const LOST_ITEM    ; $50
	const RAINBOW_WING ; $51
	const SILVER_WING  ; $52
	const CLEAR_BELL   ; $53
	const GS_BALL      ; $54
	const BLUE_CARD    ; $55
	const MYSTICTICKET ; $56
	const OLD_SEA_MAP  ; $57

	const ORAN_BERRY   ; $58
	const SITRUS_BERRY ; $59
	const PECHA_BERRY  ; $5a
	const RAWST_BERRY  ; $5b
	const CHERI_BERRY  ; $5c
	const CHESTO_BERRY ; $5d
	const ASPEAR_BERRY ; $5e
	const PERSIM_BERRY ; $5f
	const LUM_BERRY    ; $60
	const LEPPA_BERRY  ; $61

	const POMEG_BERRY  ; $62
	const KELPSY_BERRY ; $63
	const QUALOT_BERRY ; $64
	const HONDEW_BERRY ; $65
	const GREPA_BERRY  ; $66
	const TAMATO_BERRY ; $67

	const RED_APRICORN ; $68
	const BLU_APRICORN ; $69
	const YLW_APRICORN ; $6a
	const GRN_APRICORN ; $6b
	const WHT_APRICORN ; $6c
	const BLK_APRICORN ; $6d
	const PNK_APRICORN ; $6e

	const HEAVY_BALL   ; $6f
	const LEVEL_BALL   ; $70
	const LURE_BALL    ; $71
	const FAST_BALL    ; $72
	const FRIEND_BALL  ; $73
	const MOON_BALL    ; $74
	const LOVE_BALL    ; $75
	...
	const BLACK_BELT   ; $77
	const SHARP_BEAK   ; $78
	const POISON_BARB  ; $79
	const SOFT_SAND    ; $7a
	const HARD_STONE   ; $7b
	const SILVERPOWDER ; $7c
	const SPELL_TAG    ; $7d
	const METAL_COAT   ; $7e
	const CHARCOAL     ; $7f
	const MYSTIC_WATER ; $80
	const MIRACLE_SEED ; $81
	const MAGNET       ; $82
	const TWISTEDSPOON ; $83
	const NEVERMELTICE ; $84
	const DRAGON_FANG  ; $85
	const BLACKGLASSES ; $86
	const PINK_BOW     ; $87

	const BRIGHTPOWDER ; $88
	const SCOPE_LENS   ; $89
	const QUICK_CLAW   ; $8a
	const KINGS_ROCK   ; $8b
	const FOCUS_BAND   ; $8c
	...
	const SMOKE_BALL   ; $91
	const BERSERK_GENE ; $92

	const LIGHT_BALL   ; $93
	const STICK        ; $94
	const THICK_CLUB   ; $95
	const LUCKY_PUNCH  ; $96
	const METAL_POWDER ; $97
	const QUICK_POWDER ; $98

	const AIR_BALLOON  ; $99
	const ASSAULT_VEST ; $9a
	const BIG_ROOT     ; $9b
	const BINDING_BAND ; $9c
	const DESTINY_KNOT ; $9d
	const EVIOLITE     ; $9e
	const EXPERT_BELT  ; $9f
	const FOCUS_SASH   ; $a0
	const GRIP_CLAW    ; $a1
	const LIFE_ORB     ; $a2
	const LIGHT_CLAY   ; $a3
	const METRONOME_I  ; $a4
	const MUSCLE_BAND  ; $a5
	const ROCKY_HELMET ; $a6
	const SAFE_GOGGLES ; $a7
	const SHED_SHELL   ; $a8
	const SHELL_BELL   ; $a9
	const SOOTHE_BELL  ; $aa
	const WEAK_POLICY  ; $ab
	const WIDE_LENS    ; $ac
	const WISE_GLASSES ; $ad
	const ZOOM_LENS    ; $ae
	...
	const SLP_GUARD    ; $b2
	const FRZ_GUARD    ; $b3
	const CONFUSEGUARD ; $b4
	const ATTRACTGUARD ; $b5
	const FLINCH_GUARD ; $b6

	const MENTAL_HERB  ; $b7
	const POWER_HERB   ; $b8
	const WHITE_HERB   ; $b9
	...
	const CHOICE_SCARF ; $bf
	const CHOICE_SPECS ; $c0

	const MACHO_BRACE  ; $c1
	const POWER_WEIGHT ; $c2
	const POWER_BRACER ; $c3
	const POWER_BELT   ; $c4
	const POWER_LENS   ; $c5
	const POWER_BAND   ; $c6
	const POWER_ANKLET ; $c7

	const DRAGON_SCALE ; $c8
	const UP_GRADE     ; $c9
	const DUBIOUS_DISC ; $ca
	const PROTECTOR    ; $cb
	const ELECTIRIZER  ; $cc
	const MAGMARIZER   ; $cd
	const RAZOR_FANG   ; $ce
	const RAZOR_CLAW   ; $cf
	...
	const NUGGET       ; $d0
	const BIG_NUGGET   ; $d1
	const TINYMUSHROOM ; $d2
	const BIG_MUSHROOM ; $d3
	const BALMMUSHROOM ; $d4
	const PEARL        ; $d5
	const BIG_PEARL    ; $d6
	const PEARL_STRING ; $d7
	const STARDUST     ; $d8
	const STAR_PIECE   ; $da
	const BRICK_PIECE  ; $db
	const RARE_BONE    ; $dc
	const SILVER_LEAF  ; $dd
	const GOLD_LEAF    ; $de
	const SLOWPOKETAIL ; $df
	const BOTTLE_CAP   ; $e0

	const PARK_BALL    ; $e1
	const REPEAT_BALL  ; $e2
	const TIMER_BALL   ; $e3
	const QUICK_BALL   ; $e4
	const DUSK_BALL    ; $e5
	const PREMIER_BALL ; $e6
	const CHERISH_BALL ; $e7
