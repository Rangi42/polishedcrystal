	...
	const SQUIRTBOTTLE   ; $45
	const SECRETPOTION   ; $46
	const RED_SCALE      ; $47
	const CARD_KEY       ; $48
	const BASEMENT_KEY   ; $49
	const S_S_TICKET     ; $4A
	const PASS           ; $4B
	const MACHINE_PART   ; $4C
	const LOST_ITEM      ; $4D
	const RAINBOW_WING   ; $4E
	...
	const PORTRAITMAIL   ; $A3
	const LOVELY_MAIL    ; $A4
	const EON_MAIL       ; $A5
	const MORPH_MAIL     ; $A6
	const BLUESKY_MAIL   ; $A7
	const MUSIC_MAIL     ; $A8
	const MIRAGE_MAIL    ; $A9
	...
	add_tm PROTECT       ; $C2
	add_tm RAIN_DANCE    ; $C3
	add_tm GIGA_DRAIN    ; $C4
	add_tm ENDURE        ; $C5
	add_tm ICE_PUNCH     ; $C6
	add_tm SOLARBEAM     ; $C7
	add_tm IRON_TAIL     ; $C8
