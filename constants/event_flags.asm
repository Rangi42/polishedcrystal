...
; TODO: reorganize events
	...
	const EVENT_MURKY_SWAMP_HYPER_POTION
	const EVENT_MURKY_SWAMP_ANTIDOTE
	...
	const EVENT_MURKY_SWAMP_HIDDEN_FULL_HEAL
	...
	const EVENT_NOISY_FOREST_FULL_HEAL
