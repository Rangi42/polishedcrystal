...
; New to Crystal
	...
	; TODO: Does each Gym Leader need a separate flag?
	const EVENT_REMATCH_BROCK
	const EVENT_REMATCH_MISTY
	const EVENT_REMATCH_SURGE
	const EVENT_REMATCH_ERIKA
	const EVENT_REMATCH_JANINE
	const EVENT_REMATCH_SABRINA
	const EVENT_REMATCH_BLAINE
	const EVENT_REMATCH_BLUE
	const EVENT_REMATCH_FALKNER
	const EVENT_REMATCH_BUGSY
	const EVENT_REMATCH_WHITNEY
	const EVENT_REMATCH_MORTY
	const EVENT_REMATCH_CHUCK
	const EVENT_REMATCH_JASMINE
	const EVENT_REMATCH_PRYCE
	const EVENT_REMATCH_CLAIR
