...
; Johto story events
	...
	const EVENT_GOT_FLIKLIT_FROM_ELM
	const EVENT_GOT_GLUTTLE_FROM_ELM
	const EVENT_GOT_CUPICO_FROM_ELM
...
; Crystal-exclusive events in Johto
	...
	const EVENT_GOT_QUICK_BALL_FROM_OLSTEETON
...
; Decorations
	...
	const EVENT_DECO_FLIKLIT_DOLL
	const EVENT_DECO_GLUTTLE_DOLL
	const EVENT_DECO_CUPICO_DOLL
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_GOT_CUPICO_FROM_IVY
	const EVENT_GOT_FLIKLIT_FROM_IVY
	const EVENT_GOT_GLUTTLE_FROM_IVY
...
; Johto itemballs
	...
	const EVENT_PLAYER_HOUSE_RARE_CANDY
...
; Johto people
	...
	const EVENT_PLAYERS_HOUSE_MOTHER
	const EVENT_PLAYERS_SISTER
...
; Aplan Story Events
	const EVENT_FAKE_BATTLE
	const EVENT_FAKE_BATTLE_2
...
; Aplan itemballs
	...
	const EVENT_ROUTE_102_GREAT_BALL
	const EVENT_ROUTE_102_REPEL
	const EVENT_ROUTE_27_RARE_CANDY
	const EVENT_PLAYER_HOUSE_POTION
	
; Aplan Hidden Items
	const EVENT_PLAYER_HOUSE_HIDDEN_RARE_CANDY
	const EVENT_HOLLOWPORT_HIDDEN_POTION
	const EVENT_HOLLOWPORT_HIDDEN_NUGGET
	const EVENT_ROUTE_101_HIDDEN_SUPER_POTION

; Jolly Sods 
	const EVENT_NATIONAL_FOREST1_HIDDEN_SUPER_POTION
	const EVENT_NATIONAL_FOREST1_ANTIDOTE
	const EVENT_TALKED_TO_CC
	const EVENT_TALKED_MEGACORP_GOON
