...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_REGIS ; unused (HGSS, Route 3)
; Bug Catcher
...
; Camper
	...
	const EVENT_BEAT_CAMPER_TANNER ; unused (HGSS, Route 13)
	const EVENT_BEAT_CAMPER_CLARK ; unused (HGSS, Route 13)
	const EVENT_BEAT_CAMPER_PEDRO ; unused (HGSS, Route 20)
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_GINGER ; unused (HGSS, Route 13)
	const EVENT_BEAT_PICNICKER_CHEYENNE ; unused (HGSS, Route 20)
	const EVENT_BEAT_PICNICKER_ADRIAN ; unused (HGSS, Route 20)
; Twins
...
; Fisher
	...
	const EVENT_BEAT_FISHER_KYLER ; unused (HGSS, Route 12)
	const EVENT_BEAT_FISHER_MURPHY ; unused (HGSS, Route 21)
	const EVENT_BEAT_FISHER_LIAM ; unused (HGSS, Route 21)
	const EVENT_BEAT_FISHER_GIDEON ; unused (HGSS, Route 21)
; Bird Keeper
	...
	const EVENT_BEAT_BIRD_KEEPER_JUSTIN ; unused (HGSS, Route 12)
	const EVENT_BEAT_BIRD_KEEPER_GAIL ; unused (HGSS, Route 12)
	const EVENT_BEAT_BIRD_KEEPER_JOSH ; unused (HGSS, Route 14)
	const EVENT_BEAT_BIRD_KEEPER_BERT ; unused (HGSS, Route 20)
	const EVENT_BEAT_BIRD_KEEPER_ERNIE ; unused (HGSS, Route 20)
	const EVENT_BEAT_BIRD_KEEPER_KINSLEY ; unused (HGSS, Route 21)
	const EVENT_BEAT_BIRD_KEEPER_EASTON ; unused (HGSS, Route 21)
; Hiker
	...
	const EVENT_BEAT_HIKER_BRUCE ; unused (HGSS, Route 3)
	const EVENT_BEAT_HIKER_DWIGHT ; unused (HGSS, Route 3)
; GruntM
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_MOE
...
; Schoolboy
	...
	const EVENT_BEAT_SCHOOLBOY_CONNOR ; unused (HGSS, Route 14)
	const EVENT_BEAT_SCHOOLBOY_TORIN ; unused (HGSS, Route 14)
	const EVENT_BEAT_SCHOOLBOY_TRAVIS ; unused (HGSS, Route 14)
; Schoolgirl
	const EVENT_BEAT_SCHOOLGIRL_AUDREY
...
; Couple
	...
	const EVENT_BEAT_COUPLE_MOE_AND_LULU ; unused (HGSS, Route 8)
	const EVENT_BEAT_COUPLE_VIC_AND_TARA ; unused (HGSS, Route 12)
	const EVENT_BEAT_COUPLE_TIM_AND_SUE ; unused (HGSS, Route 13)
; Gentleman
...
; SwimmerM
	...
	const EVENT_BEAT_SWIMMERM_LUIS ; unused (HGSS, Route 20)
	const EVENT_BEAT_SWIMMERM_ELMO ; unused (HGSS, Route 20)
	const EVENT_BEAT_SWIMMERM_CHELAN ; unused (HGSS, Route 21)
	const EVENT_BEAT_SWIMMERM_ESTEBAN ; unused (HGSS, Route 21)
; Swimmer F
	...
	const EVENT_BEAT_SWIMMERF_MINA ; unused (HGSS, Route 20)
	const EVENT_BEAT_SWIMMERF_LEONA ; unused (HGSS, Route 20)
	const EVENT_BEAT_SWIMMERF_DUANE ; unused (HGSS, Route 21)
	const EVENT_BEAT_SWIMMERF_KENDRA ; unused (HGSS, Route 21)
; Burglar
...
; Blackbelt T
	...
	const EVENT_BEAT_BLACKBELT_MANFORD ; unused (HGSS, Route 3)
	const EVENT_BEAT_BLACKBELT_ANDER ; unused (HGSS, Route 3)
; Battle Girl
...
; Teacher
	...
	const EVENT_BEAT_TEACHER_CLARICE ; unused (HGSS, Route 14)
; GuitaristM
...
; Biker
	...
	const EVENT_BEAT_BIKER_DAN ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_TEDDY ; unused (HGSS, Route 17)
; Roughneck
