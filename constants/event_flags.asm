...
; Johto story events
	...
	const EVENT_GOT_POM_POM
	const EVENT_MANIA_TOOK_POM_POM_OR_LET_YOU_KEEP_HIM
...
; Camper
	...
	const EVENT_ROUTE_8_SNORLAX ; EVENT_BEAT_CAMPER_HARVEY unused (TODO: relocate)
	const EVENT_TRAINER_HOUSE_CAL ; EVENT_BEAT_CAMPER_DALE unused (TODO: relocate)
	const EVENT_BEAT_CAMPER_TED
	const EVENT_BEAT_CAMPER_TODD2
	const EVENT_BEAT_CAMPER_TODD3
	const EVENT_TRAINER_HOUSE_KAY ; EVENT_BEAT_CAMPER_THOMAS unused (TODO: relocate)
...
; GruntM
	const EVENT_BEAT_ROCKET_EXECUTIVEM_6 ; EVENT_BEAT_ROCKET_GRUNTM_1 unused (TODO: relocate)
