...
; More Johto events
	...
	const EVENT_SHOWED_KANGASKHAN_TO_BILLS_GRANDPA
...
; Game Freak
	const EVENT_BEAT_GAME_FREAK_MORIMOTO
	const EVENT_BEAT_GAME_FREAK_NISHINO
	const EVENT_BEAT_GAME_FREAK_ISHIHARA
; Eusine
