...
; Crystal-exclusive events in Johto
	...
	const EVENT_GOT_NET_BALLS_FROM_PROF_OAKS_AIDE
...
; Kanto people
	...
	const EVENT_BIG_LAPRAS_DOLL_ON_SALE ; TODO: remove
	const EVENT_BIG_SNORLAX_DOLL_ON_SALE ; TODO: remove
	const EVENT_BIG_ONIX_DOLL_ON_SALE ; TODO: remove
