...
; Johto story events
	...
	const EVENT_GOT_FOCUS_SASH_FROM_ROUTE_46_LEADER
	const EVENT_GOT_CHOICE_SPECS_FROM_ROUTE_26_LEADER
	...
	const EVENT_LISTENED_TO_SUBSTITUTE_INTRO
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_LENIE
; Ace Duo
...
; Kanto items
	...
	const EVENT_DIM_CAVE_3F_LIGHT_CLAY
