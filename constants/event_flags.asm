...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_MATT
	const EVENT_BEAT_COOLTRAINERM_RINGO
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_JOANNE
	const EVENT_BEAT_COOLTRAINERF_KOTORI
; Ace Duo
...
; Game Freak
	const EVENT_BEAT_GAME_FREAK_MORIMOTO ; unused
	const EVENT_BEAT_GAME_FREAK_NISHINO ; unused
	const EVENT_BEAT_GAME_FREAK_ISHIHARA ; unused
; Eusine
...
; Johto items:
	...
	const EVENT_LAKE_OF_RAGE_TM_SHADOW_CLAW
	...
	const EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_TM_AVALANCHE
