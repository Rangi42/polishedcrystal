...
; Twins
	...
	const EVENT_BEAT_TWINS_DAY_AND_DANI2
	const EVENT_BEAT_TWINS_KAY_AND_TIA
	const EVENT_BEAT_TWINS_KAY_AND_TIA2
; Fisher
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_ABDUL
	const EVENT_BEAT_COOLTRAINERM_ELAN
...
; CooltrainerF
	...
	const EVENT_BEAT_COOLTRAINERF_IDA
...
; New to Crystal
	...
	const EVENT_GOT_TRAINER_HOUSE_REWARD
