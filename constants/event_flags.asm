...
; Biker
	...
	const EVENT_BEAT_BIKER_DALE ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_JACOB ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_AIDEN ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_DAN ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_THERON ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_TEDDY ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_MARKEY ; unused (HGSS, Route 17)
	const EVENT_BEAT_BIKER_ERNEST ; unused (HGSS, Route 17)
; Roughneck
; CooltrainerM
