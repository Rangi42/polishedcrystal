...
; Cut trees
	...
	const EVENT_ROUTE_16_CUT_TREE
 	const_skip ; previously EVENT_ROUTE_16_WEST_CUT_TREE_1
...
; TODO: rearrange
	...
	const EVENT_LISTENED_TO_CHARM_INTRO ; Johto
	const EVENT_LISTENED_TO_AGILITY_INTRO ; Johto
	const EVENT_LISTENED_TO_TRICK_ROOM_INTRO ; Kanto
	const EVENT_MURKY_SWAMP_BLOODMOON_URSALUNA
	const EVENT_BEAT_LASS_ABIGAIL ; Johto
	const EVENT_BEAT_POKEMANIAC_LUIGI ; Johto
