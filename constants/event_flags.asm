...
; TODO: rearrange
	...
	const EVENT_BEAT_SCIENTIST_LYSANDER
	const EVENT_BEAT_PICNICKER_ZANE
	const EVENT_BEAT_BATTLE_GIRL_SASHA
	const EVENT_BEAT_LASS_PIPER
	const EVENT_PICKED_UP_RARE_CANDY_1_FROM_ROCKET_HIDEOUT_B1F
	const EVENT_PICKED_UP_RARE_CANDY_2_FROM_ROCKET_HIDEOUT_B1F
	const EVENT_ROCKET_HIDEOUT_B1F_HIDDEN_RARE_CANDY
	const EVENT_BEAT_HEX_MANIAC_CORINNE
	const EVENT_PICKED_UP_RARE_CANDY_1_FROM_ROCKET_HIDEOUT_B2F
	const EVENT_PICKED_UP_RARE_CANDY_2_FROM_ROCKET_HIDEOUT_B2F
	const EVENT_PICKED_UP_RARE_CANDY_3_FROM_ROCKET_HIDEOUT_B2F
	const EVENT_PICKED_UP_RARE_CANDY_4_FROM_ROCKET_HIDEOUT_B2F
	const EVENT_BEAT_COSPLAYER_AARON
	const EVENT_BEAT_COOL_DUDE_GIDEON
	const EVENT_PICKED_UP_RARE_CANDY_1_FROM_ROCKET_HIDEOUT_B3F
	const EVENT_PICKED_UP_RARE_CANDY_2_FROM_ROCKET_HIDEOUT_B3F
	const EVENT_ROCKET_HIDEOUT_B3F_HIDDEN_RARE_CANDY
	const EVENT_BEAT_YOUNGSTER_RORY
	const EVENT_PICKED_UP_LIFT_KEY_FROM_ROCKET_HIDEOUT_B4F
	const EVENT_BEAT_TEACHER_SERENA
	const EVENT_BEAT_SUPER_NERD_THEO
	const EVENT_ROCKET_HIDEOUT_B4F_HIDDEN_RARE_CANDY
	const EVENT_PICKED_UP_RARE_CANDY_1_FROM_ROCKET_HIDEOUT_B4F
	const EVENT_PICKED_UP_RARE_CANDY_2_FROM_ROCKET_HIDEOUT_B4F
	const EVENT_PICKED_UP_RARE_CANDY_3_FROM_ROCKET_HIDEOUT_B4F
