...
; sprites
	...
	const SPRITE_YOUNGSTER ; 56
	const SPRITE_NURSE ; 57
	const SPRITE_CLERK ; 58
	const SPRITE_RECEPTIONIST ; 59
	const SPRITE_LINK_RECEPTIONIST ; 5a
	const SPRITE_GYM_GUY ; 5b
	const SPRITE_FISHING_GURU ; 5c
	const SPRITE_GAMEBOY_KID ; 5d
	const SPRITE_STANDING_YOUNGSTER ; 5e
	const SPRITE_CAL ; 5f
	const SPRITE_KURT_OUTSIDE ; 60
	const SPRITE_SURF ; 61
	const SPRITE_SURFING_PIKACHU ; 62
	const SPRITE_BIG_SNORLAX ; 63
	const SPRITE_BIG_LAPRAS ; 64
	const SPRITE_BIG_ONIX ; 65
	const SPRITE_WEIRD_TREE ; 66
	const SPRITE_UNOWN_W ; 67
	const SPRITE_UNOWN_A ; 68
	const SPRITE_UNOWN_R ; 69
	const SPRITE_UNOWN_P ; 6a
	const SPRITE_POKE_BALL ; 6b
	const SPRITE_POKEDEX ; 6c
	const SPRITE_PAPER ; 6d
	const SPRITE_ROCK ; 6e
	const SPRITE_BOULDER ; 6f
	const SPRITE_FRUIT_TREE ; 70
	const SPRITE_FOSSIL ; 71
	const SPRITE_SNES ; 72
	const SPRITE_N64 ; 73
	const SPRITE_GAMECUBE ; 74
	const SPRITE_WII ; 75
	const SPRITE_SILVER_TROPHY ; 76
	const SPRITE_GOLD_TROPHY ; 77
	const SPRITE_BIRD ; 78
	const SPRITE_DRAGON ; 79
	const SPRITE_FAIRY ; 7a
...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_MILTANK ; b5
	const SPRITE_BLISSEY ; b6
	const SPRITE_RAIKOU ; b7
	const SPRITE_ENTEI ; b8
	const SPRITE_SUICUNE ; b9
