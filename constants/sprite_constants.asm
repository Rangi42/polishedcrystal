...
; sprites
	...
	const SPRITE_LAWRENCE ; $2e
	const SPRITE_JAMES ; $2f
	const SPRITE_JESSIE ; $30
	const SPRITE_PROTON ; $31
	const SPRITE_PETREL ; $32
	const SPRITE_ARCHER ; $33
	const SPRITE_ARIANA ; $34
	const SPRITE_GIOVANNI ; $35
	const SPRITE_CHERYL ; $36
	const SPRITE_RILEY ; $37
	const SPRITE_BUCK ; $38
	const SPRITE_MARLEY ; $39
	const SPRITE_MIRA ; $3a
	const SPRITE_VALERIE ; $3b
	const SPRITE_CAITLIN ; $3c
	const SPRITE_DARACH ; $3d
	const SPRITE_STEVEN ; $3e
	const SPRITE_CYNTHIA ; $3f
	const SPRITE_BUENA ; $40
	const SPRITE_CAPTAIN ; $41
	const SPRITE_BEAUTY ; $42
	const SPRITE_BIKER ; $43
	const SPRITE_BLACK_BELT ; $44
	const SPRITE_BOARDER ; $45
	const SPRITE_BREEDER ; $46
	const SPRITE_BUG_CATCHER ; $47
	const SPRITE_COOLTRAINER_F ; $48
	const SPRITE_COOLTRAINER_M ; $49
	const SPRITE_COSPLAYER ; $4a
	const SPRITE_COWGIRL ; $4b
	const SPRITE_DRAGON_TAMER ; $4c
	const SPRITE_ELDER ; $4d
	const SPRITE_FISHER ; $4e
	const SPRITE_GENTLEMAN ; $4f
	const SPRITE_GRAMPS ; $50
	const SPRITE_GRANNY ; $51
	const SPRITE_HEX_MANIAC ; $52
	const SPRITE_KIMONO_GIRL ; $53
	const SPRITE_LADY ; $54
	const SPRITE_LASS ; $55
	const SPRITE_OFFICER ; $56
	const SPRITE_OFFICER_F ; $57
	const SPRITE_PHARMACIST ; $58
	const SPRITE_PI ; $59
	const SPRITE_POKEFAN_F ; $5a
	const SPRITE_POKEFAN_M ; $5b
	const SPRITE_RICH_BOY ; $5c
	const SPRITE_ROCKER ; $5d
	const SPRITE_ROCKET ; $5e
	const SPRITE_ROCKET_GIRL ; $5f
	const SPRITE_ROUGHNECK ; $60
	const SPRITE_SAGE ; $61
	const SPRITE_SAILOR ; $62
	const SPRITE_SCIENTIST ; $63
	const SPRITE_SKIER ; $64
	const SPRITE_SUPER_NERD ; $65
	const SPRITE_SWIMMER_GIRL ; $66
	const SPRITE_SWIMMER_GUY ; $67
	const SPRITE_TEACHER ; $68
	const SPRITE_TWIN ; $69
	const SPRITE_VETERAN_M ; $6a
	const SPRITE_VETERAN_F ; $6b
	const SPRITE_YOUNGSTER ; $6c
	const SPRITE_NURSE ; $6d
	const SPRITE_CLERK ; $6e
	const SPRITE_RECEPTIONIST ; $6f
	const SPRITE_LINK_RECEPTIONIST ; $70
	const SPRITE_GYM_GUY ; $71
	const SPRITE_FISHING_GURU ; $72
	const SPRITE_GAMEBOY_KID ; $73
	const SPRITE_STANDING_YOUNGSTER ; $74
	const SPRITE_SWIMMING_OFFICER ; $75
	const SPRITE_SWIMMING_OFFICER_F ; $76
	const SPRITE_CAL ; $77
	const SPRITE_KURT_OUTSIDE ; $78
	const SPRITE_CLEFAIRY_WALK ; $79
	const SPRITE_FARFETCH_D ; $7a
	const SPRITE_LAPRAS ; $7b
	const SPRITE_EEVEE ; $7c
	const SPRITE_DRAGONITE ; $7d
	const SPRITE_MEW ; $7e
	const SPRITE_CELEBI ; $7f
	const SPRITE_SURFING_PIKACHU ; $80
	const SPRITE_ARMORED_MEWTWO ; $81
	const SPRITE_BIG_SNORLAX ; $82
	const SPRITE_BIG_LAPRAS ; $83
	const SPRITE_BIG_ONIX ; $84
	const SPRITE_WEIRD_TREE ; $85
	const SPRITE_UNOWN_W ; $86
	const SPRITE_UNOWN_A ; $87
	const SPRITE_UNOWN_R ; $88
	const SPRITE_UNOWN_P ; $89
	const SPRITE_GYARADOS_TOP_LEFT ; $8a
	const SPRITE_GYARADOS_TOP_RIGHT ; $8b
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $8c
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $8d
	const SPRITE_POKE_BALL ; $8e
	const SPRITE_POKEDEX ; $8f
	const SPRITE_BOOK ; $90
	const SPRITE_PAPER ; $91
	const SPRITE_ROCK ; $92
	const SPRITE_BOULDER ; $93
	const SPRITE_CUT_TREE ; $94
	const SPRITE_FRUIT_TREE ; $95
	const SPRITE_ELECTRIC_FENCE_LEFT ; $96
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $97
	const SPRITE_FOSSIL ; $98
	const SPRITE_SNES ; $99
	const SPRITE_N64 ; $9a
	const SPRITE_GAMECUBE ; $9b
	const SPRITE_WII ; $9c
	const SPRITE_SILVER_TROPHY ; $9d
	const SPRITE_GOLD_TROPHY ; $9e

const_value SET $a0
SPRITE_POKEMON EQU const_value
	const SPRITE_BULBASAUR ; $a0
	const SPRITE_CHARMANDER ; $a1
	const SPRITE_SQUIRTLE ; $a2
	const SPRITE_WEEDLE ; $a3
	const SPRITE_PIDGEY ; $a4
	const SPRITE_PIDGEOTTO ; $a5
	const SPRITE_PIDGEOT ; $a6
	const SPRITE_RATTATA ; $a7
	const SPRITE_PIKACHU ; $a8
	const SPRITE_NIDORAN_F ; $a9
	const SPRITE_NIDORAN_M ; $aa
	const SPRITE_NIDORINO ; $ab
	const SPRITE_CLEFAIRY ; $ac
	const SPRITE_JIGGLYPUFF ; $ad
	const SPRITE_ZUBAT ; $ae
	const SPRITE_ODDISH ; $af
	const SPRITE_DIGLETT ; $b0
	const SPRITE_MEOWTH ; $b1
	const SPRITE_PERSIAN ; $b2
	const SPRITE_PSYDUCK ; $b3
	const SPRITE_POLIWAG ; $b4
	const SPRITE_POLIWRATH ; $b5
	const SPRITE_ABRA ; $b6
	const SPRITE_MACHOP ; $b7
	const SPRITE_MACHOKE ; $b8
	const SPRITE_TENTACOOL ; $b9
	const SPRITE_GEODUDE ; $ba
	const SPRITE_SLOWPOKE ; $bb
	const SPRITE_SLOWBRO ; $bc
	const SPRITE_DODRIO ; $bd
	const SPRITE_GRIMER ; $be
	const SPRITE_SHELLDER ; $bf
	const SPRITE_GENGAR ; $c0
	const SPRITE_VOLTORB ; $c1
	const SPRITE_ELECTRODE ; $c2
	const SPRITE_RHYDON ; $c3
	const SPRITE_CHANSEY ; $c4
	const SPRITE_KANGASKHAN ; $c5
	const SPRITE_STARYU ; $c6
	const SPRITE_MAGIKARP ; $c7
	const SPRITE_ARTICUNO ; $c8
	const SPRITE_ZAPDOS ; $c9
	const SPRITE_MOLTRES ; $ca
	const SPRITE_DRATINI ; $cb
	const SPRITE_MEWTWO ; $cc
	const SPRITE_BAYLEEF ; $cd
	const SPRITE_FURRET ; $ce
	const SPRITE_HOOTHOOT ; $cf
	const SPRITE_AMPHAROS ; $d0
	const SPRITE_MARILL ; $d1
	const SPRITE_MURKROW ; $d2
	const SPRITE_UNOWN ; $d3
	const SPRITE_HERACROSS ; $d4
	const SPRITE_URSARING ; $d5
	const SPRITE_SKARMORY ; $d6
	const SPRITE_MILTANK ; $d7
	const SPRITE_BLISSEY ; $d8
	const SPRITE_RAIKOU ; $d9
	const SPRITE_ENTEI ; $da
	const SPRITE_SUICUNE ; $db
	const SPRITE_LUGIA ; $dc
	const SPRITE_HO_OH ; $dd
	const SPRITE_EGG ; $de

	const SPRITE_DAYCARE_MON_1 ; $df
	const SPRITE_DAYCARE_MON_2 ; $e0

const_value SET $e8
SPRITE_VARS EQU const_value
	const SPRITE_CONSOLE ; $e8
	const SPRITE_DOLL_1 ; $e9
	const SPRITE_DOLL_2 ; $ea
	const SPRITE_BIG_DOLL ; $eb
	const SPRITE_FUCHSIA_GYM_1 ; $ec
	const SPRITE_FUCHSIA_GYM_2 ; $ed
	const SPRITE_FUCHSIA_GYM_3 ; $ee
	const SPRITE_FUCHSIA_GYM_4 ; $ef
	const SPRITE_COPYCAT ; $f0
	const SPRITE_JANINE_IMPERSONATOR ; $f1
	const SPRITE_REMATCH_GYM_LEADER_1 ; $f2
	const SPRITE_REMATCH_GYM_LEADER_2 ; $f3
	const SPRITE_REMATCH_GYM_LEADER_3 ; $f4
	const SPRITE_NEW_BARK_LYRA ; $f5
	const SPRITE_AZALEA_ROCKET ; $f6
	const SPRITE_CHERRYGROVE_RIVAL ; $f7
	const SPRITE_OLIVINE_RIVAL ; $f8
	const SPRITE_CERULEAN_CAPE_MISTY ; $f9
