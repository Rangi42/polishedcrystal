...
; sprites
	...
	const SPRITE_LAWRENCE ; 29
	const SPRITE_JAMES ; 2a
	const SPRITE_JESSIE ; 2b
	const SPRITE_GIOVANNI ; 2c
	const SPRITE_VALERIE ; 2d
	const SPRITE_STEVEN ; 2e
	const SPRITE_CYNTHIA ; 2f
	const SPRITE_ELDER ; 30
	const SPRITE_CAPTAIN ; 31
	const SPRITE_BIKER ; 32
	const SPRITE_BLACK_BELT ; 33
	const SPRITE_BREEDER ; 34
	const SPRITE_BUENA ; 35
	const SPRITE_BUG_CATCHER ; 36
	const SPRITE_COOLTRAINER_F ; 37
	const SPRITE_COOLTRAINER_M ; 38
	const SPRITE_COWGIRL ; 39
	const SPRITE_DRAGON_TAMER ; 3a
	const SPRITE_FISHER ; 3b
	const SPRITE_GENTLEMAN ; 3c
	const SPRITE_GRAMPS ; 3d
	const SPRITE_GRANNY ; 3e
	const SPRITE_HEX_MANIAC ; 3f
	const SPRITE_KIMONO_GIRL ; 40
	const SPRITE_LASS ; 41
	const SPRITE_OFFICER ; 42
	const SPRITE_OFFICER_F ; 43
	const SPRITE_PHARMACIST ; 44
	const SPRITE_POKEFAN_F ; 45
	const SPRITE_POKEFAN_M ; 46
	const SPRITE_RICH_BOY ; 47
	const SPRITE_ROCKER ; 48
	const SPRITE_ROCKET ; 49
	const SPRITE_ROCKET_GIRL ; 4a
	const SPRITE_SAGE ; 4b
	const SPRITE_SAILOR ; 4c
	const SPRITE_SCIENTIST ; 4d
	const SPRITE_SUPER_NERD ; 4e
	const SPRITE_SWIMMER_GIRL ; 4f
	const SPRITE_SWIMMER_GUY ; 50
	const SPRITE_TEACHER ; 51
	const SPRITE_TWIN ; 52
	const SPRITE_YOUNGSTER ; 53
	const SPRITE_NURSE ; 54
	const SPRITE_CLERK ; 55
	const SPRITE_RECEPTIONIST ; 56
	const SPRITE_LINK_RECEPTIONIST ; 57
	const SPRITE_GYM_GUY ; 58
	const SPRITE_FISHING_GURU ; 59
	const SPRITE_GAMEBOY_KID ; 5a
	const SPRITE_STANDING_YOUNGSTER ; 5b
	const SPRITE_CAL ; 5c
	const SPRITE_KURT_OUTSIDE ; 5d
	const SPRITE_SURF ; 5e
	const SPRITE_BIG_SNORLAX ; 5f
	const SPRITE_BIG_LAPRAS ; 60
	const SPRITE_BIG_ONIX ; 61
	const SPRITE_SURFING_PIKACHU ; 62
	const SPRITE_WEIRD_TREE ; 63
	const SPRITE_UNOWN_W ; 64
	const SPRITE_UNOWN_A ; 65
	const SPRITE_UNOWN_R ; 66
	const SPRITE_UNOWN_P ; 67
	const SPRITE_POKE_BALL ; 68
	const SPRITE_POKEDEX ; 69
	const SPRITE_PAPER ; 6a
	const SPRITE_ROCK ; 6b
	const SPRITE_BOULDER ; 6c
	const SPRITE_FRUIT_TREE ; 6d
	const SPRITE_FOSSIL ; 6e
	const SPRITE_SNES ; 6f
	const SPRITE_N64 ; 70
	const SPRITE_GAMECUBE ; 71
	const SPRITE_WII ; 72
	const SPRITE_SILVER_TROPHY ; 73
	const SPRITE_GOLD_TROPHY ; 74
