...
; sprites
	...
	const SPRITE_OFFICER ; $69
	const SPRITE_OFFICER_F ; $6a
	const SPRITE_PHARMACIST ; $6b
	const SPRITE_PI ; $6c
	const SPRITE_POKEFAN_F ; $6d
	const SPRITE_POKEFAN_M ; $6e
	const SPRITE_RICH_BOY ; $6f
	const SPRITE_ROCKER ; $70
	const SPRITE_ROCKET ; $71
	const SPRITE_ROCKET_GIRL ; $72
	const SPRITE_ROUGHNECK ; $73
	const SPRITE_SAGE ; $74
	const SPRITE_SAILOR ; $75
	const SPRITE_SCIENTIST ; $76
	const SPRITE_SIGHTSEER_M ; $77
	const SPRITE_SKIER ; $78
	const SPRITE_SUPER_NERD ; $79
	const SPRITE_SWIMMER_GIRL ; $7a
	const SPRITE_SWIMMER_GUY ; $7b
	const SPRITE_TEACHER ; $7c
	const SPRITE_TWIN ; $7d
	const SPRITE_VETERAN_M ; $7e
	const SPRITE_VETERAN_F ; $7f
	const SPRITE_YOUNGSTER ; $80
	const SPRITE_NURSE ; $81
	const SPRITE_CLERK ; $82
	const SPRITE_RECEPTIONIST ; $83
	const SPRITE_LINK_RECEPTIONIST ; $84
	const SPRITE_GYM_GUY ; $85
	const SPRITE_FISHING_GURU ; $86
	const SPRITE_GAMEBOY_KID ; $87
	const SPRITE_SILPH_EMPLOYEE ; $88
	const SPRITE_SWIMMING_OFFICER ; $89
	const SPRITE_SWIMMING_OFFICER_F ; $8a
	const SPRITE_CLEFAIRY_WALK ; $8b
	const SPRITE_FARFETCH_D ; $8c
	const SPRITE_LAPRAS ; $8d
	const SPRITE_EEVEE ; $8e
	const SPRITE_DRAGONITE ; $8f
	const SPRITE_MEW ; $90
	const SPRITE_CELEBI ; $91
	const SPRITE_SURFING_PIKACHU ; $92
	const SPRITE_ARMORED_MEWTWO ; $93
	const SPRITE_BIG_SNORLAX ; $94
	const SPRITE_BIG_LAPRAS ; $95
	const SPRITE_BIG_ONIX ; $96
	const SPRITE_WEIRD_TREE ; $97
	const SPRITE_GYARADOS_TOP_LEFT ; $98
	const SPRITE_GYARADOS_TOP_RIGHT ; $99
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $9a
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $9b
	const SPRITE_BALL_CUT_FRUIT ; $9c
	const SPRITE_BOULDER_ROCK_FOSSIL ; $9d
	const SPRITE_PAPER_UNOWN_W ; $9e
	const SPRITE_POKEDEX_UNOWN_A ; $9f
	const SPRITE_BOOK_UNOWN_R ; $a0
	const SPRITE_SIGN_UNOWN_P ; $a1
	const SPRITE_ELECTRIC_FENCE_LEFT ; $a2
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $a3
