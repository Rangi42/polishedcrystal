; sprites
	...
	const SPRITE_WEIRD_TREE ; $98
	const SPRITE_GYARADOS_TOP_LEFT ; $99
	const SPRITE_GYARADOS_TOP_RIGHT ; $9a
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $9b
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $9c
	const SPRITE_BALL_CUT_FRUIT ; $9d
	const SPRITE_BOULDER_ROCK_FOSSIL ; $9e
	const SPRITE_PAPER_UNOWN_W ; $9f
	const SPRITE_POKEDEX_UNOWN_A ; $a0
	const SPRITE_BOOK_UNOWN_R ; $a1
	const SPRITE_SIGN_UNOWN_P ; $a2
