...
; sprites
	...
	const SPRITE_BIG_SNORLAX ; 6e
	const SPRITE_BIG_LAPRAS ; 6f
	const SPRITE_BIG_ONIX ; 70
	const SPRITE_WEIRD_TREE ; 71
	const SPRITE_UNOWN_W ; 72
	const SPRITE_UNOWN_A ; 73
	const SPRITE_UNOWN_R ; 74
	const SPRITE_UNOWN_P ; 75
	const SPRITE_GYARADOS_TOP_LEFT ; 76
	const SPRITE_GYARADOS_TOP_RIGHT ; 77
	const SPRITE_GYARADOS_BOTTOM_LEFT ; 78
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; 79
	const SPRITE_POKE_BALL ; 7a
	const SPRITE_POKEDEX ; 7b
	const SPRITE_BOOK ; 7c
	const SPRITE_PAPER ; 7d
	const SPRITE_ROCK ; 7e
	const SPRITE_BOULDER ; 7f
	const SPRITE_FRUIT_TREE ; 80
	const SPRITE_ELECTRIC_FENCE_LEFT ; 81
	const SPRITE_ELECTRIC_FENCE_RIGHT ; 82
	const SPRITE_FOSSIL ; 83
	const SPRITE_SNES ; 84
	const SPRITE_N64 ; 85
	const SPRITE_GAMECUBE ; 86
	const SPRITE_WII ; 87
	const SPRITE_SILVER_TROPHY ; 88
	const SPRITE_GOLD_TROPHY ; 89
	const SPRITE_BIRD ; 8a
	const SPRITE_DRAGON ; 8b
	const SPRITE_FAIRY ; 8c
...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_MEW ; bd
	const SPRITE_BAYLEEF ; be
	const SPRITE_FURRET ; bf
	const SPRITE_HOOTHOOT ; c0
	const SPRITE_AMPHAROS ; c1
	const SPRITE_MURKROW ; c2
	const SPRITE_UNOWN ; c3
	const SPRITE_HERACROSS ; c4
	const SPRITE_URSARING ; c5
	const SPRITE_SKARMORY ; c6
	const SPRITE_MILTANK ; c7
	const SPRITE_BLISSEY ; c8
	const SPRITE_RAIKOU ; c9
	const SPRITE_ENTEI ; ca
	const SPRITE_SUICUNE ; cb
	const SPRITE_LUGIA ; cc
	const SPRITE_HO_OH ; cd
	const SPRITE_EGG ; ce
