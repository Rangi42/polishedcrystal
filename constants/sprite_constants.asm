; sprites
	...
	const SPRITE_GYARADOS_TOP_LEFT ; $9b
	const SPRITE_GYARADOS_TOP_RIGHT ; $9c
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $9d
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $9e
	const SPRITE_BALL_CUT_FRUIT ; $9f
	const SPRITE_BOULDER_ROCK_FOSSIL ; $a0
	const SPRITE_PAPER ; $a1
	const SPRITE_POKEDEX ; $a2
	const SPRITE_BOOK ; $a3
