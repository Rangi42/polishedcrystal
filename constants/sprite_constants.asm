...
; sprites
	...
	const SPRITE_BAKER ; $43
	const SPRITE_BEAUTY ; $44
	const SPRITE_BIKER ; $45
	const SPRITE_BLACK_BELT ; $46
	const SPRITE_BOARDER ; $47
	const SPRITE_BREEDER ; $48
	const SPRITE_BUG_CATCHER ; $49
	const SPRITE_BUG_MANIAC ; $4a
	const SPRITE_CHILD ; $4b
	const SPRITE_COOLTRAINER_F ; $4c
	const SPRITE_COOLTRAINER_M ; $4d
	const SPRITE_COSPLAYER ; $4e
	const SPRITE_COWGIRL ; $4f
	const SPRITE_DRAGON_TAMER ; $50
	const SPRITE_ELDER ; $51
	const SPRITE_FISHER ; $52
	const SPRITE_GENTLEMAN ; $53
	const SPRITE_GRAMPS ; $54
	const SPRITE_GRANNY ; $55
	const SPRITE_HEX_MANIAC ; $56
	const SPRITE_KIMONO_GIRL ; $57
	const SPRITE_LADY ; $58
	const SPRITE_LASS ; $59
	const SPRITE_OFFICER ; $5a
	const SPRITE_OFFICER_F ; $5b
	const SPRITE_PHARMACIST ; $5c
	const SPRITE_PI ; $5d
	const SPRITE_POKEFAN_F ; $5e
	const SPRITE_POKEFAN_M ; $5f
	const SPRITE_RICH_BOY ; $60
	const SPRITE_ROCKER ; $61
	const SPRITE_ROCKET ; $62
	const SPRITE_ROCKET_GIRL ; $63
	const SPRITE_ROUGHNECK ; $64
	const SPRITE_SAGE ; $65
	const SPRITE_SAILOR ; $66
	const SPRITE_SCIENTIST ; $67
	const SPRITE_SIGHTSEER_M ; $68
	const SPRITE_SKIER ; $69
	const SPRITE_SUPER_NERD ; $6a
	const SPRITE_SWIMMER_GIRL ; $6b
	const SPRITE_SWIMMER_GUY ; $6c
	const SPRITE_TEACHER ; $6d
	const SPRITE_TWIN ; $6e
	const SPRITE_VETERAN_M ; $6f
	const SPRITE_VETERAN_F ; $70
	const SPRITE_YOUNGSTER ; $71
	const SPRITE_NURSE ; $72
	const SPRITE_CLERK ; $73
	const SPRITE_RECEPTIONIST ; $74
	const SPRITE_LINK_RECEPTIONIST ; $75
	const SPRITE_GYM_GUY ; $76
	const SPRITE_FISHING_GURU ; $77
	const SPRITE_GAMEBOY_KID ; $78
	const SPRITE_STANDING_YOUNGSTER ; $79
	const SPRITE_SILPH_EMPLOYEE ; $7a
	const SPRITE_SWIMMING_OFFICER ; $7b
	const SPRITE_SWIMMING_OFFICER_F ; $7c
	const SPRITE_KURT_OUTSIDE ; $7d
	const SPRITE_CLEFAIRY_WALK ; $7e
	const SPRITE_FARFETCH_D ; $7f
	const SPRITE_LAPRAS ; $80
	const SPRITE_EEVEE ; $81
	const SPRITE_DRAGONITE ; $82
	const SPRITE_MEW ; $83
	const SPRITE_CELEBI ; $84
	const SPRITE_SURFING_PIKACHU ; $85
	const SPRITE_ARMORED_MEWTWO ; $86
	const SPRITE_BIG_SNORLAX ; $87
	const SPRITE_BIG_LAPRAS ; $88
	const SPRITE_BIG_ONIX ; $89
	const SPRITE_WEIRD_TREE ; $8a
	const SPRITE_UNOWN_W ; $8b
	const SPRITE_UNOWN_A ; $8c
	const SPRITE_UNOWN_R ; $8d
	const SPRITE_UNOWN_P ; $8e
	const SPRITE_GYARADOS_TOP_LEFT ; $8f
	const SPRITE_GYARADOS_TOP_RIGHT ; $90
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $91
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $92
	const SPRITE_POKE_BALL ; $93
	const SPRITE_POKEDEX ; $94
	const SPRITE_BOOK ; $95
	const SPRITE_PAPER ; $96
	const SPRITE_ROCK ; $97
	const SPRITE_BOULDER ; $98
	const SPRITE_CUT_TREE ; $99
	const SPRITE_FRUIT_TREE ; $9a
	const SPRITE_ELECTRIC_FENCE_LEFT ; $9b
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $9c
	const SPRITE_FOSSIL ; $9d
	const SPRITE_SIGN ; $9e
	const SPRITE_SNES ; $9f
	const SPRITE_N64 ; $a0
	const SPRITE_GAMECUBE ; $a1
	const SPRITE_WII ; $a2
	const SPRITE_SILVER_TROPHY ; $a3
	const SPRITE_GOLD_TROPHY ; $a4
