...
; sprites
	...
	const SPRITE_CAITLIN ; $39
	const SPRITE_DARACH ; $3a
	const SPRITE_STEVEN ; $3b
	const SPRITE_CYNTHIA ; $3c
	const SPRITE_ELDER ; $3d
	const SPRITE_CAPTAIN ; $3e
	const SPRITE_BIKER ; $3f
	const SPRITE_BLACK_BELT ; $40
	const SPRITE_BREEDER ; $41
	const SPRITE_BUENA ; $42
	const SPRITE_BUG_CATCHER ; $43
	const SPRITE_COOLTRAINER_F ; $44
	const SPRITE_COOLTRAINER_M ; $45
	const SPRITE_COWGIRL ; $46
	const SPRITE_DRAGON_TAMER ; $47
	const SPRITE_FISHER ; $48
	const SPRITE_GENTLEMAN ; $49
	const SPRITE_GRAMPS ; $4a
	const SPRITE_GRANNY ; $4b
	const SPRITE_HEX_MANIAC ; $4c
	const SPRITE_KIMONO_GIRL ; $4d
	const SPRITE_LASS ; $4e
	const SPRITE_OFFICER ; $4f
	const SPRITE_OFFICER_F ; $50
	const SPRITE_PHARMACIST ; $51
	const SPRITE_PI ; $52
	const SPRITE_POKEFAN_F ; $53
	const SPRITE_POKEFAN_M ; $54
	const SPRITE_RICH_BOY ; $55
	const SPRITE_ROCKER ; $56
	const SPRITE_ROCKET ; $57
	const SPRITE_ROCKET_GIRL ; $58
	const SPRITE_SAGE ; $59
	const SPRITE_SAILOR ; $5a
	const SPRITE_SCIENTIST ; $5b
	const SPRITE_SUPER_NERD ; $5c
	const SPRITE_SWIMMER_GIRL ; $5d
	const SPRITE_SWIMMER_GUY ; $5e
	const SPRITE_TEACHER ; $5f
	const SPRITE_TWIN ; $60
	const SPRITE_VETERAN_M ; $61
	const SPRITE_VETERAN_F ; $62
	const SPRITE_YOUNGSTER ; $63
	const SPRITE_NURSE ; $64
	const SPRITE_CLERK ; $65
	const SPRITE_RECEPTIONIST ; $66
	const SPRITE_LINK_RECEPTIONIST ; $67
	const SPRITE_GYM_GUY ; $68
	const SPRITE_FISHING_GURU ; $69
	const SPRITE_GAMEBOY_KID ; $6a
	const SPRITE_STANDING_YOUNGSTER ; $6b
	const SPRITE_CAL ; $6c
	const SPRITE_KURT_OUTSIDE ; $6d
	const SPRITE_SURF ; $6e
	const SPRITE_SURFING_PIKACHU ; $6f
	const SPRITE_BIRD ; $70
	const SPRITE_FAIRY ; $71
	const SPRITE_DRAGONITE ; $72
	const SPRITE_ARMORED_MEWTWO ; $73
	const SPRITE_MEW ; $74
	const SPRITE_CELEBI ; $75
	const SPRITE_BIG_SNORLAX ; $76
	const SPRITE_BIG_LAPRAS ; $77
	const SPRITE_BIG_ONIX ; $78
	const SPRITE_WEIRD_TREE ; $79
	const SPRITE_UNOWN_W ; $7a
	const SPRITE_UNOWN_A ; $7b
	const SPRITE_UNOWN_R ; $7c
	const SPRITE_UNOWN_P ; $7d
	const SPRITE_GYARADOS_TOP_LEFT ; $7e
	const SPRITE_GYARADOS_TOP_RIGHT ; $7f
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $80
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $81
	const SPRITE_POKE_BALL ; $82
	const SPRITE_POKEDEX ; $83
	const SPRITE_BOOK ; $84
	const SPRITE_PAPER ; $85
	const SPRITE_ROCK ; $86
	const SPRITE_BOULDER ; $87
	const SPRITE_FRUIT_TREE ; $88
	const SPRITE_ELECTRIC_FENCE_LEFT ; $89
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $8a
	const SPRITE_FOSSIL ; $8b
	const SPRITE_SNES ; $8c
	const SPRITE_N64 ; $8d
	const SPRITE_GAMECUBE ; $8e
	const SPRITE_WII ; $8f
	const SPRITE_SILVER_TROPHY ; $90
	const SPRITE_GOLD_TROPHY ; $91

SPRITE_POKEMON EQU const_value
	const SPRITE_BULBASAUR ; $92
	const SPRITE_CHARMANDER ; $93
	const SPRITE_SQUIRTLE ; $94
	const SPRITE_WEEDLE ; $95
	const SPRITE_PIDGEY ; $96
	const SPRITE_PIDGEOT ; $97
	const SPRITE_RATTATA ; $98
	const SPRITE_PIKACHU ; $99
	const SPRITE_NIDORAN_F ; $9a
	const SPRITE_NIDORAN_M ; $9b
	const SPRITE_NIDORINO ; $9c
	const SPRITE_CLEFAIRY ; $9d
	const SPRITE_JIGGLYPUFF ; $9e
	const SPRITE_ZUBAT ; $9f
	const SPRITE_ODDISH ; $a0
	const SPRITE_DIGLETT ; $a1
	const SPRITE_MEOWTH ; $a2
	const SPRITE_PERSIAN ; $a3
	const SPRITE_PSYDUCK ; $a4
	const SPRITE_POLIWAG ; $a5
	const SPRITE_POLIWRATH ; $a6
	const SPRITE_ABRA ; $a7
	const SPRITE_MACHOP ; $a8
	const SPRITE_MACHOKE ; $a9
	const SPRITE_TENTACOOL ; $aa
	const SPRITE_GEODUDE ; $ab
	const SPRITE_SLOWPOKE ; $ac
	const SPRITE_SLOWBRO ; $ad
	const SPRITE_FARFETCH_D ; $ae
	const SPRITE_DODRIO ; $af
	const SPRITE_GRIMER ; $b0
	const SPRITE_SHELLDER ; $b1
	const SPRITE_GENGAR ; $b2
	const SPRITE_VOLTORB ; $b3
	const SPRITE_ELECTRODE ; $b4
	const SPRITE_RHYDON ; $b5
	const SPRITE_CHANSEY ; $b6
	const SPRITE_KANGASKHAN ; $b7
	const SPRITE_STARYU ; $b8
	const SPRITE_MAGIKARP ; $b9
	const SPRITE_ARTICUNO ; $ba
	const SPRITE_ZAPDOS ; $bb
	const SPRITE_MOLTRES ; $bc
	const SPRITE_DRATINI ; $bd
	const SPRITE_MEWTWO ; $be
	const SPRITE_BAYLEEF ; $bf
	const SPRITE_FURRET ; $c0
	const SPRITE_HOOTHOOT ; $c1
	const SPRITE_AMPHAROS ; $c2
	const SPRITE_MURKROW ; $c3
	const SPRITE_UNOWN ; $c4
	const SPRITE_HERACROSS ; $c5
	const SPRITE_URSARING ; $c6
	const SPRITE_SKARMORY ; $c7
	const SPRITE_MILTANK ; $c8
	const SPRITE_BLISSEY ; $c9
	const SPRITE_RAIKOU ; $ca
	const SPRITE_ENTEI ; $cb
	const SPRITE_SUICUNE ; $cc
	const SPRITE_LUGIA ; $cd
	const SPRITE_HO_OH ; $ce
	const SPRITE_EGG ; $cf
