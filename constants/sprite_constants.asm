...
; sprites
	...
	const SPRITE_KUKUI ; $44
	const SPRITE_CAITLIN ; $45
	const SPRITE_DARACH ; $46
	const SPRITE_STEVEN ; $47
	const SPRITE_CYNTHIA ; $48
	const SPRITE_CANDELA ; $49
	const SPRITE_BLANCHE ; $4a
	const SPRITE_SPARK ; $4b
	const SPRITE_BUENA ; $4c
	const SPRITE_CAPTAIN ; $4d
	const SPRITE_DEAN ; $4e
	const SPRITE_ARTIST ; $4f
	const SPRITE_BAKER ; $50
	const SPRITE_BEAUTY ; $51
	const SPRITE_BIKER ; $52
	const SPRITE_BLACK_BELT ; $53
	const SPRITE_BOARDER ; $54
	const SPRITE_BREEDER ; $55
	const SPRITE_BUG_CATCHER ; $56
	const SPRITE_BUG_MANIAC ; $57
	const SPRITE_CHILD ; $58
	const SPRITE_COOLTRAINER_F ; $59
	const SPRITE_COOLTRAINER_M ; $5a
	const SPRITE_COSPLAYER ; $5b
	const SPRITE_COWGIRL ; $5c
	const SPRITE_DRAGON_TAMER ; $5d
	const SPRITE_ELDER ; $5e
	const SPRITE_ENGINEER ; $5f
	const SPRITE_FISHER ; $60
	const SPRITE_GENTLEMAN ; $61
	const SPRITE_GRAMPS ; $62
	const SPRITE_GRANNY ; $63
	const SPRITE_HEX_MANIAC ; $64
	const SPRITE_KIMONO_GIRL ; $65
	const SPRITE_LADY ; $66
	const SPRITE_LASS ; $67
	const SPRITE_OFFICER ; $68
	const SPRITE_OFFICER_F ; $69
	const SPRITE_PHARMACIST ; $6a
	const SPRITE_PI ; $6b
	const SPRITE_POKEFAN_F ; $6c
	const SPRITE_POKEFAN_M ; $6d
	const SPRITE_RICH_BOY ; $6e
	const SPRITE_ROCKER ; $6f
	const SPRITE_ROCKET ; $70
	const SPRITE_ROCKET_GIRL ; $71
	const SPRITE_ROUGHNECK ; $72
	const SPRITE_SAGE ; $73
	const SPRITE_SAILOR ; $74
	const SPRITE_SCIENTIST ; $75
	const SPRITE_SIGHTSEER_M ; $76
	const SPRITE_SKIER ; $77
	const SPRITE_SUPER_NERD ; $78
	const SPRITE_SWIMMER_GIRL ; $79
	const SPRITE_SWIMMER_GUY ; $7a
	const SPRITE_TEACHER ; $7b
	const SPRITE_TWIN ; $7c
	const SPRITE_VETERAN_M ; $7d
	const SPRITE_VETERAN_F ; $7e
	const SPRITE_YOUNGSTER ; $7f
	const SPRITE_NURSE ; $80
	const SPRITE_CLERK ; $81
	const SPRITE_RECEPTIONIST ; $82
	const SPRITE_LINK_RECEPTIONIST ; $83
	const SPRITE_GYM_GUY ; $84
	const SPRITE_FISHING_GURU ; $85
	const SPRITE_GAMEBOY_KID ; $86
	const SPRITE_SILPH_EMPLOYEE ; $87
	const SPRITE_SWIMMING_OFFICER ; $88
	const SPRITE_SWIMMING_OFFICER_F ; $89
	const SPRITE_CLEFAIRY_WALK ; $8a
	const SPRITE_FARFETCH_D ; $8b
	const SPRITE_LAPRAS ; $8c
	const SPRITE_EEVEE ; $8d
	const SPRITE_DRAGONITE ; $8e
	const SPRITE_MEW ; $8f
	const SPRITE_CELEBI ; $90
	const SPRITE_SURFING_PIKACHU ; $91
	const SPRITE_ARMORED_MEWTWO ; $92
	const SPRITE_BIG_SNORLAX ; $93
	const SPRITE_BIG_LAPRAS ; $94
	const SPRITE_BIG_ONIX ; $95
	const SPRITE_WEIRD_TREE ; $96
	const SPRITE_GYARADOS_TOP_LEFT ; $97
	const SPRITE_GYARADOS_TOP_RIGHT ; $98
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $99
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $9a
	const SPRITE_BALL_CUT_FRUIT ; $9b
	const SPRITE_ROCK_BOULDER_FOSSIL ; $9c
	const SPRITE_PAPER_UNOWN_W ; $9d
	const SPRITE_POKEDEX_UNOWN_A ; $9e
	const SPRITE_BOOK_UNOWN_R ; $9f
	const SPRITE_SIGN_UNOWN_P ; $a0
	const SPRITE_ELECTRIC_FENCE_LEFT ; $a1
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $a2
	const SPRITE_SNES ; $a3
	const SPRITE_N64 ; $a4
	const SPRITE_GAMECUBE ; $a5
	const SPRITE_WII ; $a6
	const SPRITE_SILVER_TROPHY ; $a7
	const SPRITE_GOLD_TROPHY ; $a8

SPRITE_POKEMON EQU const_value
	const SPRITE_BULBASAUR ; $a9
	const SPRITE_CHARMANDER ; $aa
	const SPRITE_SQUIRTLE ; $ab
	const SPRITE_WEEDLE ; $ac
	const SPRITE_PIDGEY ; $ad
	const SPRITE_PIDGEOTTO ; $ae
