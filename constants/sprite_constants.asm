...
; sprites
	...
	const SPRITE_MEW ; 6e
	const SPRITE_BIG_SNORLAX ; 6f
	const SPRITE_BIG_LAPRAS ; 70
	const SPRITE_BIG_ONIX ; 71
	const SPRITE_WEIRD_TREE ; 72
	const SPRITE_UNOWN_W ; 73
	const SPRITE_UNOWN_A ; 74
	const SPRITE_UNOWN_R ; 75
	const SPRITE_UNOWN_P ; 76
	const SPRITE_GYARADOS_TOP_LEFT ; 77
	const SPRITE_GYARADOS_TOP_RIGHT ; 78
	const SPRITE_GYARADOS_BOTTOM_LEFT ; 79
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; 7a
	const SPRITE_POKE_BALL ; 7b
	const SPRITE_POKEDEX ; 7c
	const SPRITE_BOOK ; 7d
	const SPRITE_PAPER ; 7e
	const SPRITE_ROCK ; 7f
	const SPRITE_BOULDER ; 80
	const SPRITE_FRUIT_TREE ; 81
	const SPRITE_ELECTRIC_FENCE_LEFT ; 82
	const SPRITE_ELECTRIC_FENCE_RIGHT ; 83
	const SPRITE_FOSSIL ; 84
	const SPRITE_SNES ; 85
	const SPRITE_N64 ; 86
	const SPRITE_GAMECUBE ; 87
	const SPRITE_WII ; 88
	const SPRITE_SILVER_TROPHY ; 89
	const SPRITE_GOLD_TROPHY ; 8a
	const SPRITE_BIRD ; 8b
	const SPRITE_DRAGON ; 8c
	const SPRITE_FAIRY ; 8d
