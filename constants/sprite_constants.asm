...
; sprites
	...
	const SPRITE_ELDER ; $40
	const SPRITE_CAPTAIN ; $41
	const SPRITE_BIKER ; $42
	const SPRITE_BLACK_BELT ; $43
	const SPRITE_BREEDER ; $44
	const SPRITE_BUENA ; $45
	const SPRITE_BUG_CATCHER ; $46
	const SPRITE_COOLTRAINER_F ; $47
	const SPRITE_COOLTRAINER_M ; $48
	const SPRITE_COSPLAYER ; $49
	const SPRITE_COWGIRL ; $4a
	const SPRITE_DRAGON_TAMER ; $4b
	const SPRITE_FISHER ; $4c
	const SPRITE_GENTLEMAN ; $4d
	const SPRITE_GRAMPS ; $4e
	const SPRITE_GRANNY ; $4f
	const SPRITE_HEX_MANIAC ; $50
	const SPRITE_KIMONO_GIRL ; $51
	const SPRITE_LADY ; $52
	const SPRITE_LASS ; $53
	const SPRITE_OFFICER ; $54
	const SPRITE_OFFICER_F ; $55
	const SPRITE_PHARMACIST ; $56
	const SPRITE_PI ; $57
	const SPRITE_POKEFAN_F ; $58
	const SPRITE_POKEFAN_M ; $59
	const SPRITE_RICH_BOY ; $5a
	const SPRITE_ROCKER ; $5b
	const SPRITE_ROCKET ; $5c
	const SPRITE_ROCKET_GIRL ; $5d
	const SPRITE_SAGE ; $5e
	const SPRITE_SAILOR ; $5f
	const SPRITE_SCIENTIST ; $60
	const SPRITE_SUPER_NERD ; $61
	const SPRITE_SWIMMER_GIRL ; $62
	const SPRITE_SWIMMER_GUY ; $63
	const SPRITE_TEACHER ; $64
	const SPRITE_TWIN ; $65
	const SPRITE_VETERAN_M ; $66
	const SPRITE_VETERAN_F ; $67
	const SPRITE_YOUNGSTER ; $68
	const SPRITE_NURSE ; $69
	const SPRITE_CLERK ; $6a
	const SPRITE_RECEPTIONIST ; $6b
	const SPRITE_LINK_RECEPTIONIST ; $6c
	const SPRITE_GYM_GUY ; $6d
	const SPRITE_FISHING_GURU ; $6e
	const SPRITE_GAMEBOY_KID ; $6f
	const SPRITE_STANDING_YOUNGSTER ; $70
	const SPRITE_SWIMMING_OFFICER ; $71
	const SPRITE_SWIMMING_OFFICER_F ; $72
	const SPRITE_CAL ; $73
	const SPRITE_KURT_OUTSIDE ; $74
	const SPRITE_BIRD ; $75
	const SPRITE_FAIRY ; $76
	const SPRITE_LAPRAS ; $77
	const SPRITE_EEVEE ; $78
	const SPRITE_DRAGONITE ; $79
	const SPRITE_MEW ; $7a
	const SPRITE_CELEBI ; $7b
	const SPRITE_SURFING_PIKACHU ; $7c
	const SPRITE_ARMORED_MEWTWO ; $7d
	const SPRITE_BIG_SNORLAX ; $7e
	const SPRITE_BIG_LAPRAS ; $7f
	const SPRITE_BIG_ONIX ; $80
	const SPRITE_WEIRD_TREE ; $81
	const SPRITE_UNOWN_W ; $82
	const SPRITE_UNOWN_A ; $83
	const SPRITE_UNOWN_R ; $84
	const SPRITE_UNOWN_P ; $85
	const SPRITE_GYARADOS_TOP_LEFT ; $86
	const SPRITE_GYARADOS_TOP_RIGHT ; $87
	const SPRITE_GYARADOS_BOTTOM_LEFT ; $88
	const SPRITE_GYARADOS_BOTTOM_RIGHT ; $89
	const SPRITE_POKE_BALL ; $8a
	const SPRITE_POKEDEX ; $8b
	const SPRITE_BOOK ; $8c
	const SPRITE_PAPER ; $8d
	const SPRITE_ROCK ; $8e
	const SPRITE_BOULDER ; $8f
	const SPRITE_CUT_TREE ; $90
	const SPRITE_FRUIT_TREE ; $91
	const SPRITE_ELECTRIC_FENCE_LEFT ; $92
	const SPRITE_ELECTRIC_FENCE_RIGHT ; $93
	const SPRITE_FOSSIL ; $94
	const SPRITE_SNES ; $95
	const SPRITE_N64 ; $96
	const SPRITE_GAMECUBE ; $97
	const SPRITE_WII ; $98
	const SPRITE_SILVER_TROPHY ; $99
	const SPRITE_GOLD_TROPHY ; $9a

const_value SET $9d
SPRITE_POKEMON EQU const_value
	const SPRITE_BULBASAUR ; $9d
	const SPRITE_CHARMANDER ; $9e
	const SPRITE_SQUIRTLE ; $9f
	const SPRITE_WEEDLE ; $a0
	const SPRITE_PIDGEY ; $a1
	const SPRITE_PIDGEOT ; $a2
	const SPRITE_RATTATA ; $a3
	const SPRITE_PIKACHU ; $a4
	const SPRITE_NIDORAN_F ; $a5
	const SPRITE_NIDORAN_M ; $a6
	const SPRITE_NIDORINO ; $a7
	const SPRITE_CLEFAIRY ; $a8
	const SPRITE_JIGGLYPUFF ; $a9
	const SPRITE_ZUBAT ; $aa
	const SPRITE_ODDISH ; $ab
	const SPRITE_DIGLETT ; $ac
	const SPRITE_MEOWTH ; $ad
	const SPRITE_PERSIAN ; $ae
	const SPRITE_PSYDUCK ; $af
	const SPRITE_POLIWAG ; $b0
	const SPRITE_POLIWRATH ; $b1
	const SPRITE_ABRA ; $b2
	const SPRITE_MACHOP ; $b3
	const SPRITE_MACHOKE ; $b4
	const SPRITE_TENTACOOL ; $b5
	const SPRITE_GEODUDE ; $b6
	const SPRITE_SLOWPOKE ; $b7
	const SPRITE_SLOWBRO ; $b8
	const SPRITE_FARFETCH_D ; $b9
	const SPRITE_DODRIO ; $ba
	const SPRITE_GRIMER ; $bb
	const SPRITE_SHELLDER ; $bc
	const SPRITE_GENGAR ; $bd
	const SPRITE_VOLTORB ; $be
	const SPRITE_ELECTRODE ; $bf
	const SPRITE_RHYDON ; $c0
	const SPRITE_CHANSEY ; $c1
	const SPRITE_KANGASKHAN ; $c2
	const SPRITE_STARYU ; $c3
	const SPRITE_MAGIKARP ; $c4
	const SPRITE_ARTICUNO ; $c5
	const SPRITE_ZAPDOS ; $c6
	const SPRITE_MOLTRES ; $c7
	const SPRITE_DRATINI ; $c8
	const SPRITE_MEWTWO ; $c9
	const SPRITE_BAYLEEF ; $ca
	const SPRITE_FURRET ; $cb
	const SPRITE_HOOTHOOT ; $cc
	const SPRITE_AMPHAROS ; $cd
	const SPRITE_MARILL ; $ce
	const SPRITE_MURKROW ; $cf
	const SPRITE_UNOWN ; $d0
	const SPRITE_HERACROSS ; $d1
	const SPRITE_URSARING ; $d2
	const SPRITE_SKARMORY ; $d3
	const SPRITE_MILTANK ; $d4
	const SPRITE_BLISSEY ; $d5
	const SPRITE_RAIKOU ; $d6
	const SPRITE_ENTEI ; $d7
	const SPRITE_SUICUNE ; $d8
	const SPRITE_LUGIA ; $d9
	const SPRITE_HO_OH ; $da
	const SPRITE_EGG ; $db
