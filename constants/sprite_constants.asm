...
; sprites
	...
	const SPRITE_BILL ; $28
	const SPRITE_KURT ; $29
	const SPRITE_REDS_MOM ; $2a
	const SPRITE_DAISY ; $2b
	const SPRITE_LORELEI ; $2c
	const SPRITE_AGATHA ; $2d
	const SPRITE_PALMER ; $2e
	const SPRITE_WALKER ; $2f
	const SPRITE_IMAKUNI ; $30
	const SPRITE_LAWRENCE ; $31
	const SPRITE_JAMES ; $32
	const SPRITE_JESSIE ; $33
	const SPRITE_PROTON ; $34
	const SPRITE_PETREL ; $35
	const SPRITE_ARCHER ; $36
	const SPRITE_ARIANA ; $37
	const SPRITE_GIOVANNI ; $38
	const SPRITE_CHERYL ; $39
	const SPRITE_RILEY ; $3a
	const SPRITE_BUCK ; $3b
	const SPRITE_MARLEY ; $3c
	const SPRITE_MIRA ; $3d
	const SPRITE_ANABEL ; $3e
	const SPRITE_FLANNERY ; $3f
	const SPRITE_MAYLENE ; $40
	const SPRITE_SKYLA ; $41
	const SPRITE_VALERIE ; $42
	const SPRITE_CAITLIN ; $43
	const SPRITE_DARACH ; $44
	const SPRITE_STEVEN ; $45
	const SPRITE_CYNTHIA ; $46
	const SPRITE_CANDELA ; $47
	const SPRITE_BLANCHE ; $48
	const SPRITE_SPARK ; $49
	const SPRITE_BUENA ; $4a
	const SPRITE_CAPTAIN ; $4b
	const SPRITE_DEAN ; $4c
	const SPRITE_ARTIST ; $4d
	const SPRITE_BAKER ; $4e
	const SPRITE_BEAUTY ; $4f
	const SPRITE_BIKER ; $50
	const SPRITE_BLACK_BELT ; $51
	const SPRITE_BOARDER ; $52
	const SPRITE_BREEDER ; $53
	const SPRITE_BUG_CATCHER ; $54
	const SPRITE_BUG_MANIAC ; $55
	const SPRITE_CHILD ; $56
	const SPRITE_COOLTRAINER_F ; $57
	const SPRITE_COOLTRAINER_M ; $58
	const SPRITE_COSPLAYER ; $59
	const SPRITE_COWGIRL ; $5a
	const SPRITE_DRAGON_TAMER ; $5b
	const SPRITE_ELDER ; $5c
	const SPRITE_ENGINEER ; $5d
	const SPRITE_FISHER ; $5e
	const SPRITE_GENTLEMAN ; $5f
	const SPRITE_GRAMPS ; $60
	const SPRITE_GRANNY ; $61
	const SPRITE_HEX_MANIAC ; $62
	const SPRITE_KIMONO_GIRL ; $63
	const SPRITE_LADY ; $64
	const SPRITE_LASS ; $65
	const SPRITE_OFFICER ; $66
	const SPRITE_OFFICER_F ; $67
	const SPRITE_PHARMACIST ; $68
	const SPRITE_PI ; $69
	const SPRITE_POKEFAN_F ; $6a
	const SPRITE_POKEFAN_M ; $6b
	const SPRITE_RICH_BOY ; $6c
	const SPRITE_ROCKER ; $6d
	const SPRITE_ROCKET ; $6e
	const SPRITE_ROCKET_GIRL ; $6f
	const SPRITE_ROUGHNECK ; $70
	const SPRITE_SAGE ; $71
	const SPRITE_SAILOR ; $72
	const SPRITE_SCIENTIST ; $73
	const SPRITE_SIGHTSEER_M ; $74
	const SPRITE_SKIER ; $75
	const SPRITE_SUPER_NERD ; $76
	const SPRITE_SWIMMER_GIRL ; $77
	const SPRITE_SWIMMER_GUY ; $78
	const SPRITE_TEACHER ; $79
	const SPRITE_TWIN ; $7a
	const SPRITE_VETERAN_M ; $7b
	const SPRITE_VETERAN_F ; $7c
	const SPRITE_YOUNGSTER ; $7d
	const SPRITE_NURSE ; $7e
	const SPRITE_CLERK ; $7f
	const SPRITE_RECEPTIONIST ; $80
	const SPRITE_LINK_RECEPTIONIST ; $81
	const SPRITE_GYM_GUY ; $82
	const SPRITE_FISHING_GURU ; $83
	const SPRITE_GAMEBOY_KID ; $84
	const SPRITE_SILPH_EMPLOYEE ; $85
	const SPRITE_SWIMMING_OFFICER ; $86
	const SPRITE_SWIMMING_OFFICER_F ; $87
	const SPRITE_CLEFAIRY_WALK ; $88
	const SPRITE_FARFETCH_D ; $89
	const SPRITE_LAPRAS ; $8a
	const SPRITE_EEVEE ; $8b
	const SPRITE_DRAGONITE ; $8c
	const SPRITE_MEW ; $8d
	const SPRITE_CELEBI ; $8e
	const SPRITE_SURFING_PIKACHU ; $8f
	const SPRITE_ARMORED_MEWTWO ; $90
	const SPRITE_BIG_SNORLAX ; $91
	const SPRITE_BIG_LAPRAS ; $92
	const SPRITE_BIG_ONIX ; $93
	const SPRITE_WEIRD_TREE ; $94
	...
	const SPRITE_BALL_CUT_FRUIT ; $99
	const SPRITE_ROCK_BOULDER_FOSSIL ; $9a
	const SPRITE_PAPER_UNOWN_W ; $9b
	const SPRITE_POKEDEX_UNOWN_A ; $9c
	const SPRITE_BOOK_UNOWN_R ; $9d
	const SPRITE_SIGN_UNOWN_P ; $9e
