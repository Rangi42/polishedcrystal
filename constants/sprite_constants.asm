...
SPRITE_VARS EQU const_value
	const SPRITE_CONSOLE ; $eb
	const SPRITE_DOLL_1 ; $ec
	const SPRITE_DOLL_2 ; $ed
	const SPRITE_BIG_DOLL ; $ee
	const SPRITE_FUCHSIA_GYM_1 ; $ef
	const SPRITE_FUCHSIA_GYM_2 ; $f0
	const SPRITE_FUCHSIA_GYM_3 ; $f1
	const SPRITE_FUCHSIA_GYM_4 ; $f2
	const SPRITE_COPYCAT ; $f3
	const SPRITE_JANINE_IMPERSONATOR ; $f4
	const SPRITE_REMATCH_GYM_LEADER_1 ; $f5
	const SPRITE_REMATCH_GYM_LEADER_2 ; $f6
	const SPRITE_REMATCH_GYM_LEADER_3 ; $f7
	const SPRITE_GUIDE_GENT ; $f8
	const SPRITE_NEW_BARK_LYRA ; $f9
	const SPRITE_GOLDENROD_LYRA ; $fa
	const SPRITE_AZALEA_ROCKET ; $fb
	const SPRITE_CHERRYGROVE_RIVAL ; $fc
	const SPRITE_OLIVINE_RIVAL ; $fd
	const SPRITE_CERULEAN_CAPE_MISTY ; $fe
