...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_FARFETCH_D ; 9a
	const SPRITE_DODRIO ; 9b
	const SPRITE_GRIMER ; 9c
	const SPRITE_SHELLDER ; 9d
	const SPRITE_GENGAR ; 9e
	const SPRITE_VOLTORB ; 9f
	const SPRITE_ELECTRODE ; a0
	const SPRITE_RHYDON ; a1
	const SPRITE_KANGASKHAN ; a2
	const SPRITE_STARYU ; a3
	const SPRITE_MAGIKARP ; a4
	const SPRITE_GYARADOS ; a5
	const SPRITE_ARTICUNO ; a6
	const SPRITE_ZAPDOS ; a7
	const SPRITE_MOLTRES ; a8
	const SPRITE_DRATINI ; a9
	const SPRITE_MEWTWO ; aa
	const SPRITE_MEW ; ab
	const SPRITE_BAYLEEF ; ac
	const SPRITE_FURRET ; ad
	const SPRITE_HOOTHOOT ; ae
	const SPRITE_AMPHAROS ; af
	const SPRITE_MURKROW ; b0
	const SPRITE_UNOWN ; b1
	const SPRITE_URSARING ; b2
	const SPRITE_MILTANK ; b3
	const SPRITE_BLISSEY ; b4
	const SPRITE_RAIKOU ; b5
	const SPRITE_ENTEI ; b6
