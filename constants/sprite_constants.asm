...
; sprites
	...
	const SPRITE_GIOVANNI ; 2e
	const SPRITE_VALERIE ; 2f
	const SPRITE_STEVEN ; 30
	const SPRITE_CYNTHIA ; 31
	const SPRITE_ELDER ; 32
	const SPRITE_CAPTAIN ; 33
	const SPRITE_BIKER ; 34
	const SPRITE_BLACK_BELT ; 35
	const SPRITE_BREEDER ; 36
	const SPRITE_BUENA ; 37
	const SPRITE_BUG_CATCHER ; 38
	const SPRITE_COOLTRAINER_F ; 39
	const SPRITE_COOLTRAINER_M ; 3a
	const SPRITE_COWGIRL ; 3b
	const SPRITE_DRAGON_TAMER ; 3c
	const SPRITE_FISHER ; 3d
	const SPRITE_GENTLEMAN ; 3e
	const SPRITE_GRAMPS ; 3f
	const SPRITE_GRANNY ; 40
	const SPRITE_HEX_MANIAC ; 41
	const SPRITE_KIMONO_GIRL ; 42
	const SPRITE_LASS ; 43
	const SPRITE_OFFICER ; 44
	const SPRITE_OFFICER_F ; 45
	const SPRITE_PHARMACIST ; 46
	const SPRITE_PI ; 47
	const SPRITE_POKEFAN_F ; 48
	const SPRITE_POKEFAN_M ; 49
	const SPRITE_RICH_BOY ; 4a
	const SPRITE_ROCKER ; 4b
	const SPRITE_ROCKET ; 4c
	const SPRITE_ROCKET_GIRL ; 4d
	const SPRITE_SAGE ; 4e
	const SPRITE_SAILOR ; 4f
	const SPRITE_SCIENTIST ; 50
	const SPRITE_SUPER_NERD ; 51
	const SPRITE_SWIMMER_GIRL ; 52
	const SPRITE_SWIMMER_GUY ; 53
	const SPRITE_TEACHER ; 54
	const SPRITE_TWIN ; 55
	const SPRITE_VETERAN_M ; 56
	const SPRITE_VETERAN_F ; 57
	const SPRITE_YOUNGSTER ; 58
	const SPRITE_NURSE ; 59
	const SPRITE_CLERK ; 5a
	const SPRITE_RECEPTIONIST ; 5b
	const SPRITE_LINK_RECEPTIONIST ; 5c
	const SPRITE_GYM_GUY ; 5d
	const SPRITE_FISHING_GURU ; 5e
	const SPRITE_GAMEBOY_KID ; 5f
	const SPRITE_STANDING_YOUNGSTER ; 60
	const SPRITE_CAL ; 61
	const SPRITE_KURT_OUTSIDE ; 62
	const SPRITE_SURF ; 63
	const SPRITE_SURFING_PIKACHU ; 64
	const SPRITE_BIG_SNORLAX ; 65
	const SPRITE_BIG_LAPRAS ; 66
	const SPRITE_BIG_ONIX ; 67
	const SPRITE_WEIRD_TREE ; 68
	const SPRITE_UNOWN_W ; 69
	const SPRITE_UNOWN_A ; 6a
	const SPRITE_UNOWN_R ; 6b
	const SPRITE_UNOWN_P ; 6c
	const SPRITE_POKE_BALL ; 6d
	const SPRITE_POKEDEX ; 6e
	const SPRITE_PAPER ; 6f
	const SPRITE_ROCK ; 70
	const SPRITE_BOULDER ; 71
	const SPRITE_FRUIT_TREE ; 72
	const SPRITE_ELECTRIC_FENCE_LEFT ; 73
	const SPRITE_ELECTRIC_FENCE_RIGHT ; 74
	const SPRITE_FOSSIL ; 75
	const SPRITE_SNES ; 76
	const SPRITE_N64 ; 77
	const SPRITE_GAMECUBE ; 78
	const SPRITE_WII ; 79
	const SPRITE_SILVER_TROPHY ; 7a
	const SPRITE_GOLD_TROPHY ; 7b
	const SPRITE_BIRD ; 7c
	const SPRITE_DRAGON ; 7d
	const SPRITE_FAIRY ; 7e

const_value SET $80

SPRITE_POKEMON EQU const_value
	const SPRITE_BULBASAUR ; 80
	const SPRITE_CHARMANDER ; 81
	const SPRITE_SQUIRTLE ; 82
	const SPRITE_WEEDLE ; 83
	const SPRITE_PIDGEY ; 84
	const SPRITE_PIDGEOT ; 85
	const SPRITE_RATTATA ; 86
	const SPRITE_PIKACHU ; 87
	const SPRITE_NIDORAN_F ; 88
	const SPRITE_NIDORAN_M ; 89
	const SPRITE_NIDORINO ; 8a
	const SPRITE_CLEFAIRY ; 8b
	const SPRITE_JIGGLYPUFF ; 8c
	const SPRITE_ZUBAT ; 8d
	const SPRITE_ODDISH ; 8e
	const SPRITE_DIGLETT ; 8f
	const SPRITE_MEOWTH ; 90
	const SPRITE_PERSIAN ; 91
	const SPRITE_PSYDUCK ; 92
	const SPRITE_POLIWAG ; 93
	const SPRITE_POLIWRATH ; 94
	const SPRITE_ABRA ; 95
	const SPRITE_MACHOP ; 96
	const SPRITE_MACHOKE ; 97
	const SPRITE_TENTACOOL ; 98
	const SPRITE_GEODUDE ; 99
	const SPRITE_SLOWPOKE ; 9a
	const SPRITE_SLOWBRO ; 9b
	const SPRITE_FARFETCH_D ; 9c
	const SPRITE_DODRIO ; 9d
	const SPRITE_GRIMER ; 9e
	const SPRITE_SHELLDER ; 9f
	const SPRITE_GENGAR ; a0
