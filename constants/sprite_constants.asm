...
; sprites
	...
	const SPRITE_ELECTRIC_FENCE ; 73
	const SPRITE_FOSSIL ; 74
	const SPRITE_SNES ; 75
	const SPRITE_N64 ; 76
	const SPRITE_GAMECUBE ; 77
	const SPRITE_WII ; 78
	const SPRITE_SILVER_TROPHY ; 79
	const SPRITE_GOLD_TROPHY ; 7a
	const SPRITE_BIRD ; 7b
	const SPRITE_DRAGON ; 7c
	const SPRITE_FAIRY ; 7d
