...
BASEMON_UNKNOWN_1     EQUS "(BaseData + BaseUnknown1 - CurBaseData)"
BASEMON_EGG_STEPS     EQUS "(BaseData + BaseEggSteps - CurBaseData)"
BASEMON_UNKNOWN_2     EQUS "(BaseData + BaseUnknown2 - CurBaseData)"
...
BASEMON_PADDING       EQUS "(BaseData + BasePadding - CurBaseData)"
