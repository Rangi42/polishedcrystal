...
const_value SET $80
	const PAL_BG_GRAY_PRIORITY   ; 80
	const PAL_BG_RED_PRIORITY    ; 81
	const PAL_BG_GREEN_PRIORITY  ; 82
	const PAL_BG_WATER_PRIORITY  ; 83
	const PAL_BG_YELLOW_PRIORITY ; 84
	const PAL_BG_BROWN_PRIORITY  ; 85
	const PAL_BG_ROOF_PRIORITY   ; 86
	const PAL_BG_TEXT_PRIORITY   ; 87
