const_value SET 1
	...
	const TILESET_JOHTO_3          ; 03
	const TILESET_JOHTO_4          ; 04
	const TILESET_KANTO_1          ; 05
	const TILESET_KANTO_2          ; 06
	...
	const TILESET_TRADITIONAL      ; 0c
	const TILESET_POKECENTER       ; 0d
	const TILESET_POKECOM_CENTER   ; 0e
	const TILESET_MART             ; 0f
	const TILESET_GATE             ; 10
	const TILESET_GYM_1            ; 11
	const TILESET_GYM_2            ; 12
	const TILESET_OLIVINE_GYM      ; 13
	...
	const TILESET_BATTLE_TOWER_IN  ; 1d
