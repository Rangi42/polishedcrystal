...
BATTLETOWER_TRAINERDATALENGTH EQU 11 ; species + item + moves + dvs + personality
BATTLE_TOWER_STRUCT_LENGTH EQU $c7 ; NAME_LENGTH + 3 * (PARTYMON_STRUCT_LENGTH + PKMN_NAME_LENGTH) + BATTLETOWER_TRAINERDATALENGTH
