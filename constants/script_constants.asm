...
; HiddenGrottoData indexes (see data/events/hidden_grottoes/grottoes.asm)
	...
	const HIDDENGROTTO_RUGGED_ROAD      ; 0c
	const HIDDENGROTTO_SNOWTOP_MOUNTAIN ; 0d
	const HIDDENGROTTO_ROUTE_42         ; 0e
	const HIDDENGROTTO_LAKE_OF_RAGE     ; 0f
	const HIDDENGROTTO_BELLCHIME_TRAIL  ; 10
	const HIDDENGROTTO_ROUTE_44         ; 11
	const HIDDENGROTTO_ROUTE_45         ; 12
	const HIDDENGROTTO_ROUTE_46         ; 13
	const HIDDENGROTTO_SINJOH_RUINS     ; 14
	const HIDDENGROTTO_SILVER_CAVE      ; 15
