...
; Link GAME ID's
	const_def 1
	const LINK_GAME_ID_FAITHFUL     ; 1
	const LINK_GAME_ID_NON_FAITHFUL ; 2

if DEF(FAITHFUL)
	DEF LINK_GAME_ID EQU LINK_GAME_ID_FAITHFUL
else
	DEF LINK_GAME_ID EQU LINK_GAME_ID_NON_FAITHFUL
endc
