...
DEF SUMMARY_TILE_HYPER_TRAINING             EQU $3D
DEF SUMMARY_TILE_ARROW                      EQU $3E
DEF SUMMARY_TILE_POKERUS                    EQU $3F
DEF SUMMARY_TILE_POKERUS_CURED              EQU $40
DEF SUMMARY_TILE_PP_START                   EQU $41
