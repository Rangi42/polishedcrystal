...
itemball_event: MACRO
	object_event \1, \2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, \3, \4, \5
ENDM

keyitemball_event: MACRO
	object_event \1, \2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_POKEBALL, PLAYEREVENT_KEYITEMBALL, \3, \4
ENDM

tmhmball_event: MACRO
	object_event \1, \2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, \3, \4
ENDM
