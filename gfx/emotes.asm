...
JumpShadowGFX:   INCBIN "gfx/overworld/shadow.2bpp.lz"
FishingRodGFX:   INCBIN "gfx/overworld/fishing_rod.2bpp.lz"
BoulderDustGFX:  INCBIN "gfx/overworld/boulderdust.2bpp.lz"
ShakingGrassGFX: INCBIN "gfx/overworld/shaking_grass.2bpp.lz"
PuddleSplashGFX: INCBIN "gfx/overworld/puddle_splash.2bpp.lz"
