...
CuardhartFootprint:: INCBIN "gfx/footprints/cuardhart.1bpp.lz"
...
TidipossFootprint:: INCBIN "gfx/footprints/tidiposs.1bpp.lz"
ScourpossFootprint:: INCBIN "gfx/footprints/scourposs.1bpp.lz"
