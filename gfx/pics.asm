...
HonchkrowFrontpic:        INCBIN "gfx/pics/honchkrow/front.2bpp.lz"
HonchkrowBackpic:         INCBIN "gfx/pics/honchkrow/back.2bpp.lz"
...
UnownExclamationFrontpic: INCBIN "gfx/pics/unown_exclamation/front.2bpp.lz"
