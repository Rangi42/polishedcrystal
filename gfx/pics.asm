...
SECTION "Trainer Pic Pointers", ROMX, BANK[$2]
...
MagikarpFrontpic:      INCBIN "gfx/pics/magikarp_plain/front.2bpp.lz"
...
MagikarpBackpic:       INCBIN "gfx/pics/magikarp_plain/back.2bpp.lz"
