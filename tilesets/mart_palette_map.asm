	...
	tilepal 0, GRAY, GREEN, GREEN, RED, RED, WATER, WATER, WATER
...
endr
	...
	tilepal 1, GRAY, GRAY, WATER, GRAY, GRAY, BROWN, YELLOW, WATER
	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, YELLOW, WATER, WATER, ROOF
