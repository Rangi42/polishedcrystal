	...
	tilepal 0, GRAY, BROWN, BROWN, GRAY, GREEN, GREEN, GRAY, GRAY
	tilepal 0, GREEN, GREEN, BROWN, BROWN, GREEN, GREEN, BROWN, BROWN
...
endr
	...
	tilepal 1, GRAY, YELLOW, BROWN, GRAY, BROWN, YELLOW, YELLOW, GRAY
	tilepal 1, GRAY, BROWN, BROWN, GRAY, GREEN, GREEN, GRAY, GRAY
