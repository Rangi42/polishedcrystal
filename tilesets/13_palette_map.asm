	...
	tilepal 0, GRAY, GRAY, GRAY, GRAY, WATER, ROOF, WATER, WATER
	...
	tilepal 0, ROOF, ROOF, ROOF, ROOF, ROOF, WATER, BROWN, BROWN
	tilepal 0, BROWN, GREEN, BROWN, BROWN, BROWN, BROWN, BROWN, BROWN
	tilepal 0, ROOF, ROOF, ROOF, ROOF, GREEN, WATER, BROWN, BROWN
