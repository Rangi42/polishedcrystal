	tilepal 0, GRAY, GREEN, GREEN, RED, BROWN, RED, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, BROWN, GREEN, GREEN, GREEN, GREEN
	tilepal 0, RED, RED, RED, RED, WATER, BROWN, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, BROWN, GREEN, GREEN, GREEN, GREEN
	...
	tilepal 0, BROWN, BROWN, GREEN, GREEN, GRAY, GRAY, GRAY, ROOF
	tilepal 0, BROWN, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY, BROWN
