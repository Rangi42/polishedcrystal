OlivinePort_MapScriptHeader:
	...
	warp_event 16,  4, OLIVINE_CITY, 11
	warp_event 17,  4, OLIVINE_CITY, 12
	...
	object_event 12,  6, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, OlivinePortFishingGuru2Script, EVENT_OLIVINE_PORT_SPRITES_BEFORE_HALL_OF_FAME
