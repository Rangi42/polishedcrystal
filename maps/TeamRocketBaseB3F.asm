...
UnknownScript_0x6e056:
	...
	loadtrainer EXECUTIVEM, PETREL1
	startbattle
...
.PersonEvents:
	...
	person_event SPRITE_ROCKET, 3, 8, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B3F_EXECUTIVE
	...
	person_event SPRITE_POKE_BALL, 12, 3, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, TeamRocketBaseB3FXSpclDef, EVENT_TEAM_ROCKET_BASE_B3F_X_SPCL_DEF
