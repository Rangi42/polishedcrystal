...
.PersonEvents: db 3
	...
	person_event SPRITE_GENTLEMAN, 3, 6, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_JUMPTEXTFP, 0, FlowerShopGentlemanText, EVENT_FLORIA_AT_SUDOWOODO
