...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, REVIVE, 1, EVENT_MOUNT_MOON_1F_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 20, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_ACCURACY, 1, EVENT_MOUNT_MOON_1F_X_ACCURACY
	person_event SPRITE_BALL_CUT_FRUIT, 22, 16, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, CALCIUM, 1, EVENT_MOUNT_MOON_1F_CALCIUM
