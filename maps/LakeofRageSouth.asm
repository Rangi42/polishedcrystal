...
.PersonEvents: db 12
	...
	person_event SPRITE_BIG_GYARADOS, 6, 18, SPRITEMOVEDATA_BIG_GYARADOS, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, LakeOfRageRedGyaradosScript, EVENT_LAKE_OF_RAGE_RED_GYARADOS
