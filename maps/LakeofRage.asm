...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 2, 35, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, LakeofRageTMShadowClaw, EVENT_LAKE_OF_RAGE_TM_SHADOW_CLAW
