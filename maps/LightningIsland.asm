...
.PersonEvents: db 14
	person_event SPRITE_BALL_CUT_FRUIT, 15, 22, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DAMP_ROCK, 1, EVENT_LIGHTNING_ISLAND_DAMP_ROCK
