...
.PersonEvents: db 6
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 5, 6, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, strengthboulder, EVENT_BOULDER_IN_CINNABAR_VOLCANO_B1F
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 28, 8, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 17, 28, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 5, 27, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, smashrock, -1
