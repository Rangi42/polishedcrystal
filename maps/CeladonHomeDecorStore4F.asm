const_value set 2
	...
	const CELADONHOMEDECORSTORE4F_BIG_LAPRAS_DOLL
	const CELADONHOMEDECORSTORE4F_BIG_SNORLAX_DOLL
...
.DailyDolls:
	...
	if_equal MONDAY, .LaprasAndSnorlax
	if_equal TUESDAY, .LaprasAndOnix
	if_equal WEDNESDAY, .SnorlaxAndOnix
	if_equal THURSDAY, .LaprasAndSnorlax
	if_equal FRIDAY, .LaprasAndOnix
	if_equal SATURDAY, .SnorlaxAndOnix
.LaprasAndSnorlax:
	appear CELADONHOMEDECORSTORE4F_BIG_LAPRAS_DOLL
	appear CELADONHOMEDECORSTORE4F_BIG_SNORLAX_DOLL
	disappear CELADONHOMEDECORSTORE4F_BIG_ONIX_DOLL
	return

.LaprasAndOnix:
	appear CELADONHOMEDECORSTORE4F_BIG_LAPRAS_DOLL
	disappear CELADONHOMEDECORSTORE4F_BIG_SNORLAX_DOLL
	appear CELADONHOMEDECORSTORE4F_BIG_ONIX_DOLL
	return

.SnorlaxAndOnix:
	disappear CELADONHOMEDECORSTORE4F_BIG_LAPRAS_DOLL
	appear CELADONHOMEDECORSTORE4F_BIG_SNORLAX_DOLL
	appear CELADONHOMEDECORSTORE4F_BIG_ONIX_DOLL
	return
...
.PersonEvents:
	...
	person_event SPRITE_BIG_LAPRAS, 4, 4, SPRITEMOVEDATA_SNORLAX, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BigLaprasDollScript, EVENT_BIG_LAPRAS_DOLL_ON_SALE
	person_event SPRITE_BIG_SNORLAX, 5, 2, SPRITEMOVEDATA_SNORLAX, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BigSnorlaxDollScript, EVENT_BIG_SNORLAX_DOLL_ON_SALE
	person_event SPRITE_BIG_ONIX, 3, 1, SPRITEMOVEDATA_BIGDOLL, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, BigOnixDollScript, EVENT_BIG_ONIX_DOLL_ON_SALE
