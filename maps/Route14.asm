...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 8, 5, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route14CutTree, EVENT_ROUTE_14_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 14, 11, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route14CutTree, EVENT_ROUTE_14_CUT_TREE_2
	person_event SPRITE_CUT_TREE, 24, 3, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route14CutTree, EVENT_ROUTE_14_CUT_TREE_3
