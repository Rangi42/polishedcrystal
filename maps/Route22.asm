...
.Warps:
	db 1
	warp_def $5, $d, 1, POKEMON_LEAGUE_GATE
...
.PersonEvents:
	db 4
	person_event SPRITE_CELEBI, 10, 32, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_22_CELEBI
	person_event SPRITE_LYRA, 9, 31, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_22_LYRA
	person_event SPRITE_SILVER, 4, 31, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_22_SILVER
	person_event SPRITE_GIOVANNI, 4, 28, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_22_GIOVANNI
