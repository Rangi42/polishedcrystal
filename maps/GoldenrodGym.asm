...
.MapTriggers:
	db 2
	maptrigger UnknownScript_0x5400a
	maptrigger UnknownScript_0x5400b
...
.PersonEvents:
	...
	person_event SPRITE_BEAUTY, 5, 19, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerBeautySamantha, -1
