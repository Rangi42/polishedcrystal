...
MapGroup19:
	...
	map_header NavelRockOutside, TILESET_KANTO, INDOOR, NAVEL_ROCK, MUSIC_LAKE_OF_RAGE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header NavelRockInside, TILESET_SPECIAL_CAVE, INDOOR, NAVEL_ROCK, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_OCEAN
	map_header NavelRockRoof, TILESET_SPECIAL_CAVE, INDOOR, NAVEL_ROCK, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_OCEAN
	map_header FarawayIsland, TILESET_FARAWAY_ISLAND, INDOOR, FARAWAY_ISLAND, MUSIC_ABANDONED_SHIP_RSE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header FarawayJungle, TILESET_FARAWAY_ISLAND, INDOOR, FARAWAY_ISLAND, MUSIC_ABANDONED_SHIP_RSE, 0, PALETTE_AUTO, FISHGROUP_SHORE
