...
MapGroup9:
	...
	map_header SinjohRuins, TILESET_JOHTO_2, ROUTE, SINJOH_RUINS, MUSIC_NONE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header SinjohRuinsHouse, TILESET_HOUSE_1, INDOOR, SINJOH_RUINS, MUSIC_NONE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header MystriStage, TILESET_SPROUT_TOWER, CAVE, MYSTRI_STAGE, MUSIC_NONE, 0, PALETTE_NITE, FISHGROUP_SHORE
	map_header EmbeddedTower, TILESET_SPROUT_TOWER, CAVE, ROUTE_47, MUSIC_NONE, 0, PALETTE_NITE, FISHGROUP_SHORE
