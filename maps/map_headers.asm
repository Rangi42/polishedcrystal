...
MapGroup9:
	...
	map_header MystriStage, TILESET_SPROUT_TOWER, INDOOR, MYSTRI_STAGE, MUSIC_MOUNT_CORONET_DPPT, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header EmbeddedTower, TILESET_SPROUT_TOWER, CAVE, ROUTE_47, MUSIC_UNION_CAVE, 1, PALETTE_NITE, FISHGROUP_SHORE
