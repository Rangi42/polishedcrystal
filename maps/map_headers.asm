...
MapGroup6:
	...
	map_header PokemonMansion1F, TILESET_POKEMON_MANSION, CAVE, POKEMON_MANSION, MUSIC_CINNABAR_MANSION_RBY, 0, PALETTE_NITE, FISHGROUP_SHORE
	map_header PokemonMansionB1F, TILESET_POKEMON_MANSION, CAVE, POKEMON_MANSION, MUSIC_CINNABAR_MANSION_RBY, 0, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup9:
	...
	map_header SinjohRuins, TILESET_JOHTO_2, PERM_5, SINJOH_RUINS, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header SinjohRuinsHouse, TILESET_HOUSE_1, INDOOR, SINJOH_RUINS, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header MystriStage, TILESET_SPROUT_TOWER, INDOOR, MYSTRI_STAGE, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_NITE, FISHGROUP_SHORE
	map_header EmbeddedTower, TILESET_SPROUT_TOWER, CAVE, ROUTE_47, MUSIC_UNION_CAVE, 0, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup19:
	...
	map_header NavelRockOutside, TILESET_KANTO, PERM_5, NAVEL_ROCK, MUSIC_LAKE_OF_RAGE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header NavelRockInside, TILESET_CAVE, CAVE, NAVEL_ROCK, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_OCEAN
	map_header NavelRockRoof, TILESET_CAVE, CAVE, NAVEL_ROCK, MUSIC_NONE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header FarawayIsland, TILESET_FARAWAY_ISLAND, PERM_5, FARAWAY_ISLAND, MUSIC_ABANDONED_SHIP_RSE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header FarawayJungle, TILESET_FARAWAY_ISLAND, PERM_5, FARAWAY_ISLAND, MUSIC_ABANDONED_SHIP_RSE, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map_header SeagallopFerryNavelGate, TILESET_PORT, GATE, NAVEL_ROCK, MUSIC_LAKE_OF_RAGE, 0, PALETTE_DAY, FISHGROUP_OCEAN
