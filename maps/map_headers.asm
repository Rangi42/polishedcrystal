...
MapGroup9:
	...
	map_header SinjohRuins, TILESET_JOHTO_2, ROUTE, SINJOH_RUINS, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header SinjohRuinsHouse, TILESET_HOUSE_1, INDOOR, SINJOH_RUINS, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header MystriStage, TILESET_SPROUT_TOWER, CAVE, MYSTRI_STAGE, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup19:
	...
	map_header NavelRockOutside, TILESET_KANTO, ROUTE, NAVEL_ROCK, MUSIC_LAKE_OF_RAGE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map_header FarawayIsland, TILESET_FARAWAY_ISLAND, ROUTE, FARAWAY_ISLAND, MUSIC_ABANDONED_SHIP_RSE, 0, PALETTE_AUTO, FISHGROUP_SHORE
