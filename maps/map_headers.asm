...
MapGroup21:
	...
	map_header Route17, TILESET_KANTO_1, ROUTE, ROUTE_17, MUSIC_ROUTE_3, 0, PALETTE_AUTO, FISHGROUP_NONE
	map_header Route18West, TILESET_KANTO_1, ROUTE, ROUTE_18, MUSIC_ROUTE_3, 0, PALETTE_AUTO, FISHGROUP_NONE
