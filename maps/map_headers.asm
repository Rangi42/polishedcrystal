...
MapGroup7:
	...
	map_header CeruleanCave1F, TILESET_CERULEAN_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header CeruleanCave2F, TILESET_CERULEAN_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header CeruleanCaveB1F, TILESET_CERULEAN_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_SHORE
