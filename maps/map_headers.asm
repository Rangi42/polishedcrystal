...
MapGroup22:
	...
	map_header CliffEdgeGate, TILESET_CAVE, CAVE, CIANWOOD_CITY, MUSIC_ROUTE_36, 1, PALETTE_DAY, FISHGROUP_LAKE
	map_header Route47, TILESET_JOHTO_1, ROUTE, CIANWOOD_CITY, MUSIC_ROUTE_36, 0, PALETTE_AUTO, FISHGROUP_LAKE
