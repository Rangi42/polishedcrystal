...
MapGroup7:
	...
	map_header CeruleanCave1F, TILESET_SPECIAL_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_GYARADOS
	map_header CeruleanCave2F, TILESET_SPECIAL_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_GYARADOS
	map_header CeruleanCaveB1F, TILESET_SPECIAL_CAVE, CAVE, CERULEAN_CAVE, MUSIC_MT_MOON, 1, PALETTE_NITE, FISHGROUP_GYARADOS
...
MapGroup17:
	...
	map_header SafariZoneFuchsiaGate, TILESET_GATE, GATE, FUCHSIA_CITY, MUSIC_CELADON_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SafariZoneHub, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_AUTO, FISHGROUP_DRATINI
	map_header SafariZoneEast, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_AUTO, FISHGROUP_DRATINI
	map_header SafariZoneNorth, TILESET_SAFARI_ZONE, ROUTE, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_AUTO, FISHGROUP_DRATINI
	map_header SafariZoneHubRestHouse, TILESET_POWER_PLANT, INDOOR, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SafariZoneEastRestHouse, TILESET_POWER_PLANT, INDOOR, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SafariZoneNorthRestHouse, TILESET_POWER_PLANT, INDOOR, SAFARI_ZONE, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup23:
	...
	map_header ViridianForest, TILESET_ILEX_FOREST, ROUTE, VIRIDIAN_FOREST, MUSIC_MT_MOON, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header ViridianForestViridianGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header ViridianForestPewterGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, 0, PALETTE_DAY, FISHGROUP_SHORE
