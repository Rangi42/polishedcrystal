...
MapGroup17:
	...
	map_header SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, FUCHSIA_CITY, MUSIC_CERULEAN_CITY_HGSS, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup19:
	...
	map_header NavelRockOutside, TILESET_KANTO_1, PERM_5, NAVEL_ROCK, MUSIC_LAKE_OF_RAGE, 1, PALETTE_AUTO, FISHGROUP_OCEAN
