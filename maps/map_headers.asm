...
MapGroup9:
	...
	map_header MystriStage, TILESET_SPROUT_TOWER, PERM_5, MYSTRI_STAGE, MUSIC_MOUNT_CORONET_DPPT, 0, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup19:
	...
	map_header NavelRockInside, TILESET_CAVE, PERM_5, NAVEL_ROCK, MUSIC_MT_MOON, 0, PALETTE_DAY, FISHGROUP_OCEAN
	map_header NavelRockRoof, TILESET_CAVE, PERM_5, NAVEL_ROCK, MUSIC_NONE, 0, PALETTE_AUTO, FISHGROUP_OCEAN
