...
MapGroup22:
	...
	map_header Route47, TILESET_JOHTO_1, ROUTE, ROUTE_47, MUSIC_ROUTE_36, 0, PALETTE_AUTO, FISHGROUP_LAKE
	map_header CliffCave, TILESET_CAVE, CAVE, CLIFF_CAVE, MUSIC_ROUTE_36, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header Route48, TILESET_JOHTO_1, ROUTE, ROUTE_48, MUSIC_ROUTE_36, 0, PALETTE_AUTO, FISHGROUP_LAKE
	map_header YellowForestGate, TILESET_GATE, GATE, ROUTE_48, MUSIC_ROUTE_36, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header YellowForest, TILESET_YELLOW_FOREST, ROUTE, YELLOW_FOREST, MUSIC_ROUTE_36, 0, PALETTE_AUTO, FISHGROUP_LAKE
