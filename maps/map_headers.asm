...
MapGroup6:
	...
	map_header SeafoamIslands1F, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, 1, PALETTE_DAY, FISHGROUP_DRATINI
	map_header SeafoamGym, TILESET_CAVE, CAVE, SEAFOAM_ISLANDS, MUSIC_GYM, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_DRATINI
	map_header SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_DRATINI
	map_header SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_DRATINI
	map_header SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, 1, PALETTE_NITE, FISHGROUP_DRATINI
	...
	map_header CinnabarVolcano1F, TILESET_SPECIAL_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_REVERSAL_MOUNTAIN_W2, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header CinnabarVolcanoB1F, TILESET_SPECIAL_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_REVERSAL_MOUNTAIN_W2, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header CinnabarVolcanoB2F, TILESET_SPECIAL_CAVE, CAVE, CINNABAR_VOLCANO, MUSIC_REVERSAL_MOUNTAIN_W2, 1, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup24:
	...
	map_header LyrasHouse2F, TILESET_KRISS_HOUSE_2F, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_DAY, FISHGROUP_SHORE
