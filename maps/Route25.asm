...
UnknownScript_0x19eea0:
	...
	pause 30
	showemote EMOTE_SHOCK, ROUTE25_MISTY_BOYFRIEND, 10
	spriteface ROUTE25_MISTY, DOWN
	applymovement ROUTE25_MISTY_BOYFRIEND, MovementData_0x19efe8
	disappear ROUTE25_MISTY_BOYFRIEND
	pause 15
...
UnknownScript_0x19eee0:
	...
	showemote EMOTE_SHOCK, ROUTE25_MISTY_BOYFRIEND, 10
	spriteface ROUTE25_MISTY, DOWN
	applymovement ROUTE25_MISTY_BOYFRIEND, MovementData_0x19efea
	disappear ROUTE25_MISTY_BOYFRIEND
	pause 15
	playmusic MUSIC_BEAUTY_ENCOUNTER
	spriteface ROUTE25_MISTY, UP
...
.PersonEvents:
	...
	person_event SPRITE_YOUNGSTER, 10, 46, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_25_MISTY_BOYFRIEND
