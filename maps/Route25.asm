...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 4, 41, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PROTEIN, 1, EVENT_ROUTE_25_PROTEIN
	person_event SPRITE_BALL_CUT_FRUIT, 6, 44, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_25_CUT_TREE
