CeladonUniversity2F_MapScriptHeader:
	...
	def_warp_events
	warp_event 15,  0, CELADON_UNIVERSITY_1F, 3
	warp_event 16,  6, CELADON_UNIVERSITY_CAFETERIA, 1
	warp_event  1,  8, CELADON_UNIVERSITY_WILLOWS_OFFICE, 1
	warp_event 16,  6, CELADON_UNIVERSITY_HYPER_TEST_ROOM, 1
	warp_event 19,  8, CELADON_UNIVERSITY_WESTWOODS_OFFICE, 1
	warp_event 23,  8, CELADON_UNIVERSITY_POOL, 1
	warp_event  5,  8, CELADON_UNIVERSITY_NURSES_OFFICE, 1

	def_coord_events

	def_bg_events
	bg_event  9,  8, BGEVENT_JUMPTEXT, CeladonUniversity2FCafeteriaSignText
	bg_event 12,  1, BGEVENT_JUMPTEXT, CeladonUniversity2FHyperTestSignText
	bg_event 19,  1, BGEVENT_JUMPTEXT, CeladonUniversity2FPoolSignText
	...
	bg_event  5,  0, BGEVENT_READ, CeladonUniversity2FMagikarpSign
	bg_event 22,  8, BGEVENT_READ, CeladonUniversity2FCuboneSign

	def_object_events
	object_event  5,  3, SPRITE_BATTLE_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, CeladonUniversity2FCooltrainerfScript, -1
	object_event  2,  2, SPRITE_COOL_DUDE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity2FCooltrainermText, -1
	object_event 11,  2, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity2FYoungster1Text, -1
	...
	object_event 18,  4, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity2FBug_catcherText, -1
	object_event 18,  2, SPRITE_CUTE_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_RED, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity2FLassText, -1
	object_event 16, 13, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, jumptextfaceplayer, CeladonUniversity2FYoungster2Text, -1
