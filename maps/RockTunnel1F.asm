...
.PersonEvents: db 3
	...
	person_event SPRITE_BALL_CUT_FRUIT, 15, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ELIXER, 1, EVENT_ROCK_TUNNEL_1F_ELIXER
	person_event SPRITE_BALL_CUT_FRUIT, 15, 10, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, HP_UP, 1, EVENT_ROCK_TUNNEL_1F_HP_UP
