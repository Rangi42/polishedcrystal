...
.PersonEvents: db 13
	...
	person_event SPRITE_BALL_CUT_FRUIT, 12, 58, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_DRAGON_CLAW, EVENT_ROUTE_27_TM_DRAGON_CLAW
	person_event SPRITE_BALL_CUT_FRUIT, 12, 53, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, RARE_CANDY, 1, EVENT_ROUTE_27_RARE_CANDY
	person_event SPRITE_BALL_CUT_FRUIT, 4, 71, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DESTINY_KNOT, 1, EVENT_ROUTE_27_DESTINY_KNOT
	person_event SPRITE_BALL_CUT_FRUIT, 12, 60, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_27, LUM_BERRY, -1
