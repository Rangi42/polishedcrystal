Route10North_MapScriptHeader:
	...
	def_object_events
	object_event 13, 44, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ZAPDOS, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, ZAPDOS, Route10Zapdos, EVENT_ROUTE_10_ZAPDOS
	...
	object_event 14, 52, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ZAPDOS, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, ZAPDOS, ObjectEvent, EVENT_LAWRENCES_ZAPDOS_ROUTE_10
