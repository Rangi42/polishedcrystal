...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 3, 11, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, FULL_RESTORE, 1, EVENT_ROUTE_10_FULL_RESTORE
	person_event SPRITE_BALL_CUT_FRUIT, 21, 7, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_10_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 21, 9, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_10_CUT_TREE_2
	person_event SPRITE_BALL_CUT_FRUIT, 21, 11, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_10_CUT_TREE_3
	person_event SPRITE_BALL_CUT_FRUIT, 21, 13, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_10_CUT_TREE_4
