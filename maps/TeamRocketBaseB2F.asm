TeamRocketBaseB2F_MapScriptHeader:
	...
	pokemon_event 22,  5, ELECTRODE, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_1
	pokemon_event 22,  7, ELECTRODE, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_2
	pokemon_event 22,  9, ELECTRODE, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_RED, ClearText, EVENT_TEAM_ROCKET_BASE_B2F_ELECTRODE_3
