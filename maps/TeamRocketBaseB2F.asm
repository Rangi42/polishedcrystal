...
.PersonEvents:
	...
	person_event SPRITE_BALL_CUT_FRUIT, 10, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, TeamRocketBaseB2FHyperPotion, EVENT_TEAM_ROCKET_BASE_B2F_HYPER_POTION
