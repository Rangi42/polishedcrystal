...
.PersonEvents: db 1
	person_event SPRITE_BALL_CUT_FRUIT, 19, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, HEAT_ROCK, 1, EVENT_FIRE_ISLAND_HEAT_ROCK
