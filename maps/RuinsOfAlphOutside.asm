RuinsOfAlphOutside_MapScriptHeader:
	...
	warp_event 11, 22, RUINS_OF_ALPH_ENTRANCE_CHAMBER, 1
	warp_event 12, 22, RUINS_OF_ALPH_ENTRANCE_CHAMBER, 2
	...
	def_coord_events
	coord_event 11, 24, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene

	def_bg_events
	bg_event 16, 16, BGEVENT_JUMPTEXT, RuinsOfAlphOutsideMysteryChamberSignText
	bg_event 10, 23, BGEVENT_JUMPTEXT, RuinsOfAlphOutsideMysteriousHallSignText
	...
	def_object_events
	object_event 12, 24, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_RUINS_OF_ALPH_OUTSIDE_SCIENTIST
	...
	object_event 10, 27, SPRITE_FISHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFisherScript, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FISHER
