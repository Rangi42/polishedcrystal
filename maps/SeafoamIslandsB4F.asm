SeafoamIslandsB4F_MapScriptHeader:
	...
	def_object_events
	object_event 22, 13, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, ARTICUNO, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, ARTICUNO, SeafoamIslandsArticuno, EVENT_SEAFOAM_ISLANDS_ARTICUNO
