...
.PersonEvents: db 13
	...
	person_event SPRITE_BALL_CUT_FRUIT, 7, 27, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_SPCL_DEF, 1, EVENT_SCARY_CAVE_1F_X_SPCL_DEF
	person_event SPRITE_BALL_CUT_FRUIT, 9, 4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DUSK_STONE, 1, EVENT_SCARY_CAVE_1F_DUSK_STONE
	person_event SPRITE_BALL_CUT_FRUIT, 19, 33, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, HYPER_POTION, 1, EVENT_SCARY_CAVE_1F_HYPER_POTION
	person_event SPRITE_BALL_CUT_FRUIT, 23, 28, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REPEL, 1, EVENT_SCARY_CAVE_1F_MAX_REPEL
	person_event SPRITE_BALL_CUT_FRUIT, 29, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, REVIVE, 1, EVENT_SCARY_CAVE_1F_REVIVE
