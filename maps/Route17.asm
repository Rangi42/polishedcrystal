...
.Signposts:
	db 2
	signpost 77, 11, SIGNPOST_ITEM, Route17HiddenMaxEther
	signpost 129, 10, SIGNPOST_ITEM, Route17HiddenMaxElixer
...
.PersonEvents:
	...
	person_event SPRITE_BIKER, 71, 9, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 2, TrainerBikerJoel, -1
	person_event SPRITE_BIKER, 60, 3, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 3, TrainerBikerGlenn, -1
	...
	person_event SPRITE_BIKER, 134, 6, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, ObjectEvent, -1
	...
	person_event SPRITE_ROUGHNECK, 48, 6, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 2, TrainerRoughneckTheron, -1
	person_event SPRITE_ROUGHNECK, 93, 4, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 2, TrainerRoughneckMarkey, -1
