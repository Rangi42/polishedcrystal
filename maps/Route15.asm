...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 5, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PP_UP, 1, EVENT_ROUTE_15_PP_UP
