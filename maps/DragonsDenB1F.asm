...
.PersonEvents: db 11
	...
	person_event SPRITE_BALL_CUT_FRUIT, 16, 35, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DRAGON_FANG, 1, EVENT_DRAGONS_DEN_B1F_DRAGON_FANG
	person_event SPRITE_BALL_CUT_FRUIT, 4, 30, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, CALCIUM, 1, EVENT_DRAGONS_DEN_B1F_CALCIUM
	person_event SPRITE_BALL_CUT_FRUIT, 20, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_ELIXER, 1, EVENT_DRAGONS_DEN_B1F_MAX_ELIXER
