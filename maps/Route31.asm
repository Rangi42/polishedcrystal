...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 5, 13, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31CutTree, EVENT_ROUTE_31_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 10, 25, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31CutTree, EVENT_ROUTE_31_CUT_TREE_2
