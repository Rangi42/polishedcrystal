...
.Warps:
	db 2
	warp_def $8, $4, 3, ROUTE_8_SAFFRON_GATE
	warp_def $9, $4, 4, ROUTE_8_SAFFRON_GATE
...
.PersonEvents:
	...
	person_event SPRITE_SUPER_NERD, 2, 26, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 3, TrainerSupernerdSam, -1
	person_event SPRITE_SUPER_NERD, 7, 32, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 3, TrainerSupernerdTom, -1
	person_event SPRITE_GENTLEMAN, 12, 43, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerGentlemanMilton, -1
	person_event SPRITE_SUPER_NERD, 7, 17, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_TRAINER, 3, TrainerPokemaniacMoe, -1
	person_event SPRITE_CUT_TREE, 12, 21, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route8CutTree, EVENT_ROUTE_8_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 10, 33, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route8CutTree, EVENT_ROUTE_8_CUT_TREE_2
	person_event SPRITE_FRUIT_TREE, 5, 45, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, FruitTreeScript_0x6c06c, -1
	person_event SPRITE_BIKER, 7, 6, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, Route8BikerDwayneScript, EVENT_RETURNED_MACHINE_PART
	person_event SPRITE_BIKER, 8, 7, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, Route8BikerHarrisScript, EVENT_RETURNED_MACHINE_PART
	person_event SPRITE_BIKER, 9, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, Route8BikerZekeScript, EVENT_RETURNED_MACHINE_PART
