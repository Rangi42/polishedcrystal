...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 14, 21, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_8_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 12, 32, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_8_CUT_TREE_2
	person_event SPRITE_BALL_CUT_FRUIT, 7, 45, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_8, SALAC_BERRY, -1
