...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 12, 21, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route8CutTree, EVENT_ROUTE_8_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 10, 27, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route8CutTree, EVENT_ROUTE_8_CUT_TREE_2
