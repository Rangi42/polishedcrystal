Route40_MapScriptHeader:
	...
	object_event 11, 13, SPRITE_BEACH_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, Route40BeachGirlText, -1
	...
	object_event 14,  8, SPRITE_BEACH_GIRL, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route40BeachGuyScript, -1
