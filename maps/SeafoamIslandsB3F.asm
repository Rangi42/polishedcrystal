...
.Warps:
	...
	warp_def $f, $23, 7, SEAFOAM_ISLANDS_B2F
	...
	; warp_def $d, $24, 6, SEAFOAM_ISLANDS_B4F
...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 6, 17, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SeafoamIslandsB3FBigPearl, EVENT_SEAFOAM_ISLANDS_B3F_BIG_PEARL
