...
.PersonEvents:
	db 2
	person_event SPRITE_BALL_CUT_FRUIT, 10, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, NavelRockInsideSacredAsh, EVENT_NAVEL_ROCK_SACRED_ASH
	person_event SPRITE_BALL_CUT_FRUIT, 10, 37, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, NavelRockInsideMasterBall, EVENT_NAVEL_ROCK_MASTER_BALL
