...
.PersonEvents: db 2
	person_event SPRITE_BALL_CUT_FRUIT, 12, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, SACRED_ASH, 1, EVENT_NAVEL_ROCK_SACRED_ASH
	person_event SPRITE_BALL_CUT_FRUIT, 12, 37, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MASTER_BALL, 1, EVENT_NAVEL_ROCK_MASTER_BALL
