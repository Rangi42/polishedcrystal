VermilionPollutionSpeechHouse_MapScriptHeader:
	...
	db 2 ; object events
	object_event  1,  4, SPRITE_BREEDER, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumptextfaceplayer, VermilionPollutionSpeechHouseBreederText, -1
