...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 9, 13, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, UndergroundWarehouseTMXScissor, EVENT_UNDERGROUND_WAREHOUSE_TM_X_SCISSOR
