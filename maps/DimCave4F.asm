...
.PersonEvents: db 8
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 15, 14, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, EVENT_BOULDER_IN_DIM_CAVE_4F
