...
.PersonEvents: db 8
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 15, 14, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, 0, EVENT_BOULDER_IN_DIM_CAVE_4F
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 17, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_ETHER, 1, EVENT_DIM_CAVE_4F_MAX_ETHER
	person_event SPRITE_BALL_CUT_FRUIT, 8, 27, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, NUGGET, 1, EVENT_DIM_CAVE_4F_NUGGET
	person_event SPRITE_BALL_CUT_FRUIT, 23, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, FULL_RESTORE, 1, EVENT_DIM_CAVE_4F_FULL_RESTORE
