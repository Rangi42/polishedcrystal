...
.PersonEvents: db 6
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 16, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ELIXER, 1, EVENT_UNION_CAVE_B2F_ELIXER
	person_event SPRITE_BALL_CUT_FRUIT, 19, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, HYPER_POTION, 1, EVENT_UNION_CAVE_B2F_HYPER_POTION
