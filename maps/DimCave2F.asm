...
.PersonEvents: db 7
	...
	person_event SPRITE_BALL_CUT_FRUIT, 12, 28, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REVIVE, 1, EVENT_DIM_CAVE_2F_MAX_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 15, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, IRON, 1, EVENT_DIM_CAVE_2F_IRON
	person_event SPRITE_BALL_CUT_FRUIT, 33, 31, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_FACADE, EVENT_DIM_CAVE_2F_TM_FACADE
