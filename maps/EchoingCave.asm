EchoingCave_MapScriptHeader:
	def_scene_scripts
	; scene_script EchoingCaveTrigger0
	...
	def_bg_events
	; bg_event  5, 13, BGEVENT_ITEM + RARE_CANDY, EVENT_ECHOING_CAVE_1F_HIDDEN_RARE_CANDY
	; bg_event  9,  6, BGEVENT_ITEM + FULL_RESTORE, EVENT_ECHOING_CAVE_1F_HIDDEN_FULL_RESTORE
	...
	; itemball_event  3,  2, REVIVE, 1, EVENT_ECHOING_CAVE_1F_REVIVE
	; itemball_event  5,  3, X_ACCURACY, 1, EVENT_ECHOING_CAVE_1F_X_ACCURACY
	; itemball_event  2, 10, CALCIUM, 1, EVENT_ECHOING_CAVE_1F_CALCIUM
...
; 	pause 15
; 	applymovement MOUNTMOON1F_RIVAL, EchoingCaveRivalMovementBefore
...
; 	applymovement PLAYER, EchoingCavePlayerMovement
