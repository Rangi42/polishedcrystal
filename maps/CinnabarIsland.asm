...
.PersonEvents: db 2
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 22, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAGMARIZER, 1, EVENT_CINNABAR_ISLAND_MAGMARIZER
