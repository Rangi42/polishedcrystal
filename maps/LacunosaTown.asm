LacunosaTown_MapScriptHeader:
	...
	object_event 11,  3, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_EDGE, 0, 0, -1, -1, PAL_NPC_ROCK, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 22,  2, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_UPPER, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 22,  5, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_LOWER, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 14, 13, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_UPPER, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 14, 16, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_LOWER, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 19, 13, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_UPPER_FLIP, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 19, 16, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_LOWER_FLIP, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	...
	object_event 15, 15, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_LEFT, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
	object_event 17, 15, SPRITE_LACUNOSA_TILES, SPRITEMOVEDATA_RAIL_RIGHT, 0, 0, -1, -1, PAL_NPC_TREE, PERSONTYPE_COMMAND, end, NULL, -1
...
lacunosa_town_overhead_changebridgeblocks: MACRO
	...
	changebridgeblock 16, 14, $4d, LACUNOSA_TOWN
...
lacunosa_town_underfoot_changebridgeblocks: MACRO
	...
	changebridgeblock 16, 14, $a1, LACUNOSA_TOWN
