...
.PersonEvents: db 9
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 8, 17, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, 0, -1
	person_event SPRITE_BALL_CUT_FRUIT, 4, 16, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_ENDURE, EVENT_BURNED_TOWER_B1F_TM_ENDURE
