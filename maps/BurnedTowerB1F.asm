BurnedTowerB1F_MapScriptHeader:
	...
	def_object_events
	pokemon_event  7,  3, RAIKOU, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BROWN, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event 12,  3, ENTEI, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_RED, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event 10,  4, SUICUNE, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BLUE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event  7,  3, RAIKOU, SPRITEMOVEDATA_STILL, -1, MON_PAL_TAN_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 12,  3, ENTEI, SPRITEMOVEDATA_STILL, -1, MON_PAL_TAN_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 10,  4, SUICUNE, SPRITEMOVEDATA_STILL, -1, MON_PAL_TAN_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
