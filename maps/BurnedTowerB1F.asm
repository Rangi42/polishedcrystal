BurnedTowerB1F_MapScriptHeader:
	...
	pokemon_event  7,  3, RAIKOU, SPRITEMOVEDATA_STILL, -1, -1, PAL_NPC_SILVER, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 12,  3, ENTEI, SPRITEMOVEDATA_STILL, -1, -1, PAL_NPC_SILVER, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 10,  4, SUICUNE, SPRITEMOVEDATA_STILL, -1, -1, PAL_NPC_SILVER, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
