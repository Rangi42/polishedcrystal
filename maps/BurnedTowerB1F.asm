BurnedTowerB1F_MapScriptHeader:
	...
	def_object_events
	object_event  7,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(RAIKOU), -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, HIGH(RAIKOU) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	object_event 12,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(ENTEI), -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, HIGH(ENTEI) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	object_event 10,  4, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(SUICUNE), -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, HIGH(SUICUNE) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	object_event  7,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, LOW(RAIKOU), -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, HIGH(RAIKOU) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
	object_event 12,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, LOW(ENTEI), -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, HIGH(ENTEI) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
	object_event 10,  4, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, LOW(SUICUNE), -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, HIGH(SUICUNE) << MON_EXTSPECIES_F, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_2
