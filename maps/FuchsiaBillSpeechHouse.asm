FuchsiaBillSpeechHouse_MapScriptHeader:
	...
	db 2 ; warp events
	warp_event 2, 7, 3, FUCHSIA_CITY
	warp_event 3, 7, 3, FUCHSIA_CITY
	...
	db 2 ; object events
	object_event 2, 3, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_COMMAND, jumptextfaceplayer, UnknownText_0x1963c3, -1
