...
.PersonEvents: db 9
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 2, 3, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, 0, -1
	person_event SPRITE_BALL_CUT_FRUIT, 3, 10, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, SUPER_POTION, 1, EVENT_SLOWPOKE_WELL_B1F_SUPER_POTION
