...
.PersonEvents: db 9
	...
	person_event SPRITE_KURT, 14, 16, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PERSONTYPE_JUMPTEXTFP, 0, UnknownText_0x5a6b5, EVENT_SLOWPOKE_WELL_KURT
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 2, 3, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, strengthboulder, -1
