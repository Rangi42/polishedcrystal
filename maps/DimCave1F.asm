...
.PersonEvents: db 5
	...
	person_event SPRITE_BALL_CUT_FRUIT, 20, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DUSK_BALL, 1, EVENT_DIM_CAVE_1F_DUSK_BALL
	person_event SPRITE_BALL_CUT_FRUIT, 31, 28, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, RARE_BONE, 1, EVENT_DIM_CAVE_1F_RARE_BONE
