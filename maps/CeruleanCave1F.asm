CeruleanCave1F_MapScriptHeader:
	...
	db 8 ; warp events
	warp_event 27, 21, 7, CERULEAN_CITY
	warp_event 9, 5, 1, CERULEAN_CAVE_2F
	warp_event 29, 5, 2, CERULEAN_CAVE_2F
	warp_event 3, 7, 3, CERULEAN_CAVE_2F
	warp_event 2, 10, 1, CERULEAN_CAVE_B1F
	warp_event 25, 11, 4, CERULEAN_CAVE_2F
	warp_event 20, 13, 5, CERULEAN_CAVE_2F
	warp_event 5, 15, 6, CERULEAN_CAVE_2F
