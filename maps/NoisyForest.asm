NoisyForest_MapScriptHeader:
	...
	object_event 24, 31, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MARILL, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, MARILL, NoisyForestPikabluScript, EVENT_NOISY_FOREST_PIKABLU
