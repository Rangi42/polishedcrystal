...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 33, 15, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, GREAT_BALL, 1, EVENT_UNION_CAVE_1F_GREAT_BALL
	person_event SPRITE_BALL_CUT_FRUIT, 8, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_ATTACK, 1, EVENT_UNION_CAVE_1F_X_ATTACK
	person_event SPRITE_BALL_CUT_FRUIT, 28, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, POTION, 1, EVENT_UNION_CAVE_1F_POTION
	person_event SPRITE_BALL_CUT_FRUIT, 45, 12, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, AWAKENING, 1, EVENT_UNION_CAVE_1F_AWAKENING
