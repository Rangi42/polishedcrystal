...
.PersonEvents:
	...
	person_event SPRITE_BALL_CUT_FRUIT, 11, 26, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, MountMoonB2FZinc, EVENT_MOUNT_MOON_B2F_ZINC
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 6, 10, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | 0, PERSONTYPE_ITEMBALL, 0, MountMoonB2FHelixFossil, EVENT_MOUNT_MOON_B2F_HELIX_FOSSIL
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 6, 11, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | 0, PERSONTYPE_ITEMBALL, 0, MountMoonB2FDomeFossil, EVENT_MOUNT_MOON_B2F_DOME_FOSSIL
