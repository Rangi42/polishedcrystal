...
.PersonEvents: db 6
	...
	person_event SPRITE_BALL_CUT_FRUIT, 4, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MOON_STONE, 1, EVENT_POKEMON_MANSION_1F_MOON_STONE
	person_event SPRITE_BALL_CUT_FRUIT, 3, 14, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ESCAPE_ROPE, 1, EVENT_POKEMON_MANSION_1F_ESCAPE_ROPE
	person_event SPRITE_BALL_CUT_FRUIT, 22, 17, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PROTEIN, 1, EVENT_POKEMON_MANSION_1F_PROTEIN
	person_event SPRITE_BALL_CUT_FRUIT, 22, 27, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, IRON, 1, EVENT_POKEMON_MANSION_1F_IRON
