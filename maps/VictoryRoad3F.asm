...
.PersonEvents: db 2
	...
	person_event SPRITE_BALL_CUT_FRUIT, 13, 16, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, RAZOR_FANG, 1, EVENT_VICTORY_ROAD_3F_RAZOR_FANG
