CeladonMansion1F_MapScriptHeader:
	...
	pokemon_event  2,  6, MEOWTH, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BROWN, CeladonMansion1FMeowthText, -1
	pokemon_event  3,  4, CLEFAIRY, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PINK, CeladonMansion1FClefairyText, -1
	pokemon_event  4,  4, NIDORAN_F, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_TEAL, CeladonMansion1FNidoranFText, -1
