PokemonFanClub_MapScriptHeader:
	...
	def_object_events
	object_event  3,  3, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, CLEFAIRY, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, CLEFAIRY, ClefairyDollScript, EVENT_VERMILION_FAN_CLUB_DOLL
