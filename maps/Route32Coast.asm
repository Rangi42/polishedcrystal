...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 51, 21, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_32_COAST, ASPEAR_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 18, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, WHITE_HERB, 1, EVENT_ROUTE_32_COAST_WHITE_HERB
	person_event SPRITE_BALL_CUT_FRUIT, 63, 22, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, SOFT_SAND, 1, EVENT_ROUTE_32_COAST_SOFT_SAND
