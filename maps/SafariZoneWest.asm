...
.PersonEvents: db 4
	...
	person_event SPRITE_BALL_CUT_FRUIT, 9, 14, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REVIVE, 1, EVENT_SAFARI_ZONE_WEST_MAX_REVIVE
