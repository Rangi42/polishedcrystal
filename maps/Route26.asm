...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 34, 13, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_ITEMBALL, 0, Route26TMDragonPulse, EVENT_ROUTE_26_TM_DRAGON_PULSE
