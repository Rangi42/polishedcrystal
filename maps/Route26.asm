...
.PersonEvents: db 11
	...
	person_event SPRITE_BALL_CUT_FRUIT, 54, 14, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_26, SITRUS_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 15, 9, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_ELIXER, 1, EVENT_ROUTE_26_MAX_ELIXER
	person_event SPRITE_BALL_CUT_FRUIT, 34, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_DRAGON_PULSE, EVENT_ROUTE_26_TM_DRAGON_PULSE
