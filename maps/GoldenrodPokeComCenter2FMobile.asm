const_value set 2
	const GOLDENRODPOKECOMCENTER2FMOBILE_NURSE
	const GOLDENRODPOKECOMCENTER2FMOBILE_GAMEBOY_KID
	const GOLDENRODPOKECOMCENTER2FMOBILE_LASS1
	const GOLDENRODPOKECOMCENTER2FMOBILE_POKEFAN_F
	const GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST
	const GOLDENRODPOKECOMCENTER2FMOBILE_SUPER_NERD
	const GOLDENRODPOKECOMCENTER2FMOBILE_YOUNGSTER
	const GOLDENRODPOKECOMCENTER2FMOBILE_TEACHER
	const GOLDENRODPOKECOMCENTER2FMOBILE_ROCKER
	const GOLDENRODPOKECOMCENTER2FMOBILE_GRAMPS
	const GOLDENRODPOKECOMCENTER2FMOBILE_LASS2
...
GoldenrodPokeCenter2F_GSBallTriggerLeft:
...
.gsball
	...
	moveperson GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST, $0, $7
	disappear GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST
	appear GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST
	playmusic MUSIC_SHOW_ME_AROUND
	applymovement GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST, MovementData_0x6105a
	...
	waitbutton
	closetext
	applymovement GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST, MovementData_0x61060
...
GoldenrodPokeCenter2F_GSBallTriggerRight:
	writebyte BATTLETOWERACTION_CHECKMOBILEEVENT
	special BattleTowerAction
	if_equal MOBILE_EVENT_OBJECT_GS_BALL, .gsball
	end
...
.gsball
	...
	appear GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST
	playmusic MUSIC_SHOW_ME_AROUND
	applymovement GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST, MovementData_0x61065
	spriteface PLAYER, UP
	opentext
	writetext UnknownText_0x622f0
	waitbutton
	...
	waitbutton
	closetext
	applymovement GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST, MovementData_0x6106c
	special RestartMapMusic
	disappear GOLDENRODPOKECOMCENTER2FMOBILE_LINK_RECEPTIONIST
	playsound SFX_EXIT_BUILDING
.cancel
...
.Warps:
	...
	warp_def $6, $0, 5, GOLDENROD_POKECOM_CENTER_2F_MOBILE
	warp_def $f, $0, 1, POKECENTER_2F
	warp_def $1f, $0, 3, GOLDENROD_POKECOM_CENTER_2F_MOBILE
	warp_def $1f, $1, 3, GOLDENROD_POKECOM_CENTER_2F_MOBILE

.XYTriggers:
	db 2
	xy_trigger 0, $f, $6, $0, GoldenrodPokeCenter2F_GSBallTriggerLeft, $0, $0
	xy_trigger 0, $f, $7, $0, GoldenrodPokeCenter2F_GSBallTriggerRight, $0, $0
