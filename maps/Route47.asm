...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 28, 39, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, REVIVE, 1, EVENT_ROUTE_47_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 32, 7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MYSTIC_WATER, 1, EVENT_ROUTE_47_MYSTIC_WATER
	person_event SPRITE_BALL_CUT_FRUIT, 20, 31, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, QUICK_CLAW, 1, EVENT_ROUTE_47_QUICK_CLAW
	person_event SPRITE_BALL_CUT_FRUIT, 6, 7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REPEL, 1, EVENT_ROUTE_47_MAX_REPEL
