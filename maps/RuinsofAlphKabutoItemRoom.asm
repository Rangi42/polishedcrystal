...
RuinsofAlphKabutoItemRoomLeppaBerry:
...
.PersonEvents:
	db 4
	person_event SPRITE_POKE_BALL, 6, 2, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, RuinsofAlphKabutoItemRoomOranBerry, EVENT_PICKED_UP_ORAN_BERRY_FROM_KABUTO_ITEM_ROOM
	person_event SPRITE_POKE_BALL, 6, 5, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, RuinsofAlphKabutoItemRoomLeppaBerry, EVENT_PICKED_UP_LEPPA_BERRY_FROM_KABUTO_ITEM_ROOM
