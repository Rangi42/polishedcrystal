Route34IlexForestGate_MapScriptHeader:
	...
	pokemon_event  9,  4, HERACROSS, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BLUE, Route34IlexForestGateHeracrossText, EVENT_ROUTE_34_ILEX_FOREST_GATE_TEACHER_BEHIND_COUNTER
