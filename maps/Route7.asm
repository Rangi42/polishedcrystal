...
.PersonEvents: db 3
	...
	person_event SPRITE_BALL_CUT_FRUIT, 1, 16, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MENTAL_HERB, 1, EVENT_ROUTE_7_MENTAL_HERB
