...
.PersonEvents: db 8
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 10, 9, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, 0, -1
	person_event SPRITE_BALL_CUT_FRUIT, 12, 29, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, HYPER_POTION, 1, EVENT_MOUNT_MORTAR_B1F_HYPER_POTION
	person_event SPRITE_BALL_CUT_FRUIT, 16, 4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, CARBOS, 1, EVENT_MOUNT_MORTAR_B1F_CARBOS
	person_event SPRITE_BALL_CUT_FRUIT, 24, 34, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PROTECTOR, 1, EVENT_MOUNT_MORTAR_B1F_PROTECTOR
	person_event SPRITE_BALL_CUT_FRUIT, 3, 32, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_ETHER, 1, EVENT_MOUNT_MORTAR_B1F_MAX_ETHER
	person_event SPRITE_BALL_CUT_FRUIT, 26, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PP_UP, 1, EVENT_MOUNT_MORTAR_B1F_PP_UP
