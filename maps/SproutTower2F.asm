...
.PersonEvents: db 3
	...
	person_event SPRITE_BALL_CUT_FRUIT, 1, 1, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_ACCURACY, 1, EVENT_SPROUT_TOWER2F_X_ACCURACY
