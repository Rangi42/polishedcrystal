...
.PersonEvents: db 13
	...
	person_event SPRITE_BALL_CUT_FRUIT, 26, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, STAR_PIECE, 1, EVENT_ROUTE_21_STAR_PIECE
