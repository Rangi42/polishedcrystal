...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 9, 30, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_29_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 11, 21, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_29_CUT_TREE_2
