...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 9, 30, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_29_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 11, 21, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_29_CUT_TREE_2
	person_event SPRITE_BALL_CUT_FRUIT, 2, 12, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_29, ORAN_BERRY, -1
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 48, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, POTION, 1, EVENT_ROUTE_29_POTION
