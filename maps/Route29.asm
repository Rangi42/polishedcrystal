...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 9, 30, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route29CutTree, EVENT_ROUTE_29_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 11, 21, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route29CutTree, EVENT_ROUTE_29_CUT_TREE_2
