...
.PersonEvents:
	db 1
	person_event SPRITE_POKE_BALL, 16, 8, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, IcePathB2FBlackthornSideNugget, EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_NUGGET
