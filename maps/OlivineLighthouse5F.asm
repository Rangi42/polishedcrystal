...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 13, 2, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, OlivineLighthouse5FTMEnergyBall, EVENT_OLIVINE_LIGHTHOUSE_5F_TM_ENERGY_BALL
