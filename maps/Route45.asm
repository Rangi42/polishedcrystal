...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 80, 20, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_45, LEPPA_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 51, 8, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, NUGGET, 1, EVENT_ROUTE_45_NUGGET
	person_event SPRITE_BALL_CUT_FRUIT, 66, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, REVIVE, 1, EVENT_ROUTE_45_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 20, 7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ELIXER, 1, EVENT_ROUTE_45_ELIXER
	person_event SPRITE_BALL_CUT_FRUIT, 32, 15, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_POTION, 1, EVENT_ROUTE_45_MAX_POTION
