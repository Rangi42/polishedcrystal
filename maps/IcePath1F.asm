...
.PersonEvents: db 5
	...
	person_event SPRITE_BALL_CUT_FRUIT, 7, 31, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, HM_WATERFALL, EVENT_GOT_HM06_WATERFALL
	person_event SPRITE_BALL_CUT_FRUIT, 23, 32, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PP_UP, 1, EVENT_ICE_PATH_1F_PP_UP
	person_event SPRITE_BALL_CUT_FRUIT, 9, 35, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PROTEIN, 1, EVENT_ICE_PATH_1F_PROTEIN
