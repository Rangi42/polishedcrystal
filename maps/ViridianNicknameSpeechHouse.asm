ViridianNicknameSpeechHouse_MapScriptHeader:
	...
	pokemon_event  5,  2, HOOTHOOT, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BROWN, HootyText, -1
	pokemon_event  6,  3, RATTATA, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PURPLE, RatteyText, -1
