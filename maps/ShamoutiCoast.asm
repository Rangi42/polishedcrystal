...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 11, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, STAR_PIECE, 1, EVENT_SHAMOUTI_COAST_STAR_PIECE
