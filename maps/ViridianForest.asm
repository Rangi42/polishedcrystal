...
.PersonEvents: db 8
	...
	person_event SPRITE_BALL_CUT_FRUIT, 31, 14, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DIRE_HIT, 1, EVENT_ROUTE_2_DIRE_HIT
	person_event SPRITE_BALL_CUT_FRUIT, 33, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_POTION, 1, EVENT_ROUTE_2_MAX_POTION
