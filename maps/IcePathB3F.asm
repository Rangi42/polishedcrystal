...
.PersonEvents: db 3
	...
	person_event SPRITE_BALL_CUT_FRUIT, 7, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, NEVERMELTICE, 1, EVENT_ICE_PATH_B3F_NEVERMELTICE
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 6, 6, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, smashrock, 0, -1
