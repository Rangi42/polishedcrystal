Route1617Gate_MapScriptHeader:
	...
	db 5 ; warp events
	warp_event 0, 5, 1, ROUTE_16_SOUTH
	warp_event 0, 6, 2, ROUTE_16_SOUTH
	warp_event 9, 5, 1, ROUTE_16_NORTHEAST
	warp_event 9, 6, 2, ROUTE_16_NORTHEAST
	warp_event 8, 8, 1, ROUTE_16_17_GATE_2F
	...
	db 1 ; object events
	object_event 5, 1, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_COMMAND, jumptextfaceplayer, UnknownText_0x73408, -1
