MrFujisHouse_MapScriptHeader:
	...
	pokemon_event  8,  4, PSYDUCK, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BROWN, MrFujisPsyduckText, -1
	pokemon_event  5,  5, NIDORINO, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PURPLE, MrFujisNidorinoText, -1
	pokemon_event  1,  3, PIDGEY, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_BROWN, MrFujisPidgeyText, -1
