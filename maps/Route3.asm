...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 14, 36, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, BIG_ROOT, 1, EVENT_ROUTE_3_BIG_ROOT
