...
.PersonEvents: db 5
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 9, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, DIVE_BALL, 1, EVENT_URAGA_CHANNEL_EAST_DIVE_BALL
	person_event SPRITE_BALL_CUT_FRUIT, 8, 20, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, EVIOLITE, 1, EVENT_URAGA_CHANNEL_EAST_EVIOLITE
