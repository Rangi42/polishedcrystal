SaffronBookSpeechHouse_MapScriptHeader:
	...
	db 2 ; warp events
	warp_event 2, 7, 18, SAFFRON_CITY
	warp_event 3, 7, 18, SAFFRON_CITY
	...
	db 2 ; object events
	object_event 2, 3, SPRITE_LASS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_COMMAND, jumptextfaceplayer, SaffronBookSpeechHouseLassText, -1
