...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 5, 37, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, Route35CoastBigPearl, EVENT_ROUTE_35_COAST_BIG_PEARL
