...
.PersonEvents: db 6
	...
	person_event SPRITE_BALL_CUT_FRUIT, 5, 37, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, BIG_PEARL, 1, EVENT_ROUTE_35_COAST_BIG_PEARL
