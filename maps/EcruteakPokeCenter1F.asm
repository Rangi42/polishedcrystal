EcruteakPokeCenter1F_MapScriptHeader:
	...
	db 3 ; warp events
	warp_event 5, 7, 6, ECRUTEAK_CITY
	warp_event 6, 7, 6, ECRUTEAK_CITY
	...
	object_event 8, 1, SPRITE_GYM_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_COMMAND, jumptextfaceplayer, EcruteakPokeCenter1FGymGuyText, -1
