...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 9, 40, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_YELLOW_FOREST_CUT_TREE
	person_event SPRITE_BALL_CUT_FRUIT, 16, 25, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_LEECH_LIFE, EVENT_YELLOW_FOREST_TM_LEECH_LIFE
	person_event SPRITE_BALL_CUT_FRUIT, 24, 32, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MIRACLE_SEED, 1, EVENT_YELLOW_FOREST_MIRACLE_SEED
	person_event SPRITE_BALL_CUT_FRUIT, 21, 11, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, BIG_ROOT, 1, EVENT_YELLOW_FOREST_BIG_ROOT
	person_event SPRITE_BALL_CUT_FRUIT, 24, 49, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, LEMONADE, 1, EVENT_YELLOW_FOREST_LEMONADE
