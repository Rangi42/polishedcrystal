...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 9, 40, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, YellowForestCutTree, EVENT_YELLOW_FOREST_CUT_TREE
	person_event SPRITE_POKE_BALL, 16, 25, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TMHMBALL, 0, YellowForestTMLeechLife, EVENT_YELLOW_FOREST_TM_LEECH_LIFE
	...
	person_event SPRITE_POKE_BALL, 16, 41, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_SCRIPT, 0, YellowForestSurfPikachuDoll, EVENT_DECO_SURFING_PIKACHU_DOLL
