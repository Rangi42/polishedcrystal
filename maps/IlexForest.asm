...
.PersonEvents: db 14
	...
	person_event SPRITE_BALL_CUT_FRUIT, 27, 10, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ILEX_FOREST_CUT_TREE
	...
	person_event SPRITE_BALL_CUT_FRUIT, 34, 22, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, REVIVE, 1, EVENT_ILEX_FOREST_REVIVE
	...
	person_event SPRITE_BALL_CUT_FRUIT, 19, 11, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_ATTACK, 1, EVENT_ILEX_FOREST_X_ATTACK
	person_event SPRITE_BALL_CUT_FRUIT, 17, 25, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ANTIDOTE, 1, EVENT_ILEX_FOREST_ANTIDOTE
	person_event SPRITE_BALL_CUT_FRUIT, 3, 29, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MULCH, 1, EVENT_ILEX_FOREST_MULCH
