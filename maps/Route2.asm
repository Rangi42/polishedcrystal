...
.PersonEvents:
	...
	person_event SPRITE_CUT_TREE, 8, 5, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route2CutTree, EVENT_ROUTE_2_CUT_TREE_1
	person_event SPRITE_CUT_TREE, 18, 15, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route2CutTree, EVENT_ROUTE_2_CUT_TREE_2
	person_event SPRITE_CUT_TREE, 40, 10, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route2CutTree, EVENT_ROUTE_2_CUT_TREE_3
	person_event SPRITE_CUT_TREE, 46, 12, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route2CutTree, EVENT_ROUTE_2_CUT_TREE_4
	person_event SPRITE_CUT_TREE, 50, 12, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route2CutTree, EVENT_ROUTE_2_CUT_TREE_5
