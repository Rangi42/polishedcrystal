...
.PersonEvents: db 4
	person_event SPRITE_GRAMPS, 3, 4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, (1 << MORN), 0, PERSONTYPE_MART, 0, MARTTYPE_STANDARD, MART_MT_MOON, -1
	person_event SPRITE_GRAMPS, 2, 1, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, (1 << DAY), 0, PERSONTYPE_MART, 0, MARTTYPE_STANDARD, MART_MT_MOON, -1
