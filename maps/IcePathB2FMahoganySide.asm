...
.PersonEvents: db 6
	...
	person_event SPRITE_BALL_CUT_FRUIT, 9, 8, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, FULL_HEAL, 1, EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_FULL_HEAL
	person_event SPRITE_BALL_CUT_FRUIT, 2, 0, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_POTION, 1, EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_MAX_POTION
