SnowtopMountainInside_MapScriptHeader:
	...
	def_object_events
	object_event 28, 14, SPRITE_KIMONO_GIRL, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, KimonoGirlAmiScript, -1
	...
	itemball_event 14,  6, HEAVY_BOOTS, 1, EVENT_SNOWTOP_MOUNTAIN_INSIDE_HEAVY_BOOTS
	itemball_event 31, 17, SNOWBALL, 1, EVENT_SNOWTOP_MOUNTAIN_INSIDE_SNOWBALL
