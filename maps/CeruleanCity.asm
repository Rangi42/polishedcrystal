CeruleanCity_MapScriptHeader:
	...
	warp_event 14, 23, CERULEAN_BIKE_SHOP, 1
	...
	bg_event 13, 17, BGEVENT_JUMPTEXT, CeruleanBubblerText
	...
	object_event 11, 17, SPRITE_FAT_GUY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanCityFisherScript, -1
