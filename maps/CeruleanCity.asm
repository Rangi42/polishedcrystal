CeruleanCity_MapScriptHeader:
	...
	object_event 20, 20, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, LOW(SLOWBRO), -1, -1, PAL_NPC_RED, OBJECTTYPE_POKEMON, HIGH(SLOWBRO) << MON_EXTSPECIES | GALARIAN_FORM, CeruleanCitySlowbroText, -1
