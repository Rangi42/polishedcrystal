WhirlIslandLugiaChamber_MapScriptHeader:
	...
	def_object_events
	object_event  9,  5, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LUGIA, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, NO_FORM, Lugia, EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_LUGIA
