AzaleaTown_MapScriptHeader:
	...
	object_event  8, 17, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(SLOWPOKE), -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, HIGH(SLOWPOKE) << MON_EXTSPECIES_F, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event 18,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(SLOWPOKE), -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, HIGH(SLOWPOKE) << MON_EXTSPECIES_F, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event 29,  9, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(SLOWPOKE), -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, HIGH(SLOWPOKE) << MON_EXTSPECIES_F, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event 15, 15, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, LOW(SLOWPOKE), -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, HIGH(SLOWPOKE) << MON_EXTSPECIES_F, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
