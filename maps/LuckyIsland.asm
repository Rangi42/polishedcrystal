LuckyIsland_MapScriptHeader:
	...
	def_object_events
	object_event 27, 18, SPRITE_BALL_CUT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_ENV_RED, OBJECTTYPE_SCRIPT, 0, LuckyIslandLuckyEgg, EVENT_LUCKY_ISLAND_LUCKY_EGG
	...
	fruittree_event 25, 16, FRUITTREE_LUCKY_ISLAND, JABOCA_BERRY, PAL_NPC_ENV_YELLOW, MORN, EVENT_LUCKY_ISLAND_CIVILIANS
