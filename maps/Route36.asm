Route36_MapScriptHeader:
	...
	warp_event 43,  8, ROUTE_36_VIOLET_GATE, 1
	warp_event 43,  9, ROUTE_36_VIOLET_GATE, 2
	...
	bg_event 41,  7, BGEVENT_JUMPTEXT, Route36SignText
	bg_event  7,  7, BGEVENT_JUMPTEXT, Route36TrainerTips1Text
	bg_event 35,  4, BGEVENT_JUMPTEXT, Route36AdvancedTips1Text
	...
	object_event 35,  6, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_WANDER, 1, 1, -1, 0, OBJECTTYPE_SCRIPT, 0, ArthurScript, EVENT_ROUTE_36_ARTHUR_OF_THURSDAY
	...
	object_event 39,  9, SPRITE_CUTE_GIRL, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 2, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route36LassScript, -1
	object_event 30,  9, SPRITE_FAT_GUY, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, Route36RockSmashGuyScript, -1
	fruittree_event  7,  4, FRUITTREE_ROUTE_36, RAWST_BERRY, PAL_NPC_TEAL
	object_event 32,  5, SPRITE_SCHOOLGIRL, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerSchoolgirlMolly, -1
