...
RuinsofAlphHoOhItemRoomLifeOrb:
	itemball LIFE_ORB
...
.PersonEvents:
	...
	person_event SPRITE_BALL_CUT_FRUIT, 4, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_ITEMBALL, 0, RuinsofAlphHoOhItemRoomLifeOrb, EVENT_PICKED_UP_LIFE_ORB_FROM_HO_OH_ITEM_ROOM
