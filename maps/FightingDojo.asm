FightingDojo_MapScriptHeader:
	...
	db 7 ; object events
	object_event 0, 1, SPRITE_DOLL_1, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, RematchRed0Script, EVENT_REMATCH_GYM_LEADER_1
	object_event 0, 2, SPRITE_DOLL_2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, RematchGreen1Script, EVENT_REMATCH_GYM_LEADER_2
	object_event 0, 3, SPRITE_DOLL_2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, RematchBlue1Script, EVENT_REMATCH_GYM_LEADER_3
	object_event 0, 4, SPRITE_CONSOLE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, RematchBlue2Script, EVENT_REMATCH_GYM_LEADER_4
	object_event 0, 5, SPRITE_DOLL_2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, RematchBrown1Script, EVENT_REMATCH_GYM_LEADER_5
	object_event 0, 6, SPRITE_CONSOLE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, RematchBrown2Script, EVENT_REMATCH_GYM_LEADER_6
	object_event 4, 4, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, BlackBeltScript_0x189b61, -1
...
.SundayMorningAndDay
	...
	rematch_right REMATCH_GREEN_2, SPRITE_DOLL_2, SPRITE_ERIKA
	return
.SundayNight
	rematch REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_SABRINA, 4, 6, DOWN
	return
...
.TuesdayNight
	...
	iffalse .NoLorelei
	rematch REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_LORELEI, 4, 6, DOWN
.NoLorelei
	return
...
.WednesdayDay
	...
	rematch REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_MISTY, 5, 2, RIGHT
	rematch_right REMATCH_BLUE_3, SPRITE_CONSOLE, SPRITE_BLUE
	return
.WednesdayMorning
	rematch_left REMATCH_BROWN_2, SPRITE_DOLL_2, SPRITE_BROCK
	rematch_right REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_MISTY
	return
.WednesdayNight
...
.ThursdayDay
	...
	iffalse .NoPalmer
	rematch REMATCH_GREEN_2, SPRITE_DOLL_2, SPRITE_PALMER, 6, 3, DOWN
.NoPalmer
	return
.ThursdayMorning
	rematch REMATCH_GREEN_2, SPRITE_DOLL_2, SPRITE_BUGSY, 6, 1, DOWN
	return
.ThursdayNight
...
.FridayDay
	...
	iffalse .NoYellow
	rematch REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_YELLOW, 6, 6, DOWN
.NoYellow
	return
.FridayMorning
	rematch REMATCH_BROWN_2, SPRITE_DOLL_2, SPRITE_SURGE, 7, 6, DOWN
	return
.FridayNight
	rematch REMATCH_BLUE_2, SPRITE_DOLL_2, SPRITE_CLAIR, 6, 2, RIGHT
	return
...
.SaturdayDay
	...
	rematch_right REMATCH_BROWN_2, SPRITE_DOLL_2, SPRITE_CHUCK
	return
.SaturdayMorning
	rematch_left REMATCH_RED_1, SPRITE_DOLL_1, SPRITE_WHITNEY
	return
