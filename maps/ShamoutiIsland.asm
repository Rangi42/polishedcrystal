ShamoutiIsland_MapScriptHeader:
	...
	def_object_events
	object_event 16,  8, SPRITE_MON_ICON, SPRITEMOVEDATA_STILL, 0, VILEPLUME, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, VILEPLUME, ShamoutiIslandVileplumeScript, EVENT_SHAMOUTI_ISLAND_VILEPLUME
