...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 5, 9, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_44, ASPEAR_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 8, 30, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REVIVE, 1, EVENT_ROUTE_44_MAX_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 4, 45, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ULTRA_BALL, 1, EVENT_ROUTE_44_ULTRA_BALL
	person_event SPRITE_BALL_CUT_FRUIT, 9, 14, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REPEL, 1, EVENT_ROUTE_44_MAX_REPEL
