...
.PersonEvents: db 13
	...
	person_event SPRITE_BALL_CUT_FRUIT, 68, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, CALCIUM, 1, EVENT_ROUTE_12_CALCIUM
	person_event SPRITE_BALL_CUT_FRUIT, 82, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, NUGGET, 1, EVENT_ROUTE_12_NUGGET
	person_event SPRITE_BALL_CUT_FRUIT, 71, 6, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_12_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 79, 9, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_12_CUT_TREE_2
