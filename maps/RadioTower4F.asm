...
.PersonEvents: db 7
	...
	person_event SPRITE_FISHER, 4, 6, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_JUMPTEXTFP, 0, UnknownText_0x5ec12, EVENT_RADIO_TOWER_CIVILIANS_AFTER
