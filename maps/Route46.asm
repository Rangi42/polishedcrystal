...
.PersonEvents: db 7
	...
	person_event SPRITE_BALL_CUT_FRUIT, 5, 7, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_46_1, CHERI_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 6, 8, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_46_2, CHESTO_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 15, 1, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, X_SPEED, 1, EVENT_ROUTE_46_X_SPEED
