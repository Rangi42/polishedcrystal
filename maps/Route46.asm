...
.PersonEvents: db 7
	...
	person_event SPRITE_BALL_CUT_FRUIT, 5, 7, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_FRUITTREE, 0, FRUITTREE_ROUTE_46_1, CHERI_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 6, 8, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_FRUITTREE, 0, FRUITTREE_ROUTE_46_2, CHESTO_BERRY, -1
