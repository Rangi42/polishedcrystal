KrissHouse1F_MapScriptHeader:
	...
	object_event  6,  3, SPRITE_MOM, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, (1 << EVE), 0, OBJECTTYPE_SCRIPT, 0, MomScript, EVENT_KRISS_HOUSE_MOM_2
	...
	object_event  6,  4, SPRITE_MATRON, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, NeighborScript, EVENT_KRISS_HOUSE_1F_NEIGHBOR
