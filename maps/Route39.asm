Route39_MapScriptHeader:
	...
	object_event 11, 19, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, PERSONTYPE_GENERICTRAINER, 4, GenericTrainerPokefanfRuth, -1
	object_event  3, 12, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MILTANK, -1, -1, PAL_NPC_RED, PERSONTYPE_POKEMON, MILTANK, Route39MiltankText, -1
	object_event  6, 11, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MILTANK, -1, -1, PAL_NPC_RED, PERSONTYPE_POKEMON, MILTANK, Route39MiltankText, -1
	object_event  4, 15, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MILTANK, -1, -1, PAL_NPC_RED, PERSONTYPE_POKEMON, MILTANK, Route39MiltankText, -1
	object_event  8, 13, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MILTANK, -1, -1, PAL_NPC_RED, PERSONTYPE_POKEMON, MILTANK, Route39MiltankText, -1
	...
	object_event  4, 22, SPRITE_POKEFAN_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, PokefanFScript_0x1a5bbe, -1
