Route39_MapScriptHeader:
	...
	pokemon_event  3, 26, MILTANK, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PINK, Route39MiltankText, -1
	pokemon_event  6, 25, MILTANK, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PINK, Route39MiltankText, -1
	pokemon_event  4, 29, MILTANK, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PINK, Route39MiltankText, -1
	pokemon_event  8, 27, MILTANK, SPRITEMOVEDATA_POKEMON, -1, MON_PAL_TAN_PINK, Route39MiltankText, -1
