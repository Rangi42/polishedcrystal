...
.PersonEvents:
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 26, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TMHMBALL, 0, Route9TMFlashCannon, EVENT_ROUTE_9_TM_FLASH_CANNON
	person_event SPRITE_BALL_CUT_FRUIT, 8, 5, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route9CutTree, EVENT_ROUTE_9_CUT_TREE
