...
.PersonEvents: db 9
	...
	person_event SPRITE_BALL_CUT_FRUIT, 2, 26, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_POTION, 1, EVENT_ROUTE_9_MAX_POTION
	person_event SPRITE_BALL_CUT_FRUIT, 2, 45, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_FLASH_CANNON, EVENT_ROUTE_9_TM_FLASH_CANNON
	person_event SPRITE_BALL_CUT_FRUIT, 8, 4, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_9_CUT_TREE
