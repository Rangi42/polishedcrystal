...
.PersonEvents:
	...
	person_event SPRITE_BUG_MANIAC, 21, 17, SPRITEMOVEDATA_WANDER, 3, 3, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, BugManiacScript_0x1a9a90, -1
