ViridianCity_MapScriptHeader:
	...
	warp_event 21, 5, 1, VIRIDIAN_NICKNAME_SPEECH_HOUSE
	warp_event 23, 15, 1, TRAINER_HOUSE_1F
	warp_event 29, 19, 2, VIRIDIAN_MART
	warp_event 23, 25, 1, VIRIDIAN_POKECENTER_1F
	warp_event 28, 33, 1, ROUTE_1_VIRIDIAN_GATE
	warp_event 29, 33, 2, ROUTE_1_VIRIDIAN_GATE
	warp_event 21, 9, 1, VIRIDIAN_SCHOOL_HOUSE
	...
	object_event 32, 8, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, GrampsScript_0x1a9a61, EVENT_BLUE_IN_CINNABAR
	object_event 30, 8, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, GrampsScript_0x1a9a61, EVENT_VIRIDIAN_GYM_BLUE
	object_event 6, 23, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, FisherScript_0x1a9a75, -1
	object_event 17, 21, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 3, 3, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_COMMAND, jumptextfaceplayer, UnknownText_0x1a9daa, -1
	object_event 31, 23, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_COMMAND, jumptextfaceplayer, ViridianCityYoungsterText, -1
