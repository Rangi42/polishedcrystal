...
.PersonEvents: db 8
	...
	person_event SPRITE_BALL_CUT_FRUIT, 4, 14, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_VIRIDIAN_CITY_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 22, 8, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_VIRIDIAN_CITY_CUT_TREE_2
