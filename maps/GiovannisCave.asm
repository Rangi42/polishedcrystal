...
.PersonEvents:
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 6, 3, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, GiovannisCaveRock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 2, 6, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, GiovannisCaveRock, -1
