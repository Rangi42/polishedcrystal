...
.PersonEvents: db 5
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 6, 13, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 2, 16, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, smashrock, -1
