...
.PersonEvents: db 8
	person_event SPRITE_VALERIE, 3, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_JUMPTEXTFP, 0, ValeriesHouseValerieText, EVENT_VALERIE_ECRUTEAK_CITY
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseRedFairyBookText, EVENT_RED_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseBlueFairyBookText, EVENT_BLUE_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseGreenFairyBookText, EVENT_GREEN_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseBrownFairyBookText, EVENT_BROWN_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PURPLE, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseVioletFairyBookText, EVENT_VIOLET_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_JUMPTEXT, 0, ValeriesHousePinkFairyBookText, EVENT_PINK_FAIRY_BOOK
	person_event SPRITE_BOOK_UNOWN_R, 3, 3, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_JUMPTEXT, 0, ValeriesHouseYellowFairyBookText, EVENT_YELLOW_FAIRY_BOOK
