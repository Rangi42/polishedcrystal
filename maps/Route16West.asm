...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 7, 3, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_16_WEST_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 2, 57, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_16_WEST_CUT_TREE_2
