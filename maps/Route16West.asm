...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 14, 42, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, METRONOME_I, 1, EVENT_ROUTE_16_WEST_METRONOME
	person_event SPRITE_BALL_CUT_FRUIT, 2, 51, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, PP_UP, 1, EVENT_ROUTE_16_WEST_PP_UP
	person_event SPRITE_BALL_CUT_FRUIT, 2, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, MAX_REVIVE, 1, EVENT_ROUTE_16_WEST_MAX_REVIVE
	person_event SPRITE_BALL_CUT_FRUIT, 7, 3, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_16_WEST_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 2, 57, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_16_WEST_CUT_TREE_2
