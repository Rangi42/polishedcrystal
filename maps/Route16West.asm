const_value set 2
	const ROUTE16WEST_LASS1
	const ROUTE16WEST_LASS2
	const ROUTE16WEST_COSPLAYER
	const ROUTE16WEST_COOLTRAINER_F
	const ROUTE16WEST_BEAUTY
	const ROUTE16WEST_POKE_BALL1
	const ROUTE16WEST_POKE_BALL2
	const ROUTE16WEST_POKE_BALL3
	const ROUTE16WEST_CUT_TREE1
	const ROUTE16WEST_CUT_TREE2
