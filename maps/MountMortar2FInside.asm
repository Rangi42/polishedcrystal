...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 17, 19, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, MountMortar2FInsideTMAerialAce, EVENT_MOUNT_MORTAR_2F_INSIDE_TM_AERIAL_ACE
