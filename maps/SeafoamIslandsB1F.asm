SeafoamIslandsB1F_MapScriptHeader:
	...
	strengthboulder_event 30, 9,  -1, PAL_NPC_COPY_BG_BROWN
	strengthboulder_event 31, 9,  -1, PAL_NPC_COPY_BG_BROWN
	strengthboulder_event 32, 10, -1, PAL_NPC_COPY_BG_BROWN
	strengthboulder_event 12, 8,  -1, PAL_NPC_COPY_BG_BROWN
	strengthboulder_event  7, 11, -1, PAL_NPC_COPY_BG_BROWN
	strengthboulder_event 13, 15, -1, PAL_NPC_COPY_BG_BROWN
