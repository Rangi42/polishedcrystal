...
.PersonEvents: db 10
	...
	person_event SPRITE_BALL_CUT_FRUIT, 25, 4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, COIN_CASE, 1, EVENT_WAREHOUSE_ENTRANCE_COIN_CASE
