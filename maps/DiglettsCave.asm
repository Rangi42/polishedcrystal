...
.PersonEvents: db 9
	...
	person_event SPRITE_BALL_CUT_FRUIT, 28, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, RARE_BONE, 1, EVENT_DIGLETTS_CAVE_RARE_BONE
