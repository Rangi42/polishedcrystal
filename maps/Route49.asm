...
.PersonEvents: db 11
	...
	person_event SPRITE_BALL_CUT_FRUIT, 6, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, WHITE_HERB, 1, EVENT_ROUTE_49_WHITE_HERB
	person_event SPRITE_BALL_CUT_FRUIT, 20, 18, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, CALCIUM, 1, EVENT_ROUTE_49_CALCIUM
	person_event SPRITE_BALL_CUT_FRUIT, 14, 29, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_49, LUM_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 12, 26, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_49_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 15, 20, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_49_CUT_TREE_2
