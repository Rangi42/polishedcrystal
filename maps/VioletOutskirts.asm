VioletOutskirts_MapScriptHeader:
	...
	def_object_events
	object_event 16, -2, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, SUICUNE, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, SUICUNE, ObjectEvent, EVENT_SAW_SUICUNE_ON_ROUTE_42
