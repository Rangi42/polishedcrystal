VioletOutskirts_MapScriptHeader:
	...
	const VIOLETOUTSKIRTS_DUMMY_ROUTE42_SUICUNE
	const VIOLETOUTSKIRTS_DUMMY_ROUTE42_FRUITTREE_1
	const VIOLETOUTSKIRTS_DUMMY_ROUTE42_FRUITTREE_2
	const VIOLETOUTSKIRTS_DUMMY_ROUTE42_FRUITTREE_3
