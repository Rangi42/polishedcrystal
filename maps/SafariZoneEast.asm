SafariZoneEast_MapScriptHeader:
	...
	db 5 ; warp events
	warp_event 2, 24, 3, SAFARI_ZONE_HUB
	warp_event 2, 25, 4, SAFARI_ZONE_HUB
	warp_event 2, 6, 1, SAFARI_ZONE_NORTH
	warp_event 2, 7, 2, SAFARI_ZONE_NORTH
	warp_event 27, 11, 1, SAFARI_ZONE_EAST_REST_HOUSE
