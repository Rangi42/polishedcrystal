...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 9, 25, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_ITEMBALL, 0, RockTunnel2FTMThunderWave, EVENT_ROCK_TUNNEL_2F_TM_THUNDER_WAVE
