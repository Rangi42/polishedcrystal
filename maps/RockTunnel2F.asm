...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 23, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, THUNDERSTONE, 1, EVENT_ROCK_TUNNEL_2F_THUNDERSTONE
	person_event SPRITE_BALL_CUT_FRUIT, 9, 25, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_THUNDER_WAVE, EVENT_ROCK_TUNNEL_2F_TM_THUNDER_WAVE
	person_event SPRITE_BALL_CUT_FRUIT, 3, 21, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ELECTIRIZER, 1, EVENT_ROCK_TUNNEL_2F_ELECTIRIZER
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 2, 12, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 3, 12, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 3, 13, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, strengthboulder, -1
