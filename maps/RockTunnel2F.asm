...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 9, 25, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, RockTunnel2FTMSteelWing, EVENT_ROCK_TUNNEL_2F_TM_STEEL_WING
