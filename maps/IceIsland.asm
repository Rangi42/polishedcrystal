...
.PersonEvents: db 1
	person_event SPRITE_BALL_CUT_FRUIT, 6, 19, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, ICY_ROCK, 1, EVENT_ICE_ISLAND_ICY_ROCK
