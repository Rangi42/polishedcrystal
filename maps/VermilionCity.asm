VermilionCity_MapScriptHeader:
	...
	db 14 ; warp events
	warp_event 5, 5, 1, VERMILION_HOUSE_FISHING_SPEECH_HOUSE
	warp_event 9, 5, 1, VERMILION_POKECENTER_1F
	warp_event 7, 17, 1, POKEMON_FAN_CLUB
	warp_event 13, 17, 1, VERMILION_MAGNET_TRAIN_SPEECH_HOUSE
	warp_event 21, 17, 2, VERMILION_MART
	warp_event 21, 21, 1, VERMILION_HOUSE_DIGLETTS_CAVE_SPEECH_HOUSE
	warp_event 10, 23, 1, VERMILION_GYM
	warp_event 17, 35, 1, VERMILION_PORT_PASSAGE
	warp_event 18, 35, 2, VERMILION_PORT_PASSAGE
	warp_event 36, 17, 1, DIGLETTS_CAVE
	warp_event 29, 35, 1, SEAGALLOP_FERRY_VERMILION_GATE
	warp_event 30, 35, 1, SEAGALLOP_FERRY_VERMILION_GATE
	warp_event 13, 5, 1, VERMILION_POLLUTION_SPEECH_HOUSE
	warp_event 19, 5, 1, VERMILION_S_S_ANNE_SPEECH_HOUSE
	...
	object_event 19, 28, SPRITE_VERMILION_LAWRENCE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_LAWRENCE_VERMILION_CITY
	object_event 18, 13, SPRITE_VERMILION_LAWRENCE, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_COMMAND, jumptextfaceplayer, UnknownText_0x1aaa15, -1
