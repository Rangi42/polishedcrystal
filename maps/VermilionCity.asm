...
.PersonEvents: db 15
	...
	person_event SPRITE_BALL_CUT_FRUIT, 23, 13, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_VERMILION_CITY_CUT_TREE
	...
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 14, 26, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 12, 23, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 7, 28, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, smashrock, -1
	person_event SPRITE_ROCK_BOULDER_FOSSIL, 9, 29, SPRITEMOVEDATA_SMASHABLE_ROCK, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, smashrock, -1
