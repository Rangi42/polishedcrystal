...
.PersonEvents: db 4
	...
	person_event SPRITE_BALL_CUT_FRUIT, 16, 15, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_POKEBALL, PLAYEREVENT_ITEMBALL, WATER_STONE, 1, EVENT_SEAFOAM_ISLANDS_B2F_WATER_STONE
