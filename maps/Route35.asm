...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 6, 17, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_JUMPSTD, 0, cuttree, EVENT_ROUTE_35_CUT_TREE
	person_event SPRITE_BALL_CUT_FRUIT, 25, 2, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_FRUITTREE, 0, FRUITTREE_ROUTE_35, LEPPA_BERRY, -1
