...
.PersonEvents: db 12
	...
	person_event SPRITE_BALL_CUT_FRUIT, 6, 17, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_ROUTE_35_CUT_TREE
	person_event SPRITE_BALL_CUT_FRUIT, 25, 2, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, fruittree, FRUITTREE_ROUTE_35, LEPPA_BERRY, -1
	person_event SPRITE_BALL_CUT_FRUIT, 16, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_POKEBALL, PLAYEREVENT_TMHMBALL, TM_HONE_CLAWS, EVENT_ROUTE_35_TM_HONE_CLAWS
