...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 16, 13, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_ITEMBALL, 0, Route35TMHoneClaws, EVENT_ROUTE_35_TM_HONE_CLAWS
