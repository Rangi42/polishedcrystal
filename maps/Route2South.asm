const_value set 2
	const ROUTE2SOUTH_BUG_MANIAC1
	const ROUTE2SOUTH_BUG_MANIAC2
	const ROUTE2SOUTH_POKE_BALL
	const ROUTE2SOUTH_CUT_TREE1
	const ROUTE2SOUTH_CUT_TREE2
	const ROUTE2SOUTH_CUT_TREE3
	const ROUTE2SOUTH_CUT_TREE4
