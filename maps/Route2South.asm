...
.PersonEvents: db 7
	...
	person_event SPRITE_BALL_CUT_FRUIT, 16, 11, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_2_CUT_TREE_3
	person_event SPRITE_BALL_CUT_FRUIT, 24, 12, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_2_CUT_TREE_4
	person_event SPRITE_BALL_CUT_FRUIT, 30, 12, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, EVENT_ROUTE_2_CUT_TREE_5
