...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 4, 8, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TMHMBALL, 0, VictoryRoad2FTMEarthquake, EVENT_VICTORY_ROAD_2F_TM_EARTHQUAKE
	person_event SPRITE_POKE_BALL, 5, 20, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, VictoryRoad2FFullRestore, EVENT_VICTORY_ROAD_2F_FULL_RESTORE
	person_event SPRITE_POKE_BALL, 14, 9, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, VictoryRoad2FHPUp, EVENT_VICTORY_ROAD_2F_HP_UP
