...
.PersonEvents: db 2
	person_event SPRITE_BALL_CUT_FRUIT, 18, 31, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_SILVER_CAVE_OUTSIDE_CUT_TREE_1
	person_event SPRITE_BALL_CUT_FRUIT, 17, 34, SPRITEMOVEDATA_CUTTABLE_TREE, 0, 0, -1, -1, 0, PERSONTYPE_COMMAND, jumpstd, cuttree, 0, EVENT_SILVER_CAVE_OUTSIDE_CUT_TREE_2
