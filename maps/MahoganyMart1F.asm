MahoganyMart1F_MapScriptHeader:
	...
	object_event  6,  6, SPRITE_VETERAN_F, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MahoganyMart1FVeteranFScript, EVENT_MAHOGANY_MART_OWNERS
