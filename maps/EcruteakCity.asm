EcruteakCity_MapScriptHeader:
	...
	object_event 12, 11, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, SMEARGLE, -1, (1 << MORN) | (1 << DAY), PAL_NPC_BROWN, PERSONTYPE_POKEMON, SMEARGLE, EcruteakCitySmeargleText, -1
