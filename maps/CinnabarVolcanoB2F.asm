CinnabarVolcanoB2F_MapScriptHeader:
	...
	def_object_events
	object_event 18, 22, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MOLTRES, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, MOLTRES, CinnabarVolcanoMoltres, EVENT_CINNABAR_VOLCANO_MOLTRES
