CeruleanCaveB1F_MapScriptHeader:
	...
	def_object_events
	object_event  7, 13, SPRITE_MON_ICON, SPRITEMOVEDATA_POKEMON, 0, MEWTWO, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, MEWTWO, CeruleanCaveMewtwo, EVENT_CERULEAN_CAVE_MEWTWO
