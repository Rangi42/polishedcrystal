...
; https://hax.iimarckus.org/topic/6777/3/
	...
	music_header Music_LyraDepartureHGSS
	channel_count 4
	...
	music_label Music_LyraDepartureHGSS_Ch1
	tempo 184
	duty_cycle 1
	note_type 12, 8, 5
	rest 4
	...
	music_label Music_LyraDepartureHGSS_Ch2
	duty_cycle 2
	note_type 12, 11, 4
	rest 4
	sound_jump Music_LyraEncounterHGSS_Ch2_loop

	music_label Music_LyraDepartureHGSS_Ch3
	note_type 12, 1, 5
	volume_envelope 1, 0
	rest 4
	sound_jump Music_LyraEncounterHGSS_Ch3_loop

	music_label Music_LyraDepartureHGSS_Ch4
	toggle_noise 3
	drum_speed 6
	drum_note 1, 2
	drum_note 1, 2
