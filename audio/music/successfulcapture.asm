	...
	music_label Music_SuccessfulCapture_Ch2
	vibrato 18, 2, 4
	note_type 12, 12, 1
	duty_cycle 2
	sound_jump Music_SuccessfulCapture_branch_f4585

	music_label Music_SuccessfulCapture_Ch3
	note_type 12, 2, 5
