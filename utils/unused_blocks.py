...
tileset_maps = {
'johto_traditional': 'CherrygroveBay CherrygroveCity EcruteakCity MagnetTunnelEast MahoganyTown NewBarkTown Route26 Route27 Route29 Route30 Route31 Route32 Route32Coast Route35 Route36 Route37 Route42 Route44 VioletCity VioletOutskirts',
...
'kanto': 'CinnabarIsland FuchsiaCity LavenderTown MountMoonSquare PalletTown PewterCity Route1 Route2North Route2South Route3 Route6 Route8 Route10South Route11 Route12North Route16North Route16West Route18East Route19 Route20 Route21 Route22 Route22Past UragaChannelWest VermilionCity ViridianCity',
'kanto_north': 'CeruleanCape CeruleanCity Route4 Route5 Route9 Route10North Route24 Route25',
'kanto_urban': 'CeladonCity Route7 Route16East SaffronCity',
