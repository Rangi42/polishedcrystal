...
; ================
	...
	db 73, DEWGONG, FOCUS_BAND, PERFECT_DVS
		db PROTECT
		db TOXIC
		db SURF
		db ICE_BEAM

	db 73, CLOYSTER, KINGS_ROCK, PERFECT_DVS
		db SPIKES
		db SURF
		db EXPLOSION
		db ICICLE_CRASH

	db 72, WEAVILE, KINGS_ROCK, PERFECT_DVS
		db SWORDS_DANCE
		db ICICLE_CRASH
		db SLASH
		db CRUNCH
	...
	db 73, LAPRAS, LEFTOVERS, PERFECT_DVS
		db SING
		db TOXIC
		db ICE_BEAM
		db THUNDERBOLT

	db 75, MAMOSWINE, HARD_STONE, PERFECT_DVS
		db EARTHQUAKE
		db AVALANCHE
		db STONE_EDGE
		db ANCIENTPOWER
...
; ================
	...
	db 67, XATU, TWISTEDSPOON, PERFECT_DVS
		db AIR_SLASH
		db FUTURE_SIGHT
		db CONFUSE_RAY
		db PSYCHIC_M

	db 68, JYNX, BRIGHTPOWDER, PERFECT_DVS
		db NASTY_PLOT
		db DRAIN_KISS
		db ICE_BEAM
		db PSYCHIC_M

	db 68, EXEGGUTOR, MIRACLE_SEED, PERFECT_DVS
		db REFLECT
		db GIGA_DRAIN
		db SLEEP_POWDER
		db PSYCHIC_M
	...
	db 69, SLOWBRO, WISE_GLASSES, PERFECT_DVS
		db SURF
		db PSYCHIC_M
		db THUNDER_WAVE
		db REST

	db 70, XATU, LEFTOVERS, PERFECT_DVS
		db QUICK_ATTACK
		db FUTURE_SIGHT
		db CONFUSE_RAY
		db PSYCHIC_M
...
; ================
	...
	db 74, ELECTIVIRE, BLACK_BELT, PERFECT_DVS
		db CROSS_CHOP
		db THUNDERPUNCH
		db LIGHT_SCREEN
		db WILD_CHARGE

	db 72, ELECTRODE, SILK_SCARF, PERFECT_DVS
		db REFLECT
		db DOUBLE_TEAM
		db SWIFT
		db EXPLOSION
	...
	db 73, LANTURN, LEFTOVERS, PERFECT_DVS
		db SURF
		db ICE_BEAM
		db THUNDERBOLT
		db RECOVER
	...
	db 75, RAICHU, BRIGHTPOWDER, PERFECT_DVS
		db THUNDER_WAVE
		db NASTY_PLOT
		db THUNDERBOLT
		db FOCUS_BLAST
...
; ================
	...
	db 72, SUNFLORA, BRIGHTPOWDER, PERFECT_DVS
		db SUNNY_DAY
		db LEECH_SEED
		db GIGA_DRAIN
		db FIRE_BLAST

	db 73, TANGROWTH, LEFTOVERS, PERFECT_DVS
		db EARTHQUAKE
		db SWORDS_DANCE
		db GIGA_DRAIN
		db SLEEP_POWDER

	db 73, VICTREEBEL, POISON_BARB, PERFECT_DVS
		db SWORDS_DANCE
		db GIGA_DRAIN
		db SLUDGE_BOMB
		db SEED_BOMB

	db 74, LEAFEON, MIRACLE_SEED, PERFECT_DVS
		db SWORDS_DANCE
		db SEED_BOMB
		db IRON_TAIL
		db X_SCISSOR

	db 74, VILEPLUME, QUICK_CLAW, PERFECT_DVS
		db PETAL_DANCE
		db MOONLIGHT
		db LEECH_SEED
		db TOXIC
...
; ================
	...
	db 96, LAPRAS, LEFTOVERS, PERFECT_DVS, HIDDEN_ABILITY | MODEST, FEMALE
		db ICE_BEAM
		db THUNDERBOLT
		db REST
		db SLEEP_TALK

	db 100, VENUSAUR, MIRACLE_SEED, PERFECT_DVS, HIDDEN_ABILITY | HASTY, FEMALE
		db GROWTH
		db GIGA_DRAIN
		db SLUDGE_BOMB
		db SLEEP_POWDER
	...
	db 95, SYLVEON, BRIGHTPOWDER, PERFECT_DVS, HIDDEN_ABILITY | MODEST, FEMALE
		db MOONBLAST
		db LIGHT_SCREEN
		db CALM_MIND
		db HYPER_VOICE

	db 98, AERODACTYL, MUSCLE_BAND, PERFECT_DVS, HIDDEN_ABILITY | ADAMANT, FEMALE
		db HONE_CLAWS
		db CRUNCH
		db EARTHQUAKE
		db ROCK_SLIDE

	db 99, MEW, WISE_GLASSES, PERFECT_DVS, HIDDEN_ABILITY | MODEST, FEMALE
		db NASTY_PLOT
		db PSYCHIC_M
		db DARK_PULSE
		db GIGA_DRAIN
...
; ================
	...
	; party
	db 5, RATTATA, ORAN_BERRY, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
...
; ================
	...
	; party
	db 15, RATTATA, ORAN_BERRY, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
...
; ================
	...
	; YOUNGSTER
	db "Joey@"
	db TRAINERTYPE_ITEM | TRAINERTYPE_MOVES | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY

	; party

	db 25, RATICATE, ORAN_BERRY, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
		db LEER
		db QUICK_ATTACK
		db HYPER_FANG
		db SCARY_FACE
...
; ================
	...
	db 30, RATICATE, SITRUS_BERRY, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
		db LEER
		db QUICK_ATTACK
		db HYPER_FANG
		db PURSUIT
...
; ================
	...
	db 40, RATICATE, SITRUS_BERRY, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
		db HYPER_BEAM
		db QUICK_ATTACK
		db HYPER_FANG
		db PURSUIT
