...
; ================
	...
	db 23, NOCTOWL, NO_ITEM, 64, ABILITY_1 | QUIRKY, MALE
		db HYPNOSIS
		db PECK
		db CONFUSION
		db SHADOW_BALL
...
; ================
	...
	db 29, RATTATA, ORAN_BERRY, 92, HIDDEN_ABILITY | ADAMANT, FEMALE, "Ratty@"
		db LEER
		db QUICK_ATTACK
		db HYPER_FANG
		db FOCUS_ENERGY

	db 27, BUTTERFREE, ORAN_BERRY, 92, HIDDEN_ABILITY | MODEST, FEMALE, "Kitty@"
		db CONFUSION
		db SLEEP_POWDER
		db POISONPOWDER
		db STUN_SPORE

	db 30, DODUO, ORAN_BERRY, 92, HIDDEN_ABILITY | HASTY, FEMALE, "Dody@"
		db PECK
		db TRI_ATTACK
		db RETURN
		db MUD_SLAP

	db 29, GRAVELER, ORAN_BERRY, 92, HIDDEN_ABILITY | ADAMANT, FEMALE, "Gravvy@"
		db ROLLOUT
		db DEFENSE_CURL
		db MAGNITUDE
		db ROCK_THROW

	db 28, OMANYTE, ORAN_BERRY, 92, HIDDEN_ABILITY | QUIRKY, FEMALE, "Omny@"
		db WATER_GUN
		db BITE
		db DEFENSE_CURL
		db ICE_SHARD

	db 33, PIKACHU, LIGHT_BALL, 92, HIDDEN_ABILITY | HASTY, FEMALE, "Chuchu@"
		db SURF
		db FLY
		db THUNDERBOLT
		db QUICK_ATTACK
