...
; ================
	...
	db 17, SCYTHER, ORAN_BERRY, ABILITY_1 | QUIRKY, FEMALE
		db QUICK_ATTACK
		db LEER
		db PURSUIT
		db FURY_CUTTER
...
if DEF(FAITHFUL)
	...
	db 72, DUGTRIO, BLACKGLASSES, $EE, $EE, $EE
		db EARTHQUAKE
		db IRON_HEAD
		db NIGHT_SLASH
		db ROCK_SLIDE
...
; ================
	...
	db 57, DRAGONITE, QUICK_CLAW, ABILITY_1 | MODEST, MALE
		db THUNDER_WAVE
		db TWISTER
		db THUNDER
		db HYPER_BEAM

	db 57, DRAGONITE, LEFTOVERS, ABILITY_1 | MODEST, MALE
		db SAFEGUARD
		db TWISTER
		db BLIZZARD
		db HYPER_BEAM
...
; ================
	...
	db 77, DRAGONITE, QUICK_CLAW, ABILITY_1 | MODEST, MALE
		db THUNDER_WAVE
		db BLIZZARD
		db THUNDER
		db LIGHT_SCREEN

	db 77, DRAGONITE, LEFTOVERS, ABILITY_1 | ADAMANT, MALE
		db DRAGON_DANCE
		db OUTRAGE
		db BODY_SLAM
		db EXTREMESPEED
...
; ================
	...
	db 66, MEWTWO, WISE_GLASSES, ABILITY_2 | MODEST, MALE | 2, "???@"
		db NASTY_PLOT
		db PSYSTRIKE
		db SHADOW_BALL
		db ICE_BEAM
