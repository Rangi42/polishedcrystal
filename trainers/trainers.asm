...
; ================
	...
	db 65, EXEGGUTOR, FIGY_BERRY, DVS_HP_ELECTRIC, MODEST | HIDDEN_ABILITY, MALE
		db PSYCHIC_M
		db GIGA_DRAIN
		db HIDDEN_POWER ; Electric
		db ANCIENTPOWER
...
endc
	...
	db 65, ALAKAZAM, LEFTOVERS, FAKE_PERFECT_DVS, MODEST | HIDDEN_ABILITY, MALE
		db PSYCHIC_M
		db TRI_ATTACK
		db CALM_MIND
		db CONFUSE_RAY
