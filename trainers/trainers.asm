...
; ================
	...
	db 69, EXEGGUTOR, MIRACLE_SEED
		db PSYCHIC_M
		db LEECH_SEED
		db EGG_BOMB
		db GIGA_DRAIN

	db 69, ARCANINE, CHARCOAL
		db ROAR
		db FLAME_WHEEL
		db FLAMETHROWER
		db EXTREMESPEED
...
; ================
	...
	db 36, MAGNETON, NO_ITEM
		db TRI_ATTACK
		db THUNDERBOLT
		db FLASH_CANNON
		db THUNDER_WAVE

	db 37, TAUROS, NO_ITEM
		db HORN_ATTACK
		db ZEN_HEADBUTT
		db QUICK_ATTACK
		db BULK_UP

	db 36, HAUNTER, NO_ITEM
		db PAIN_SPLIT
		db MEAN_LOOK
		db CONFUSE_RAY
		db SHADOW_BALL

	db 40, SNEASEL, NO_ITEM
		db SLASH
		db ICE_PUNCH
		db SCREECH
		db FEINT_ATTACK
...
; ================
	...
	db 27, DROWZEE, TWISTEDSPOON
		db DREAM_EATER
		db HYPNOSIS
		db DISABLE
		db PSYBEAM

	db 27, HAUNTER, EVIOLITE
		db SHADOW_BALL
		db HYPNOSIS
		db CONFUSE_RAY
		db CURSE

	db 27, JUMPLUFF, PINK_BOW
		db GIGA_DRAIN
		db SYNTHESIS
		db FAIRY_WIND
		db LEECH_SEED

	db 29, ELECTRODE, MAGNET
		db THUNDER
		db SCREECH
		db SONIC_BOOM
		db ROLLOUT
...
; ================
	...
	db 35, GLACEON, NEVERMELTICE
		db ICE_BEAM
		db BARRIER
		db RECOVER
		db QUICK_ATTACK

	db 38, DEWGONG, LEFTOVERS
		db WATERFALL
		db AURORA_BEAM
		db SLEEP_TALK
		db REST

	db 37, CLOYSTER, SILK_SCARF
		db RAZOR_SHELL
		db SELFDESTRUCT
		db AURORA_BEAM
		db DEFENSE_CURL

	db 38, SLOWBRO, TWISTEDSPOON
		db PSYCHIC_M
		db BUBBLE_BEAM
		db HEADBUTT
		db DISABLE
