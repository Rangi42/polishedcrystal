...
; ================
	...
	db 18, CLEFAIRY, NO_ITEM, 48, ABILITY_1 | QUIRKY, FEMALE
		db METRONOME
		db DISARM_VOICE
		db DOUBLE_SLAP
		db ATTRACT

	db 19, TEDDIURSA, NO_ITEM, 48, ABILITY_1 | QUIRKY, FEMALE
		db SCRATCH
		db ATTRACT
		db LICK
		db FEINT_ATTACK

	db 18, MUNCHLAX, NO_ITEM, 48, ABILITY_1 | QUIRKY, FEMALE
		db ATTRACT
		db METRONOME
		db DEFENSE_CURL
		db ROLLOUT

	db 20, MILTANK, LUM_BERRY, 48, ABILITY_2 | QUIRKY, FEMALE ; Scrappy
		db DEFENSE_CURL
		db STOMP
		db MILK_DRINK
		db ROLLOUT
...
; ================
	...
	db 23, HAUNTER, NO_ITEM, 64, ABILITY_2 | QUIRKY, MALE ; Levitate
		db HYPNOSIS
		db ICE_PUNCH
		db NIGHT_SHADE
		db SHADOW_CLAW

	db 22, NOCTOWL, NO_ITEM, 64, ABILITY_1 | QUIRKY, MALE
		db HYPNOSIS
		db PECK
		db CONFUSION
		db SHADOW_BALL

	db 24, MISDREAVUS, NO_ITEM, 64, ABILITY_1 | QUIRKY, MALE
		db DISARM_VOICE
		db DARK_PULSE
		db NASTY_PLOT
		db SHADOW_BALL

	db 25, GENGAR, SITRUS_BERRY, 64, ABILITY_2 | QUIRKY, MALE ; Levitate
		db HYPNOSIS
		db THUNDERBOLT
		db SHADOW_BALL
		db DREAM_EATER
...
if DEF(FAITHFUL)
	db 28, MACHOKE, NO_ITEM, 80
		db KARATE_CHOP
		db BULLET_PUNCH
		db BULK_UP
		db DYNAMICPUNCH
else
	db 28, FARFETCH_D, NO_ITEM, 80
		db NIGHT_SLASH
		db AERIAL_ACE
		db SWORDS_DANCE
		db HI_JUMP_KICK
endc
	...
	db 27, HITMONTOP, NO_ITEM, 80
		db BULK_UP
		db SUCKER_PUNCH
		db TRIPLE_KICK
		db RAPID_SPIN

	db 30, POLIWRATH, SITRUS_BERRY, 80
		db ICE_PUNCH
		db HYPNOSIS
		db WATERFALL
		db DYNAMICPUNCH
...
; ================
	...
	db 32, SKARMORY, NO_ITEM, 96
		db SAND_ATTACK
		db DRILL_PECK
		db SPIKES
		db STEEL_WING

	db 31, MAGNETON, NO_ITEM, 96
		db SUPERSONIC
		db THUNDER_WAVE
		db THUNDERBOLT
		db TRI_ATTACK

	db 32, FORRETRESS, NO_ITEM, 96
		db SPIKES
		db FLASH_CANNON
		db DEFENSE_CURL
		db ROLLOUT

	db 32, SCIZOR, NO_ITEM, 96
		db PURSUIT
		db AERIAL_ACE
		db METAL_CLAW
		db SLASH

	db 35, STEELIX, SITRUS_BERRY, 96
		db BODY_SLAM
		db SCREECH
		db ROCK_SLIDE
		db IRON_TAIL
...
; ================
	...
	db 37, DEWGONG, CHESTO_BERRY, 112
		db WATERFALL
		db REST
		db RAIN_DANCE
		db AURORA_BEAM

	db 36, SNEASEL, NO_ITEM, 112
		db SWORDS_DANCE
		db ICICLE_CRASH
		db SCREECH
		db SLASH

	db 37, CLOYSTER, NO_ITEM, 112
		db DEFENSE_CURL
		db SUPERSONIC
		db WATER_PULSE
		db ICE_SHARD

	db 38, LAPRAS, NO_ITEM, 112
		db SING
		db CONFUSE_RAY
		db ANCIENTPOWER
		db ICE_BEAM

	db 40, MAMOSWINE, SITRUS_BERRY, 112
		db MAGNITUDE
		db ANCIENTPOWER
		db AVALANCHE
		db FURY_ATTACK
...
; ================
	...
	db 41, GYARADOS, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db CRUNCH
		db TWISTER
		db DRAGONBREATH
		db AQUA_TAIL

	db 43, YANMEGA, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db DOUBLE_TEAM
		db SUPERSONIC
		db ANCIENTPOWER
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	db 42, DRAGONAIR, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db THUNDER_WAVE
		db AQUA_TAIL
		db FLAMETHROWER
		db DRAGONBREATH
else
	db 42, AMPHAROS, NO_ITEM, 128, ABILITY_1 | QUIRKY, FEMALE
		db THUNDER_WAVE
		db CONFUSE_RAY
		db THUNDERBOLT
		db DRAGON_PULSE
endc
	...
	db 45, KINGDRA, SITRUS_BERRY, 128, ABILITY_2 | QUIRKY, FEMALE ; Sniper
		db SMOKESCREEN
		db HYPER_BEAM
		db DRAGON_PULSE
		db SURF
...
; ================
	...
	db 47, XATU, TWISTEDSPOON, 180
		db QUICK_ATTACK
		db CONFUSE_RAY
		db RECOVER
		db PSYCHIC_M

	db 48, JYNX, BRIGHTPOWDER, 180
		db NASTY_PLOT
		db DRAIN_KISS
		db ICE_BEAM
		db PSYCHIC_M

	db 49, EXEGGUTOR, MIRACLE_SEED, 180
		db REFLECT
		db LEECH_SEED
		db SEED_BOMB
		db PSYCHIC_M

	db 49, ALAKAZAM, LUM_BERRY, 180
		db CALM_MIND
		db RECOVER
		db LIGHT_SCREEN
		db PSYCHIC_M

	db 48, SLOWBRO, SITRUS_BERRY, 180
		db SURF
		db CALM_MIND
		db BODY_SLAM
		db PSYCHIC_M

	db 50, XATU, LEFTOVERS, 180
		db QUICK_ATTACK
		db CONFUSE_RAY
		db PSYCHIC_M
		db FUTURE_SIGHT
...
; ================
	...
	db 49, ARIADOS, SITRUS_BERRY, 200
		db DOUBLE_TEAM
		db GLARE
		db BATON_PASS
		db GIGA_DRAIN

	db 49, VENOMOTH, SILVERPOWDER, 200
		db SUPERSONIC
		db BUG_BUZZ
		db PSYCHIC_M
		db TOXIC

	db 51, FORRETRESS, SILK_SCARF, 200
		db PROTECT
		db EXPLOSION
		db SPIKES
		db IRON_HEAD

	db 50, MUK, BRIGHTPOWDER, 200
		db MINIMIZE
		db SCREECH
		db SLUDGE_BOMB
		db TOXIC

	db 50, WEEZING, MAGNET, 200
		db WILL_O_WISP
		db TOXIC
		db SLUDGE_BOMB
		db EXPLOSION

	db 52, CROBAT, LEFTOVERS, 200
		db DOUBLE_TEAM
		db POISON_JAB
		db SUPER_FANG
		db TOXIC
...
; ================
	...
	db 50, HITMONTOP, QUICK_CLAW, 220
		db PURSUIT
		db TRIPLE_KICK
		db DIG
		db PROTECT

	db 52, HERACROSS, SILVERPOWDER, 220
		db SWORDS_DANCE
		db EARTHQUAKE
		db MEGAHORN
if DEF(FAITHFUL)
...
endc
	...
	db 50, HITMONLEE, FOCUS_BAND, 220
		db SUCKER_PUNCH
		db DOUBLE_KICK
		db HI_JUMP_KICK
		db FORESIGHT

	db 50, HITMONCHAN, NEVERMELTICE, 220
		db THUNDERPUNCH
		db ICE_PUNCH
		db POISON_JAB
		db MACH_PUNCH

	db 52, ONIX, HARD_STONE, 220
		db BODY_SLAM
		db EARTHQUAKE
		db CRUNCH
		db ROCK_SLIDE

	db 54, MACHAMP, LEFTOVERS, 220
		db ROCK_SLIDE
		db FORESIGHT
		db CROSS_CHOP
		db SWORDS_DANCE
...
; ================
	...
	db 52, UMBREON, LEFTOVERS, 240
		db SAND_ATTACK
		db CONFUSE_RAY
		db FEINT_ATTACK
		db MEAN_LOOK

	db 52, PERSIAN, PINK_BOW, 240
		db NIGHT_SLASH
		db FEINT_ATTACK
		db SCREECH
		db PLAY_ROUGH

	db 53, WEAVILE, KINGS_ROCK, 240
		db SWORDS_DANCE
		db SCREECH
		db NIGHT_SLASH
		db ICE_PUNCH

	db 54, GENGAR, SPELL_TAG, 240
		db SHADOW_BALL
		db WILL_O_WISP
		db CURSE
		db DESTINY_BOND

	db 53, HONCHKROW, BLACKGLASSES, 240
		db DRILL_PECK
		db SUCKER_PUNCH
		db PURSUIT
		db FEINT_ATTACK

	db 56, HOUNDOOM, CHARCOAL, 240
		db ROAR
		db PURSUIT
		db FLAMETHROWER
		db DARK_PULSE
...
; ================
	...
	db 56, GYARADOS, MUSCLE_BAND, ABILITY_1 | JOLLY, MALE
		db DRAGON_DANCE
		db FLY
		db WATERFALL
		db EARTHQUAKE

	db 57, DRAGONITE, WIDE_LENS, HIDDEN_ABILITY | MODEST, MALE
		db FIRE_BLAST
		db BLIZZARD
		db THUNDER
		db HYPER_BEAM

	db 57, KINGDRA, SCOPE_LENS, ABILITY_2 | MODEST, MALE
		db FOCUS_ENERGY
		db DRAGONBREATH
		db SURF
		db HYPER_BEAM

	db 56, AERODACTYL, KINGS_ROCK, HIDDEN_ABILITY | ADAMANT, MALE
		db AERIAL_ACE
		db ANCIENTPOWER
		db ROCK_SLIDE
		db GIGA_IMPACT

	db 56, CHARIZARD, WISE_GLASSES, ABILITY_2 | MODEST, MALE
		db FLAMETHROWER
		db HYPER_BEAM
		db FOCUS_BLAST
if DEF(FAITHFUL)
...
endc
	...
	db 59, DRAGONITE, LEFTOVERS, SHINY_MASK | HIDDEN_ABILITY | ADAMANT, MALE
		db SUBSTITUTE
		db DRAGON_DANCE
		db FLY
		db EXTREMESPEED
...
; ================
	...
	db 38, GOLBAT, NO_ITEM, 116
		db LEECH_LIFE
		db BITE
		db CONFUSE_RAY
		db WING_ATTACK

	db 37, MAGNETON, NO_ITEM, 116
		db TRI_ATTACK
		db THUNDERBOLT
		db FLASH_CANNON
		db THUNDER_WAVE

	db 37, HAUNTER, NO_ITEM, 116
		db PAIN_SPLIT
		db MEAN_LOOK
		db CONFUSE_RAY
		db SHADOW_BALL

	db 39, SNEASEL, NO_ITEM, 116
		db SLASH
		db ICE_PUNCH
		db HONE_CLAWS
		db FEINT_ATTACK

	db 41, MEGANIUM, SITRUS_BERRY, 116
		db REFLECT
		db LIGHT_SCREEN
		db PETAL_DANCE
		db ANCIENTPOWER
...
; ================
	...
	db 41, TYPHLOSION, SITRUS_BERRY, 116
		db SMOKESCREEN
		db FLAME_WHEEL
		db DIG
		db SWIFT
...
; ================
	...
	db 41, FERALIGATR, SITRUS_BERRY, 116
		db SLASH
		db SURF
		db CRUNCH
		db NIGHT_SLASH
...
; ================
	...
	db 44, WEAVILE, KINGS_ROCK, 144
		db SWORDS_DANCE
		db SCREECH
		db NIGHT_SLASH
		db X_SCISSOR

	db 46, GOLBAT, EVIOLITE, 144
		db POISON_JAB
		db SUPER_FANG
		db CONFUSE_RAY
		db WING_ATTACK

	db 45, MAGNETON, MAGNET, 144
		db THUNDERBOLT
		db TRI_ATTACK
		db THUNDER_WAVE
		db FLASH_CANNON

	db 45, GENGAR, SPELL_TAG, 144
		db MEAN_LOOK
		db DARK_PULSE
		db SHADOW_BALL
		db CONFUSE_RAY

	db 45, ALAKAZAM, BRIGHTPOWDER, 144
		db DISABLE
		db PSYCHIC_M
		db RECOVER
		db CONFUSE_RAY

	db 48, MEGANIUM, SITRUS_BERRY, 144
		db REFLECT
		db LIGHT_SCREEN
		db ENERGY_BALL
		db ANCIENTPOWER
...
; ================
	...
	db 48, TYPHLOSION, SITRUS_BERRY, 144
		db SMOKESCREEN
		db QUICK_ATTACK
		db DIG
		db FLAMETHROWER
...
; ================
	...
	db 48, FERALIGATR, SITRUS_BERRY, 144
		db CRUNCH
		db SURF
		db SLASH
		db SCARY_FACE
...
; ================
	...
	; party
	db 31, PIDGEOTTO, NO_ITEM, 100, "Pidgeotto@"
	db 32, GROWLITHE, NO_ITEM, 100, "Growlithe@"
	db 32, AZUMARILL, NO_ITEM, 100, "Azumarill@"
	db 30, FLAAFFY, NO_ITEM, 100, "Flaaffy@"
	db 35, BAYLEEF, ORAN_BERRY, 100, "Chicory@"
...
; ================
	...
	; party
	db 31, PIDGEOTTO, NO_ITEM, 100, "Pidgeotto@"
	db 32, SUNFLORA, NO_ITEM, 100, "Sunflora@"
	db 32, AZUMARILL, NO_ITEM, 100, "Azumarill@"
	db 30, FLAAFFY, NO_ITEM, 100, "Flaaffy@"
	db 35, QUILAVA, ORAN_BERRY, 100, "Cinder@"
...
; ================
	...
	db 32, GROWLITHE, NO_ITEM, 100, "Growlithe@"
	db 30, FLAAFFY, NO_ITEM, 100, "Flaaffy@"
	db 35, CROCONAW, ORAN_BERRY, 100, "Toto@"
...
; ================
	...
	; party
	db 42, PIDGEOT, NO_ITEM, 132, "Pidgeot@"
	db 43, ARCANINE, NO_ITEM, 132, "Arcanine@"
	db 43, AZUMARILL, NO_ITEM, 132, "Azumarill@"
	db 44, AMPHAROS, NO_ITEM, 132, "Ampharos@"
	db 41, GIRAFARIG, NO_ITEM, 132, "Girafarig@"
	db 45, MEGANIUM, SITRUS_BERRY, 132, "Chicory@"
...
; ================
	...
	; party
	db 42, PIDGEOT, NO_ITEM, 132, "Pidgeot@"
	db 43, SUNFLORA, NO_ITEM, 132, "Sunflora@"
	db 43, AZUMARILL, NO_ITEM, 132, "Azumarill@"
	db 44, AMPHAROS, NO_ITEM, 132, "Ampharos@"
	db 41, GIRAFARIG, NO_ITEM, 132, "Girafarig@"
	db 45, TYPHLOSION, SITRUS_BERRY, 132, "Cinder@"
...
; ================
	...
	db 44, AMPHAROS, NO_ITEM, 132, "Ampharos@"
	db 41, GIRAFARIG, NO_ITEM, 132, "Girafarig@"
	db 45, FERALIGATR, SITRUS_BERRY, 132, "Toto@"
...
; ================
	...
	db 43, DRAGONITE, 132, FOCUS_SASH, HIDDEN_ABILITY | ADAMANT, MALE
		db FOCUS_ENERGY
		db DRAGON_CLAW
		db EARTHQUAKE
		db ICE_PUNCH

	db 43, KINGDRA, 132, FOCUS_SASH, ABILITY_2 | MODEST, MALE
		db DOUBLE_TEAM
		db DRAGON_PULSE
		db SURF
		db ICE_BEAM

	db 43, CHARIZARD, 132, FOCUS_SASH, ABILITY_1 | ADAMANT, MALE
		db DRAGON_DANCE
		db DRAGON_CLAW
		db EARTHQUAKE
		db FLARE_BLITZ
...
; ================
	...
	db 33, GOLBAT, BLACKGLASSES, 108
		db BITE
		db AERIAL_ACE
		db CONFUSE_RAY
		db SUPER_FANG

	db 34, PERSIAN, HARD_STONE, 108
		db PLAY_ROUGH
		db FURY_SWIPES
		db SCREECH
		db FEINT_ATTACK

	db 34, RATICATE, KINGS_ROCK, 108
		db SWORDS_DANCE
		db CRUNCH
		db SUPER_FANG
		db HYPER_FANG

	db 35, WEEZING, POISON_BARB, 108
		db ENDURE
		db WILL_O_WISP
		db SLUDGE_BOMB
		db SELFDESTRUCT
...
; ================
	...
	db 27, HAUNTER, SPELL_TAG, 88
		db DISABLE
		db NIGHT_SHADE
		db CONFUSE_RAY
		db SHADOW_BALL

	db 29, RATICATE, BLACKGLASSES, 88
		db PURSUIT
		db HYPER_FANG
		db SCARY_FACE
		db CRUNCH

	db 27, WEEZING, SILK_SCARF, 88
		db WILL_O_WISP
		db SELFDESTRUCT
		db SLUDGE
		db SMOKESCREEN

	db 31, HOUNDOUR, KINGS_ROCK, 88
		db EMBER
		db SMOKESCREEN
		db BITE
		db SUPER_FANG
...
; ================
	...
	db 37, GLACEON, NO_ITEM, 120
		db ICE_BEAM
		db BARRIER
		db RECOVER
		db QUICK_ATTACK

	db 39, DEWGONG, NO_ITEM, 120
		db WATERFALL
		db AURORA_BEAM
		db SLEEP_TALK
		db REST

	db 38, CLOYSTER, NO_ITEM, 120
		db DEFENSE_CURL
		db ROLLOUT
		db AURORA_BEAM
		db SELFDESTRUCT

	db 39, SLOWBRO, NO_ITEM, 120
		db PSYCHIC_M
		db WATER_PULSE
		db HEADBUTT
		db DISABLE

	db 42, JYNX, SITRUS_BERRY, 120
		db DRAIN_KISS
		db SING
		db AVALANCHE
		db PETAL_DANCE
...
; ================
	...
	db 35, CLEFABLE, NO_ITEM, 112
		db DISARM_VOICE
		db MINIMIZE
		db BATON_PASS
		db METRONOME

	db 35, MR__MIME, NO_ITEM, 112
		db PSYBEAM
		db CONFUSE_RAY
		db LIGHT_SCREEN
		db REFLECT

	db 34, AZUMARILL, NO_ITEM, 112
		db PLAY_ROUGH
		db AQUA_TAIL
		db DIZZY_PUNCH
		db ROLLOUT

	db 36, TOGETIC, NO_ITEM, 112
		db ANCIENTPOWER
		db SOFTBOILED
		db FAIRY_WIND
		db ENCORE

	db 38, SYLVEON, SITRUS_BERRY, 112
		db MOONBLAST
		db CALM_MIND
		db DRAIN_KISS
		db SWIFT
...
; ================
	...
	db 28, RATTATA, ORAN_BERRY, 92, HIDDEN_ABILITY | ADAMANT, FEMALE, "Ratty@"
		db LEER
		db QUICK_ATTACK
		db HYPER_FANG
		db FOCUS_ENERGY

	db 26, BUTTERFREE, ORAN_BERRY, 92, HIDDEN_ABILITY | MODEST, FEMALE, "Kitty@"
		db CONFUSION
		db SLEEP_POWDER
		db POISONPOWDER
		db STUN_SPORE

	db 29, DODUO, ORAN_BERRY, 92, HIDDEN_ABILITY | HASTY, FEMALE, "Dody@"
		db PECK
		db TRI_ATTACK
		db RETURN
		db MUD_SLAP

	db 28, GRAVELER, ORAN_BERRY, 92, HIDDEN_ABILITY | ADAMANT, FEMALE, "Gravvy@"
		db ROLLOUT
		db DEFENSE_CURL
		db MAGNITUDE
		db ROCK_THROW

	db 27, OMANYTE, ORAN_BERRY, 92, HIDDEN_ABILITY | QUIRKY, FEMALE, "Omny@"
		db WATER_GUN
		db BITE
		db DEFENSE_CURL
		db ICE_SHARD

	db 32, PIKACHU, LIGHT_BALL, 92, HIDDEN_ABILITY | HASTY, FEMALE, "Chuchu@"
		db SURF
		db FLY
		db THUNDERBOLT
		db QUICK_ATTACK
...
; ================
	...
	db 28, NOCTOWL, NO_ITEM, 92
		db AERIAL_ACE
		db NIGHT_SHADE
		db REFLECT
		db CONFUSION

	db 29, PIDGEOT, NO_ITEM, 92
		db GUST
		db TWISTER
		db SWIFT
		db MUD_SLAP

	db 28, AERODACTYL, NO_ITEM, 92
		db WING_ATTACK
		db SUPERSONIC
		db BITE
		db ANCIENTPOWER

	db 31, SKARMORY, SITRUS_BERRY, 92
		db METAL_CLAW
		db FURY_ATTACK
		db DRILL_PECK
		db SWIFT
...
; ================
	...
	db 21, NINETALES, SITRUS_BERRY, 60
