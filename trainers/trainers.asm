...
; ================
	...
	db 24, MISDREAVUS, NO_ITEM, ABILITY_1 | QUIRKY, MALE
		db DISARM_VOICE
		db DARK_PULSE
		db NASTY_PLOT
		db SHADOW_BALL
...
endc
	...
	db 59, DRAGONITE, WISE_GLASSES, SHINY_MASK | HIDDEN_ABILITY | ADAMANT, MALE
		db DRAGON_DANCE
		db OUTRAGE
		db EARTHQUAKE
		db EXTREMESPEED
...
; ================
	...
	db 77, DRAGONITE, WIDE_LENS, HIDDEN_ABILITY | MODEST, MALE
		db THUNDER_WAVE
		db BLIZZARD
		db THUNDER
		db LIGHT_SCREEN
...
endc
	...
	db 80, DRAGONITE, WISE_GLASSES, SHINY_MASK | HIDDEN_ABILITY | MODEST, MALE
		db HURRICANE
		db FIRE_BLAST
		db DRAGON_PULSE
		db HYPER_BEAM
...
; ================
	...
	db 25, MILTANK, LEFTOVERS, PERFECT_DVS, ABILITY_2 | ADAMANT, FEMALE
		db DEFENSE_CURL
		db ROLLOUT
		db MILK_DRINK
		db BODY_SLAM

	db 25, TAUROS, LEFTOVERS, PERFECT_DVS, ABILITY_2 | ADAMANT, MALE
		db ZEN_HEADBUTT
		db QUICK_ATTACK
		db PURSUIT
		db BULK_UP
...
; ================
	...
	db 20, WEEPINBELL, BINDING_BAND, ABILITY_1 | HASTY, FEMALE
		db WRAP
		db SLEEP_POWDER
		db POISONPOWDER
		db STUN_SPORE

	db 20, AZUMARILL, BINDING_BAND, HIDDEN_ABILITY | HASTY, FEMALE
		db WHIRLPOOL
		db PERISH_SONG
		db AQUA_TAIL
		db PROTECT

	db 21, CHARMELEON, BINDING_BAND, ABILITY_2 | HASTY, FEMALE
		db FIRE_SPIN
		db DRAGON_RAGE
		db SMOKESCREEN
		db PROTECT
...
; ================
	...
	; party
	db 19, KADABRA, NO_ITEM
	db 19, NOCTOWL, NO_ITEM
	db 18, MURKROW, NO_ITEM
