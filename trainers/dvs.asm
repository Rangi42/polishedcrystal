...
TrainerClassDVsAndPersonality: ; 270d6
	...
	db 160, PERFECT_DVS,   ABILITY_1 | QUIRKY, FEMALE ; clair
	db 180, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; will
	db 200, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; koga
	db 220, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; bruno
	db 240, PERFECT_DVS,   ABILITY_1 | QUIRKY, FEMALE ; karen
	...
	db 192, $EE, $EE, $EE, ABILITY_1 | QUIRKY, FEMALE ; yellow
	db 192, $EE, $EE, $EE, ABILITY_1 | QUIRKY, MALE   ; walker
	db 192, $EE, $EE, $EE, ABILITY_1 | QUIRKY, MALE   ; imakuni
	db 252, PERFECT_DVS,   ABILITY_1 | QUIRKY, MALE   ; lawrence
	db 192, $EE, $EE, $EE, ABILITY_1 | QUIRKY, FEMALE ; rei
; 2715c
