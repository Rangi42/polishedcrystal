...
UniqueDVTrainerPokemon:
	...
	; Shiny
	db BEAUTY, CHARLOTTE, BELLOSSOM, 16, ATKDEFDV_SHINY_FEMALE, SPDSPCDV_SHINY
	...
	; Hidden Power types
	db JASMINE, 2, MAGNEZONE, 65, ATKDEFDV_HP_GRASS, $FF
	db JASMINE, 2, MAGNEZONE, 66, ATKDEFDV_HP_FIRE, $FF
	db PRYCE, 2, GLACEON, 64, ATKDEFDV_HP_GROUND, $FF
	db WILL, 2, ALAKAZAM, 65, ATKDEFDV_HP_FIGHTING, $FF
	db LT_SURGE, 2, JOLTEON, 66, ATKDEFDV_HP_ICE, $FF
	db LT_SURGE, 2, MAGNEZONE, 65, ATKDEFDV_HP_FIRE, $FF
	db ERIKA, 2, BELLOSSOM, 68, ATKDEFDV_HP_ROCK, $FF
	db LEAF, 1, MOLTRES, 89, ATKDEFDV_HP_GRASS, $FF
