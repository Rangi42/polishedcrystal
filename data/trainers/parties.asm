...
ChuckGroup:
	...
	dbp 30, PRIMEAPE, MALE
		db NO_ITEM, ABIL_PRIMEAPE_ANGER_POINT | NAT_NEUTRAL
		ev_spread 160 Atk
...
endc
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 71, PRIMEAPE, MALE
		db DRAGON_FANG, ABIL_PRIMEAPE_ANGER_POINT | NAT_NEUTRAL
...
ProfElmGroup:
	...
	; party
	; TODO: movesets, etc
	dbp LEVEL_FROM_BADGES + 5, AIPOM
	dbp LEVEL_FROM_BADGES + 6, WIGGLYTUFF
	...
	; party
	; TODO: movesets, etc
	dbp LEVEL_FROM_BADGES + 6, AMBIPOM
	dbp LEVEL_FROM_BADGES + 7, WIGGLYTUFF
	dbp LEVEL_FROM_BADGES + 8, TYPHLOSION
	dbp LEVEL_FROM_BADGES + 8, MEGANIUM
	dbp LEVEL_FROM_BADGES + 8, FERALIGATR
	db -1 ; end
