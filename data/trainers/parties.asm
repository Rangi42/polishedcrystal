...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 57, GYARADOS, MUSCLE_BAND, 208, ABILITY_1 | JOLLY, MALE
	...
	db 57, AERODACTYL, KINGS_ROCK, 208, HIDDEN_ABILITY | ADAMANT, MALE
		db AERIAL_ACE, ANCIENTPOWER, ROCK_SLIDE, GIGA_IMPACT
	db 57, CHARIZARD, WISE_GLASSES, 208, ABILITY_2 | MODEST, MALE
if DEF(FAITHFUL)
...
if DEF(FAITHFUL)
	...
	db 75, CHARIZARD, LIFE_ORB, HIDDEN_ABILITY | ADAMANT, MALE
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	db 8, GEODUDE, AIR_BALLOON, 12, $DD, $DD, $DD, GEODUDE_STURDY | RELAXED, MALE
