...
RileyGroup:
	...
	tr_mon 56, ELECTIVIRE @ LIGHT_CLAY, MALE
		...
		tr_evs 252 Atk, 36 Spe
		tr_moves THUNDER_PUNCH, CROSS_CHOP, BULLDOZE, LIGHT_SCREEN
	tr_mon 55, MAMOSWINE @ ASSUALT_VEST, MALE
	...
	tr_mon 73, RHYPERIOR @ ASSUALT_VEST, MALE
		tr_extra SOLID_ROCK, SDEF_UP_SATK_DOWN
		tr_evs 252 Atk, 252 SDe, 4 HP
		tr_moves IRON_HEAD, STONE_EDGE, EARTHQUAKE, CLOSE_COMBAT
	tr_mon 72, NIDOKING @ LIFO_ORB, MALE
		tr_extra SHEER_FORCE, SPE_UP_SATK_DOWN
		tr_evs 252 Atk, 252 Spe, 4 HP
		tr_moves FIRE_PUNCH, ROCK_SLIDE, POISON_JAB, THUNDER_PUNCH
...
MarleyGroup:
	...
	tr_mon 59, PIDGEOT @ SILK_SCARF, FEMALE
		...
		tr_evs 252 Spe, 36 Atk
		tr_moves DRILL_PECK, STEEL_WING, U-TURN, EXTREMESPEED
