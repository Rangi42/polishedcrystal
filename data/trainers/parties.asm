...
if DEF(FAITHFUL)
	tr_mon 72, DUGTRIO | ALOLAN_FORM @ FOCUS_SASH, FEMALE
		tr_extra ARENA_TRAP, ATK_UP_SATK_DOWN
		tr_evs 252 Atk, 4 Def, 252 Spe
...
WillGroup:
	...
	tr_mon 49, JYNX @ BRIGHTPOWDER, FEMALE
		tr_extra DRY_SKIN
...
endc
	...
	tr_mon 75, RAICHU @ BRIGHTPOWDER, MALE
		tr_extra LIGHTNING_ROD, SPE_UP_ATK_DOWN
		tr_evs 252 SAt, 4 Def, 252 Spe
		tr_moves DOUBLE_TEAM, NASTY_PLOT, THUNDERBOLT, FOCUS_BLAST
	end_trainer
...
Rival1Group:
	...
	tr_mon 46, ALAKAZAM @ BRIGHTPOWDER, MALE
		tr_extra SYNCHRONIZE
		tr_evs 144 SAt, 144 Spe
...
endc
	...
	tr_mon 63, ALAKAZAM @ BRIGHTPOWDER, MALE
...
endc
	...
	tr_mon 62, ELECTABUZZ, MALE
		tr_extra STATIC
		tr_evs 252 Atk, 132 Spe
		tr_moves THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, DOUBLE_TEAM
...
if DEF(FAITHFUL)
	tr_mon 73, HERACROSS @ FOCUS_SASH, FEMALE
		tr_extra SWARM, SPE_UP_ATK_DOWN
		tr_evs 252 Atk, 4 Def, 252 Spe
