...
; ================
	...
	; party
	db 18, PIDGEY, NO_ITEM, 36, "Pidgey@"
		db ROOST, QUICK_ATTACK, GUST, RAGE
	db 17, MARILL, NO_ITEM, 36, "Marill@"
		db DIZZY_PUNCH, BUBBLE_BEAM, ROLLOUT, DEFENSE_CURL
	db 15, MAREEP, NO_ITEM, 36, "Mareep@"
		db THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP, TACKLE
	db 20, BAYLEEF, ORAN_BERRY, 36, "Chicory@"
		db RAZOR_LEAF, HEALINGLIGHT, POISONPOWDER, DISARM_VOICE
	db -1 ; end
...
; ================
	...
	db 17, SUNKERN, NO_ITEM, 36, "Sunkern@"
		db MEGA_DRAIN, GROWTH, RAZOR_LEAF, LEECH_SEED
	db 15, MAREEP, NO_ITEM, 36, "Mareep@"
		db THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP, TACKLE
	db 20, QUILAVA, ORAN_BERRY, 36, "Cinder@"
		db FLAME_WHEEL, QUICK_ATTACK, SMOKESCREEN, MUD_SLAP
	db -1 ; end
...
; ================
	...
	db 17, GROWLITHE, NO_ITEM, 36, "Growlithe@"
		db BITE, FLAME_WHEEL, ROAR, LEER
	db 15, MAREEP, NO_ITEM, 36, "Mareep@"
		db THUNDER_WAVE, THUNDERSHOCK, MUD_SLAP, TACKLE
	db 20, CROCONAW, ORAN_BERRY, 36, "Toto@"
		db BITE, METAL_CLAW, SCARY_FACE, WATER_GUN
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 34, PIDGEOTTO, NO_ITEM, 100, "Pidgeotto@"
		db ROOST, WING_ATTACK, MUD_SLAP, CHARM
	db 35, GROWLITHE, NO_ITEM, 100, "Growlithe@"
		db FLAME_WHEEL, AGILITY, DOUBLE_KICK, THRASH
	db 35, AZUMARILL, NO_ITEM, 100, "Azumarill@"
		db PLAY_ROUGH, SCARY_FACE, AQUA_TAIL, DIZZY_PUNCH
	db 34, FLAAFFY, NO_ITEM, 100, "Flaaffy@"
		db POWER_GEM, CONFUSE_RAY, THUNDERSHOCK, THUNDER_WAVE
	db 37, MEGANIUM, SITRUS_BERRY, 100, "Chicory@"
		db LIGHT_SCREEN, ENERGY_BALL, DISARM_VOICE, ANCIENTPOWER
	db -1 ; end
...
; ================
	...
	db 34, PIDGEOTTO, NO_ITEM, 100, "Pidgeotto@"
		db ROOST, WING_ATTACK, MUD_SLAP, CHARM
	db 35, SUNFLORA, NO_ITEM, 100, "Sunflora@"
		db HEALINGLIGHT, GIGA_DRAIN, FLAMETHROWER, EARTH_POWER
	db 35, AZUMARILL, NO_ITEM, 100, "Azumarill@"
		db PLAY_ROUGH, SCARY_FACE, AQUA_TAIL, DIZZY_PUNCH
	db 34, FLAAFFY, MAGNEZONE, 100, "Flaaffy@"
		db POWER_GEM, CONFUSE_RAY, THUNDERSHOCK, THUNDER_WAVE
	db 37, TYPHLOSION, SITRUS_BERRY, 100, "Cinder@"
		db EARTH_POWER, FLAME_WHEEL, ROLLOUT, SWIFT
	db -1 ; end
...
; ================
	...
	db 34, FLAAFFY, NO_ITEM, 100, "Flaaffy@"
		db POWER_GEM, CONFUSE_RAY, THUNDERSHOCK, THUNDER_WAVE
	db 37, FERALIGATR, SITRUS_BERRY, 100, "Toto@"
		db CRUNCH, AGILITY, SURF, METAL_CLAW
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 49, PIDGEOT, NO_ITEM, 132, "Pidgeot@"
		db ROOST, AIR_SLASH, ICY_WIND, CHARM
	db 45, GIRAFARIG, NO_ITEM, 132, "Girafarig@"
		db SHADOW_BALL, NASTY_PLOT, ENERGY_BALL, HYPER_VOICE
	db 45, ARCANINE, NO_ITEM, 132, "Arcanine@"
		db PLAY_ROUGH, OUTRAGE, CRUNCH, FLAMETHROWER
	db 46, AZUMARILL, NO_ITEM, 132, "Azumarill@"
		db PLAY_ROUGH, SCARY_FACE, AQUA_TAIL, DIZZY_PUNCH
	db 47, AMPHAROS, NO_ITEM, 132, "Ampharos@"
		db POWER_GEM, THUNDERBOLT, THUNDER_WAVE, DRAGONBREATH
	db 50, MEGANIUM, LUM_BERRY, 132, "Chicory@"
		db DISARM_VOICE, ENERGY_BALL, LIGHT_SCREEN, HEALINGLIGHT
	db -1 ; end
...
; ================
	...
	db 50, TYPHLOSION, SITRUS_BERRY, 132, "Cinder@"
		db EARTH_POWER, FLAMETHROWER, SWIFT, ROLLOUT
	db -1 ; end
...
; ================
	...
	db 45, SUNFLORA, NO_ITEM, 132, "Sunflora@"
		db EARTH_POWER, SOLAR_BEAM, FLAMETHROWER, SUNNY_DAY
	db 46, ARCANINE, NO_ITEM, 132, "Arcanine@"
		db PLAY_ROUGH, OUTRAGE, CRUNCH, FLAMETHROWER
	db 47, AMPHAROS, NO_ITEM, 132, "Ampharos@"
		db POWER_GEM, THUNDERBOLT, THUNDER_WAVE, DRAGONBREATH
	db 50, FERALIGATR, SITRUS_BERRY, 132, "Toto@"
		db CRUNCH, AGILITY, WATERFALL, METAL_CLAW
	db -1 ; end
...
; ================
	...
	db 69, PIDGEOT, NO_ITEM, "Pidgeot@"
		db ROOST, FOCUS_BLAST, HURRICANE, ROAR
	db 70, ARCANINE, NO_ITEM, "Arcanine@"
		db PLAY_ROUGH, WILD_CHARGE, CRUNCH, FLARE_BLITZ
	db 70, AZUMARILL, NO_ITEM, "Azumarill@"
		db PLAY_ROUGH, WATERFALL, DIZZY_PUNCH, CLOSE_COMBAT
	db 71, AMPHAROS, NO_ITEM, "Ampharos@"
		db POWER_GEM, THUNDERBOLT, THUNDER_WAVE, DRAGON_PULSE
	db 68, GIRAFARIG, NO_ITEM, "Girafarig@"
		db SHADOW_BALL, NASTY_PLOT, ENERGY_BALL, HYPER_VOICE
	db 72, MEGANIUM, LEFTOVERS, "Chicory@"
		db DISARM_VOICE, LEECH_SEED, LIGHT_SCREEN, HEALINGLIGHT
	db -1 ; end
...
; ================
	...
	db 68, GIRAFARIG, NO_ITEM, "Girafarig@"
		db SHADOW_BALL, NASTY_PLOT, ENERGY_BALL, HYPER_VOICE
	db 72, TYPHLOSION, LIFE_ORB, "Cinder@"
		db EARTH_POWER, FLAMETHROWER, NASTY_PLOT, FOCUS_BLAST
	db -1 ; end
