...
FalknerGroup:
	...
	dbp 11, NATU
		db NO_ITEM
		ev_spread 32 HP
		db PECK, LEER, NIGHT_SHADE, HYPNOSIS
	dbp 10, SPEAROW
		db NO_ITEM
		ev_spread 32 HP
		db PECK, GUST, MUD_SLAP, PURSUIT
	dbp 10, PIDGEY
		db NO_ITEM
		ev_spread 32 HP
	...
	dbp 12, MURKROW
		db NO_ITEM
		ev_spread 32 HP
		db PECK, ASTONISH, PURSUIT, WING_ATTACK
	dbp 13, PIDGEOTTO
		db PECHA_BERRY
		ev_spread 32 HP
...
BugsyGroup:
	...
	dbp 13, VENONAT, MALE
		...
		db CONFUSION, SUPERSONIC, DISABLE, POISONPOWDER
	...
	dbp 15, HERACROSS, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 64 Atk
		db NIGHT_SLASH, ENDURE, HORN_ATTACK, BUG_BITE
...
WhitneyGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_EVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 18, CLEFAIRY, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 64 HP
		db METRONOME, DISARM_VOICE, DOUBLE_SLAP, ATTRACT
	dbp 18, JIGGLYPUFF, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 96 HP
		db DIZZY_PUNCH, DISARM_VOICE, SING, ATTRACT
...
MortyGroup:
	...
	dbp 22, GASTLY, MALE
		...
		db HYPNOSIS, SUCKER_PUNCH, NIGHT_SHADE, CONFUSE_RAY
	dbp 22, MEOWTH, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 64 Atk, 64 Spe
		db ASTONISH, FEINT_ATTACK, SCREECH, BITE
	dbp 24, HAUNTER, MALE
		db NO_ITEM, ABIL_HAUNTER_LEVITATE | NAT_NEUTRAL
		ev_spread 64 Atk, 64 Spe
...
JasmineGroup:
	...
	dbp 32, MAGNEMITE
		db NO_ITEM
		ev_spread 192 HP
		db SWIFT, THUNDER_WAVE, THUNDERBOLT, FLASH_CANNON
	dbp 34, SKARMORY
		db NO_ITEM
		ev_spread 192 HP
...
PryceGroup:
	...
	dbp 41, GLACEON
		db NEVERMELTICE
		ev_spread 224 HP
		db ICE_BEAM, ICE_SHARD, MUD_SLAP, BATON_PASS
	dbp 42, MAMOSWINE
		db SITRUS_BERRY
		ev_spread 224 Atk
...
ClairGroup:
	...
	dbp 43, DRAGONAIR, FEMALE
		...
		db THUNDER_WAVE, THUNDERBOLT, AQUA_TAIL, DRAGONBREATH
