...
ChuckGroup:
	...
	dbp 30, PRIMEAPE, MALE
		db NO_ITEM, 80, ABIL_PRIMEAPE_ANGER_POINT | NAT_NEUTRAL
		db KARATE_CHOP, SEISMIC_TOSS, SCREECH, DYNAMICPUNCH
	dbp 29, FARFETCH_D, MALE | GALARIAN_FORM
		db NO_ITEM, 80, ABIL_FARFETCH_D_GALARIAN_STEADFAST | NAT_NEUTRAL
if DEF(FAITHFUL)
...
endc
	dbp 28, HITMONTOP, MALE
		db NO_ITEM, 80, ABIL_HITMONTOP_INTIMIDATE | NAT_NEUTRAL
		db BULK_UP, SUCKER_PUNCH, DOUBLE_KICK, RAPID_SPIN
	dbp 31, POLIWRATH, MALE
		db ZOOM_LENS, 80, ABIL_POLIWRATH_WATER_ABSORB | NAT_NEUTRAL
...
ChampionGroup:
	...
	dbp 57, GYARADOS, MALE
		db MUSCLE_BAND, 208, ABIL_GYARADOS_INTIMIDATE | NAT_SPE_UP_SATK_DOWN
