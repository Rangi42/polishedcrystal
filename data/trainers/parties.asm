...
CooltrainerMGroup:
	...
	dbp 14, BULBASAUR, MALE
		db MIRACLE_SEED, 20, $EE, $EE, $EE, ABIL_BULBASAUR_CHLOROPHYLL | NAT_SPE_UP_DEF_DOWN
...
endc
	...
	dbp 20, WEEPINBELL, FEMALE
		db BINDING_BAND, 52, ABIL_WEEPINBELL_CHLOROPHYLL | NAT_SPE_UP_DEF_DOWN
		db WRAP, SLEEP_POWDER, POISONPOWDER, STUN_SPORE
	dbp 20, AZUMARILL, FEMALE
		db BINDING_BAND, 52, ABIL_AZUMARILL_SAP_SIPPER | NAT_SPE_UP_DEF_DOWN
		db WHIRLPOOL, PERISH_SONG, AQUA_TAIL, PROTECT
	dbp 21, CHARMELEON, FEMALE
		db BINDING_BAND, 52, ABIL_CHARMELEON_SOLAR_POWER | NAT_SPE_UP_DEF_DOWN
