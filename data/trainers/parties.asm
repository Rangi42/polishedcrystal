...
; ================
	...
	db 58, DRAGONITE, WIDE_LENS, 208, ABIL_DRAGONITE_INNER_FOCUS | MODEST, MALE
...
; ================
	...
	db 75, GYARADOS, LIFE_ORB, ABILITY_1 | JOLLY, MALE
		db DRAGON_DANCE, FLY, WATERFALL, EARTHQUAKE
	db 77, DRAGONITE, LEFTOVERS, ABIL_DRAGONITE_INNER_FOCUS | MODEST, MALE
...
; ================
	...
	db TRAINERTYPE_MOVES
	; party
	db 19, YANMA, BUG_BITE, QUICK_ATTACK, DOUBLE_TEAM, SONIC_BOOM
	db -1 ; end
