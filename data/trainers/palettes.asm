...
HoOhPaintingPalette:      INCLUDE "gfx/trainers/ho_oh_painting.pal"
LugiaPaintingPalette:     INCLUDE "gfx/trainers/lugia_painting.pal"
BellTowerPaintingPalette: INCLUDE "gfx/trainers/bell_tower_painting.pal"
else
PlayerPalette:
KrisPalette:
Lyra1Palette:
