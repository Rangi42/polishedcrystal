...
SandslashEvosAttacks:
	...
	db 28, HONE_CLAWS ; Slash → TM move
	db 33, DIG
...
GeodudeEvosAttacks:
	...
	db 22, BULLDOZE
	db 24, SELFDESTRUCT
	db 28, FLAIL ; Stealth Rock → egg move
	db 30, ROCK_BLAST
	db 34, EARTHQUAKE
	db 36, EXPLOSION
	db 40, DOUBLE_EDGE
...
GravelerEvosAttacks:
	...
	db 22, BULLDOZE
	db 24, SELFDESTRUCT
	db 30, FLAIL ; Stealth Rock → egg move
	db 34, ROCK_BLAST
	db 40, EARTHQUAKE
	db 44, EXPLOSION
	db 50, DOUBLE_EDGE
...
StaryuEvosAttacks:
	...
	db 24, FLASH_CANNON ; Gyro Ball → TM move
