...
endc
	...
	; tmhm
	tmhm CURSE, CALM_MIND, TOXIC, SWORDS_DANCE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, GIGA_DRAIN, SAFEGUARD, SOLAR_BEAM, IRON_TAIL, EARTHQUAKE, RETURN, DOUBLE_TEAM, REFLECT, FACADE, REST, ATTRACT, FURY_CUTTER, ROCK_SMASH, ENERGY_BALL, ENDURE, DAZZLINGLEAM, GIGA_IMPACT, FLASH, CUT, STRENGTH, BODY_SLAM, BULLDOZE, COUNTER, DOUBLE_EDGE, HEADBUTT, SEED_BOMB, SLEEP_TALK, SUBSTITUTE, SWAGGER
	; end
