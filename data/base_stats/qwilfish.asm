...
endc
	...
	; tmhm
	tmhm CURSE, TOXIC, HAIL, SWORDS_DANCE, HIDDEN_POWER, ICE_BEAM, BLIZZARD, PROTECT, RAIN_DANCE, RETURN, SHADOW_BALL, DOUBLE_TEAM, SLUDGE_BOMB, SWIFT, FACADE, REST, ATTRACT, SCALD, ENDURE, THUNDER_WAVE, EXPLOSION, POISON_JAB, SURF, WATERFALL, WHIRLPOOL, AQUA_TAIL, DEFENSE_CURL, DOUBLE_EDGE, HEADBUTT, ICY_WIND, ROLLOUT, SLEEP_TALK, SUBSTITUTE, SWAGGER, WATER_PULSE
	; end
