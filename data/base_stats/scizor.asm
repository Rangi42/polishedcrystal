	...
	; tmhm
	tmhm CURSE, TOXIC, SWORDS_DANCE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SAFEGUARD, RETURN, DOUBLE_TEAM, FLASH_CANNON, SANDSTORM, SWIFT, AERIAL_ACE, FACADE, REST, ATTRACT, THIEF, STEEL_WING, FURY_CUTTER, ROCK_SMASH, FALSE_SWIPE, X_SCISSOR, ENDURE, ACROBATICS, GIGA_IMPACT, U_TURN, CUT, FLY, STRENGTH, COUNTER, DOUBLE_EDGE, FIRE_PUNCH, HEADBUTT, ICE_PUNCH, IRON_HEAD, SLEEP_TALK, SUBSTITUTE, SWAGGER, THUNDERPUNCH
	; end
