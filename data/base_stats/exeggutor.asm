	...
	; tmhm
	tmhm CURSE, TOXIC, SWORDS_DANCE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, GIGA_DRAIN, SOLAR_BEAM, RETURN, PSYCHIC, DOUBLE_TEAM, REFLECT, SLUDGE_BOMB, REST, ATTRACT, THIEF, ENERGY_BALL, ENDURE, EXPLOSION, GIGA_IMPACT, FLASH, STRENGTH, DOUBLE_EDGE, DREAM_EATER, HEADBUTT, ROLLOUT, SEED_BOMB, SLEEP_TALK, SUBSTITUTE, SWAGGER, ZEN_HEADBUTT
	; end
