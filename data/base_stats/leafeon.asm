...
endc
	...
	; tmhm
	tmhm ROAR, TOXIC, SWORDS_DANCE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, SOLAR_BEAM, IRON_TAIL, RETURN, DIG, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWIFT, AERIAL_ACE, REST, ATTRACT, FURY_CUTTER, ROCK_SMASH, ENERGY_BALL, X_SCISSOR, ENDURE, GIGA_IMPACT, FLASH, STRENGTH, HEADBUTT, HYPER_VOICE, SEED_BOMB, SLEEP_TALK, SUBSTITUTE, SWAGGER
	; end
