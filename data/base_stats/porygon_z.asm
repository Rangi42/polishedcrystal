	...
	; tmhm
	tmhm TOXIC, HIDDEN_POWER, SUNNY_DAY, ICE_BEAM, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, SOLAR_BEAM, IRON_TAIL, THUNDERBOLT, THUNDER, RETURN, PSYCHIC, SHADOW_BALL, DOUBLE_TEAM, SWIFT, AERIAL_ACE, REST, THIEF, DARK_PULSE, ENDURE, THUNDER_WAVE, GIGA_IMPACT, FLASH, DREAM_EATER, ICY_WIND, SLEEP_TALK, SUBSTITUTE, SWAGGER, ZAP_CANNON, ZEN_HEADBUTT
	; end
