...
endc
	...
	; tmhm
	tmhm CURSE, TOXIC, SWORDS_DANCE, HIDDEN_POWER, SUNNY_DAY, HYPER_BEAM, PROTECT, GIGA_DRAIN, SOLAR_BEAM, RETURN, ROOST, DOUBLE_TEAM, SLUDGE_BOMB, SWIFT, AERIAL_ACE, FACADE, REST, ATTRACT, THIEF, FURY_CUTTER, ROCK_SMASH, LEECH_LIFE, FALSE_SWIPE, X_SCISSOR, ENDURE, ACROBATICS, POISON_JAB, GIGA_IMPACT, U_TURN, FLASH, CUT, DOUBLE_EDGE, SLEEP_TALK, SUBSTITUTE, SWAGGER
	; end
