	...
	; tmhm
	tmhm CURSE, CALM_MIND, ROAR, TOXIC, HAIL, HIDDEN_POWER, ICE_BEAM, BLIZZARD, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, REFLECT, SANDSTORM, STONE_EDGE, FACADE, REST, ATTRACT, ROCK_SLIDE, FURY_CUTTER, ROCK_SMASH, ENDURE, AVALANCHE, GIGA_IMPACT, STRENGTH, EARTH_POWER, HEADBUTT, ICY_WIND, IRON_HEAD, SLEEP_TALK, SUBSTITUTE, SWAGGER
	; end
