...
HarshSunAliasedMapGroups:
	...
	harsh_sun_area SUN_AREA_ROUTE_13, ROUTE_13
	...
	harsh_sun_area SUN_AREA_FARAWAY_ISLAND, FARAWAY_ISLAND_NORTH, FARAWAY_ISLAND_SOUTH
...
HarshSunMapsKanto:
	...
	harsh_sun_map SUN_AREA_FARAWAY_ISLAND
