...
ItemAttributes:
; # BALL
	item_attribute 200, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; GREAT BALL
	item_attribute 600, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; ULTRA BALL
	item_attribute 800, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; MASTER BALL
	item_attribute 0, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; SAFARI BALL
	item_attribute 200, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; LEVEL BALL
	item_attribute 150, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; LURE BALL
	item_attribute 150, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; MOON BALL
	item_attribute 150, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
...
; PARK BALL
	item_attribute 0, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; REPEAT BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; TIMER BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; NEST BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
...
; LUXURY BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; HEAL BALL
	item_attribute 300, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; QUICK BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; DUSK BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; DREAM BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; PREMIER BALL
	item_attribute 20, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; CHERISH BALL
	item_attribute 1000, 0, 0, BALL, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; POTION
...
; SITRUS BERRY
	item_attribute 10, HELD_BERRY, 30, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; FIGY BERRY
	item_attribute 10, HELD_BERRY, 50, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; POMEG BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_HP_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; KELPSY BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_ATK_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUALOT BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_DEF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HONDEW BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_SAT_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GREPA BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_SDF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TAMATO BERRY
	item_attribute 10, HELD_REDUCE_EV, MON_SPD_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI BERRY
...
; MAGMARIZER
	item_attribute 2000, 0, 0, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAZOR FANG
	item_attribute 5000, HELD_FLINCH_UP, 30, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; RAZOR CLAW
