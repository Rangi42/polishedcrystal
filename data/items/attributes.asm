...
; JABOCA BERRY
	item_attribute 10, HELD_OFFEND_HIT, PHYSICAL, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ROWAP BERRY
	item_attribute 10, HELD_OFFEND_HIT, SPECIAL, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; KEE BERRY
	item_attribute 10, HELD_DEFEND_HIT, PHYSICAL, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; MARANGABERRY
	item_attribute 10, HELD_DEFEND_HIT, SPECIAL, CANT_SELECT, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; SILK SCARF
