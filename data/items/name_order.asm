ItemNameOrder:
	...
	db NAM_PEWTERCRUNCH ; 38

	db NAM_SACRED_ASH   ; 39
	db NAM_ENERGYPOWDER ; 3a
	db NAM_ENERGY_ROOT  ; 3b
	db NAM_HEAL_POWDER  ; 3c
	db NAM_REVIVAL_HERB ; 3d

	db NAM_X_ATTACK     ; 3e
	db NAM_X_DEFEND     ; 3f
	db NAM_X_SPEED      ; 40
	db NAM_X_SPCL_ATK   ; 41
	db NAM_X_SPCL_DEF   ; 42
	db NAM_X_ACCURACY   ; 43
	db NAM_DIRE_HIT     ; 44
	db NAM_GUARD_SPEC   ; 45

	db NAM_REPEL        ; 46
	db NAM_SUPER_REPEL  ; 47
	db NAM_MAX_REPEL    ; 48
	db NAM_ESCAPE_ROPE  ; 49
	db NAM_POKE_DOLL    ; 4a

	db NAM_ABILITY_CAP  ; 4b

	db NAM_LEAF_STONE   ; 4c
	db NAM_FIRE_STONE   ; 4d
	db NAM_WATER_STONE  ; 4e
	db NAM_THUNDERSTONE ; 4f
	db NAM_MOON_STONE   ; 50
	db NAM_SUN_STONE    ; 51
	db NAM_DUSK_STONE   ; 52
	db NAM_SHINY_STONE  ; 53
	db NAM_ICE_STONE    ; 54
	db NAM_EVERSTONE    ; 55

	db NAM_EXP_SHARE    ; 56

	db NAM_TERU_SAMA_01 ; 57
	db NAM_TERU_SAMA_02 ; 58
	db NAM_TERU_SAMA_03 ; 59
	db NAM_TERU_SAMA_04 ; 5a
	db NAM_TERU_SAMA_05 ; 5b
	db NAM_TERU_SAMA_06 ; 5c
	db NAM_TERU_SAMA_07 ; 5d
	db NAM_TERU_SAMA_08 ; 5e
	db NAM_TERU_SAMA_09 ; 5f
	db NAM_TERU_SAMA_10 ; 60
	db NAM_TERU_SAMA_11 ; 61
	db NAM_TERU_SAMA_12 ; 62
	db NAM_TERU_SAMA_13 ; 63
	db NAM_TERU_SAMA_14 ; 64
	db NAM_TERU_SAMA_15 ; 65
	db NAM_TERU_SAMA_16 ; 66
	db NAM_TERU_SAMA_17 ; 67
	db NAM_TERU_SAMA_18 ; 68
	db NAM_TERU_SAMA_19 ; 69
	db NAM_TERU_SAMA_20 ; 6a
	db NAM_TERU_SAMA_21 ; 6b
	db NAM_TERU_SAMA_22 ; 6c
	db NAM_TERU_SAMA_23 ; 6d
	db NAM_TERU_SAMA_24 ; 6e
	db NAM_TERU_SAMA_25 ; 6f
	db NAM_TERU_SAMA_26 ; 70
	db NAM_TERU_SAMA_27 ; 71
	db NAM_TERU_SAMA_28 ; 72
	db NAM_TERU_SAMA_29 ; 73

	db NAM_CHERI_BERRY  ; 74
	db NAM_CHESTO_BERRY ; 75
	db NAM_PECHA_BERRY  ; 76
	db NAM_RAWST_BERRY  ; 77
	db NAM_ASPEAR_BERRY ; 78
	db NAM_LEPPA_BERRY  ; 79
	db NAM_ORAN_BERRY   ; 7a
	db NAM_PERSIM_BERRY ; 7b
	db NAM_LUM_BERRY    ; 7c
	db NAM_SITRUS_BERRY ; 7d
	db NAM_FIGY_BERRY   ; 7e
	db NAM_LIECHI_BERRY ; 7f
	db NAM_GANLON_BERRY ; 80
	db NAM_SALAC_BERRY  ; 81
	db NAM_PETAYA_BERRY ; 82
	db NAM_APICOT_BERRY ; 83
	db NAM_JABOCA_BERRY ; 84
	db NAM_ROWAP_BERRY  ; 85
	db NAM_KEE_BERRY    ; 86
	db NAM_MARANGABERRY ; 87
