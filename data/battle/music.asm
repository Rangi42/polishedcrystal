BattleMusic_Trainers:
	...
	dbw FACTORYHEAD,      MUSIC_FRONTIER_BRAIN_BATTLE_RSE
	dbw JESSIE_JAMES,     MUSIC_ROCKET_BATTLE
	dbw LORELEI,          MUSIC_KANTO_GYM_LEADER
	dbw AGATHA,           MUSIC_KANTO_GYM_LEADER
	...
	dbw MARLON,           MUSIC_GYM_LEADER_BATTLE_BW
	dbw VALERIE,          MUSIC_GYM_LEADER_BATTLE_XY
	dbw KUKUI,            MUSIC_TRAINER_BATTLE_SM
	dbw PIERS,            MUSIC_GYM_LEADER_BATTLE_SWSH
	dbw KATY,             MUSIC_GYM_LEADER_BATTLE_SWSH
	dbw WALKER,           MUSIC_JOHTO_GYM_LEADER_BATTLE
