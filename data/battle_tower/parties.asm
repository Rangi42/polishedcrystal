...
BattleTowerPokemon2:
	...
	db BRAVE_BIRD, STONE_EDGE, EARTHQUAKE, AQUA_TAIL
	db PERFECT_DVS
	db ABILITY_1 | JOLLY, MALE ; Rock Head, +Speed -SpAtk

	db ALAKAZAM, FOCUS_SASH
	db PSYCHIC, FOCUS_BLAST, SHADOW_BALL, THUNDER_WAVE
	db PERFECT_DVS
	...
	db PERFECT_DVS
	db ABILITY_1 | JOLLY, MALE ; Flash Fire, +Speed -Sp.Atk

	db AZUMARILL, CHOICE_BAND
	db AQUA_JET, PLAY_ROUGH, WATERFALL, CLOSE_COMBAT
	db PERFECT_DVS
	db ABILITY_2 | ADAMANT, FEMALE ; Huge Power, +Atk -Sp.Atk

	db DRAGONITE, CHOICE_BAND
	db OUTRAGE, FIRE_PUNCH, EARTHQUAKE, EXTREMESPEED
	db PERFECT_DVS
	db HIDDEN_ABILITY | ADAMANT, MALE ; Multiscale, +Atk -Sp.Atk

if DEF(FAITHFUL)
	db DUGTRIO, CHOICE_BAND
	db EARTHQUAKE, STONE_EDGE, SUCKER_PUNCH, PURSUIT
	db PERFECT_DVS
	db ABILITY_2 | JOLLY, MALE ; Arena Trap, +Speed -Sp.Atk
else
	db DUGTRIO, FOCUS_SASH
	db EARTHQUAKE, STONE_EDGE, SANDSTORM, IRON_HEAD
	db PERFECT_DVS
	db HIDDEN_ABILITY | JOLLY, MALE ; Arena Trap, +Speed -Sp.Atk
endc

	db ELECTIVIRE, EXPERT_BELT
	db THUNDERPUNCH, ICE_PUNCH, EARTHQUAKE, CLOSE_COMBAT
	db PERFECT_DVS
	db HIDDEN_ABILITY | JOLLY, MALE ; Vital Spirit,  +Speed -Sp.Atk

	db GENGAR, LIFE_ORB
	db SHADOW_BALL, SLUDGE_BOMB, FOCUS_BLAST, SUBSTITUTE
	db PERFECT_DVS
	db HIDDEN_ABILITY | TIMID, FEMALE ; Shadow Tag, +Speed -Atk

	db GLISCOR, TOXIC_ORB
	db SWORDS_DANCE, EARTHQUAKE, ROOST, KNOCK_OFF
	db PERFECT_DVS
	db HIDDEN_ABILITY | CAREFUL, MALE ; Poison Heal, +SpDef -SpAtk

	db GYARADOS, LIFE_ORB
	db DRAGON_DANCE, WATERFALL, STONE_EDGE, EARTHQUAKE
	db PERFECT_DVS
	db ABILITY_1 | ADAMANT, MALE ; Intimidate, +Atk -SpAtk

	db HERACROSS, CHOICE_SCARF
	db CLOSE_COMBAT, MEGAHORN, STONE_EDGE, NIGHT_SLASH
	db PERFECT_DVS
	db HIDDEN_ABILITY | JOLLY, FEMALE ; Moxie, +Speed -SpAtk

	db HONCHKROW, LIFE_ORB
	db BRAVE_BIRD, SUCKER_PUNCH, ROOST, SUBSTITUTE
	db PERFECT_DVS
	db HIDDEN_ABILITY | ADAMANT, MALE ; Moxie, +Atk -SpAtk

	db JOLTEON, CHOICE_SPECS
	db THUNDERBOLT, SHADOW_BALL, VOLT_SWITCH, HIDDEN_POWER
	db BTDVS_HP_ICE
	db ABILITY_1 | TIMID, MALE ; Volt Absorb, +Speed -Atk

	db MACHAMP, FOCUS_SASH
	db DYNAMICPUNCH, BULLET_PUNCH, ICE_PUNCH, KNOCK_OFF
	db PERFECT_DVS
	db ABILITY_2 | ADAMANT, FEMALE ; No Guard, +Atk -SpAtk

	db MAGNEZONE, CHOICE_SCARF
	db THUNDERBOLT, VOLT_SWITCH, FLASH_CANNON, HIDDEN_POWER
	db BTDVS_HP_FIRE
	db ABILITY_1 | TIMID, MALE ; Magnet Pull, +Speed -Atk

	db MAMOSWINE, LIFE_ORB
	db ICE_SHARD, ICICLE_CRASH, EARTHQUAKE, STONE_EDGE
	db PERFECT_DVS
	db HIDDEN_POWER | ADAMANT, MALE ; Thick Fat, +Atk -SpAtk

	db MISMAGIUS, LIFE_ORB
	db NASTY_PLOT, SHADOW_BALL, DAZZLINGLEAM, FLAMETHROWER
	db PERFECT_DVS
	db ABILITY_1 | TIMID, FEMALE ; Levitate, +Speed -Atk

	db RHYPERIOR, LEFTOVERS
	db EARTHQUAKE, STONE_EDGE, TOXIC, SUBSTITUTE
	db PERFECT_DVS
	...
	db SPIKES, ROAR, DRILL_PECK, TOXIC
	db PERFECT_DVS
	db ABILITY_1 | CAREFUL, FEMALE ; Keen Eye, +SpDef -SpAtk

	db SLOWBRO, LEFTOVERS
	db CALM_MIND, SCALD, RECOVER, PSYCHIC
	db PERFECT_DVS
	db HIDDEN_ABILITY | BOLD, MALE ; Refrigerator, +Def -Atk
	db $ff

BattleTowerMons2:
	db STARMIE, LIFE_ORB
	db SURF, THUNDERBOLT, ICE_BEAM, RECOVER
	db PERFECT_DVS
	db ABILITY_2 | TIMID, MALE ; Natural Cure, +Speed -SpAtk
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, RETURN, FRESH_SNACK, COUNTER
	db $fb, $df, $bb ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons3:
	...
	db BLISSEY
	db LEFTOVERS
	db TOXIC, REFLECT, FRESH_SNACK, PROTECT
	db $ef, $be, $ff ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons6:
	...
	db BLISSEY
	db LEFTOVERS
	db FRESH_SNACK, TOXIC, PROTECT, PSYCHIC_M
	db $cf, $bc, $ff ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons7:
	...
	db BLISSEY
	db SITRUS_BERRY
	db COUNTER, FRESH_SNACK, SHADOW_BALL, THUNDERBOLT
	db $ed, $fe, $dd ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons9:
	...
	db BLISSEY
	db LEFTOVERS
	db SOLAR_BEAM, SUNNY_DAY, FRESH_SNACK, FIRE_BLAST
	db $fb, $df, $bb ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
	...
	db TOGEKISS
	db LEFTOVERS
	db FRESH_SNACK, ANCIENTPOWER, AIR_SLASH, FOCUS_BLAST
	db $ff, $ef, $ff ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
	...
	db MILTANK
	db LEFTOVERS
	db FRESH_SNACK, EARTHQUAKE, ATTRACT, BODY_SLAM
	db $54, $75, $44 ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
...
BattleTowerMons10:
	...
	db BLISSEY
	db LEFTOVERS
	db THUNDERBOLT, BLIZZARD, FIRE_BLAST, FRESH_SNACK
	db $fd, $df, $dd ; DVs
	db ABILITY_1 | QUIRKY, MALE ; Personality
