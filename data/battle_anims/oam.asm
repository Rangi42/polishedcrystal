...
; entries correspond to BATTLEANIMOAMSET_* constants
	...
	battleanimoam $0a,  8, .OAMData_48               ; BATTLEANIMOAMSET_48
	...
	battleanimoam $00,  6, .OAMData_113              ; BATTLEANIMOAMSET_113
	battleanimoam $06,  6, .OAMData_113              ; BATTLEANIMOAMSET_114
	battleanimoam $0c,  6, .OAMData_113              ; BATTLEANIMOAMSET_115
	battleanimoam $10,  2, .OAMData_11               ; BATTLEANIMOAMSET_116
	battleanimoam $12,  8, .OAMData_48               ; BATTLEANIMOAMSET_117
	battleanimoam $1b,  4, .OAMData_03               ; BATTLEANIMOAMSET_TORMENT
	battleanimoam $00,  4, .OAMData_Roots1           ; BATTLEANIMOAMSET_ROOTS_1
	battleanimoam $04,  6, .OAMData_Roots2           ; BATTLEANIMOAMSET_ROOTS_2
	battleanimoam $0a,  5, .OAMData_Roots3           ; BATTLEANIMOAMSET_ROOTS_3
	battleanimoam $00, 26, .OAMData_CP_BG            ; BATTLEANIMOAMSET_CP_BG
	...
	battleanimoam $03,  2, .OAMData_MagnetRise       ; BATTLEANIMOAMSET_MAGNET_RISE
...
.OAMData_103:
	...
	dbsprite   0,  -1, 0,  3, $01, OAM_XFLIP | OAM_YFLIP
	dbsprite   1,  -1, 0,  3, $00, OAM_XFLIP | OAM_YFLIP
...
.OAMData_10a:
	dbsprite  -2,   1, 6, -1, $00, OAM_XFLIP | OAM_YFLIP
	dbsprite  -1,   0, 6,  0, $00, $0
	dbsprite  -1,  -1, 6,  0, $01, $0
	dbsprite  -1,  -2, 6,  0, $00, OAM_XFLIP | OAM_YFLIP

.OAMData_MudBomb:
	dbsprite  -2,  -2, 4, 4, $00, $0
	dbsprite  -1,  -2, 4, 4, $03, $0
	dbsprite   0,  -2, 4, 4, $06, $0
	dbsprite  -2,  -1, 4, 4, $01, $0
	dbsprite  -1,  -1, 4, 4, $04, $0
	dbsprite   0,  -1, 4, 4, $07, $0
	dbsprite  -2,   0, 4, 4, $02, $0
	dbsprite  -1,   0, 4, 4, $05, $0
	dbsprite   0,   0, 4, 4, $08, $0
...
.OAMData_113:
	dbsprite  -3,  -1, 0, 5, $00, $0
	dbsprite  -2,  -1, 0, 5, $01, $0
	dbsprite  -1,  -1, 0, 5, $02, $0
	dbsprite  -3,   0, 0, 5, $03, $0
	dbsprite  -2,   0, 0, 5, $04, $0
	dbsprite  -1,   0, 0, 5, $05, $0
