...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BIG_ROCK_STAR_HEART, BATTLEANIMFUNC_FALL_AND_STOP, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHOP ; ANIM_OBJ_VERTICAL_CHOP
