...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $86, BATTLEANIMFRAMESET_POISON_JAB, BATTLEANIMFUNC_DARK_PULSE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_2 ; ANIM_OBJ_DARK_PULSE
