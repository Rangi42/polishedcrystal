...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $8c, BATTLE_ANIM_FRAMESET_WATER_BALL, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_WATER_BALL ; ANIM_OBJ_HYDRO_PUMP_SHOT
	battleanimobj RELATIVE_X, $98, BATTLE_ANIM_FRAMESET_RAZOR_LEAF_1, BATTLE_ANIM_FUNC_RAZOR_LEAF, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_PETALS ; ANIM_OBJ_PETAL_DANCE_IMPACT
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLE_ANIM_FRAMESET_MIST, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_HAZE ; ANIM_OBJ_SHOOTING_MIST
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLE_ANIM_FRAMESET_GROWING_BALL, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_GLOW ; ANIM_OBJ_GROWING_BALL
