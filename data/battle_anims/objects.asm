...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_POISON_JAB, BATTLEANIMFUNC_RADIAL_MOVE_IN_XYFIX, PAL_BATTLE_OB_BLUE, ANIM_GFX_OBJECTS_2 ; ANIM_OBJ_POISON_JAB
