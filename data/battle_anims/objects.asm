...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_3E, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_HONE_CLAWS_LEFT
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_3F, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, $02 ; ANIM_OBJ_HONE_CLAWS_RIGHT
