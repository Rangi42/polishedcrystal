...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_BIG_GLOW_CLEAR, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_YELLOW, ANIM_GFX_BIG_GLOW_CLEAR
	battleanimobj RELATIVE_X | X_FLIP, $94, BATTLEANIMFRAMESET_SWIRL_SHORT, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_SWIRL
