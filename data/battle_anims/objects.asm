...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_ECHOED_VOICE, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, ANIM_GFX_PSYCHIC ; ANIM_OBJ_ECHOED_VOICE
	...
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_ABSORB, PAL_BATTLE_OB_RED, ANIM_GFX_CHARGE ; ANIM_OBJ_ABSORB_RED
