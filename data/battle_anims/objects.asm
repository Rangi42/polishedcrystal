...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_CHERUB, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BLUE, ANIM_GFX_U_TURN ; ANIM_OBJ_U_TURN_LAUNCH
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_IMP, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_U_TURN ; ANIM_OBJ_U_TURN_RISE
