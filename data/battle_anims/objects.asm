...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_CROSS_CHOP_1, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHOP ; ANIM_OBJ_CROSS_CHOP1
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_CROSS_CHOP_2, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_GRAY, ANIM_GFX_CHOP ; ANIM_OBJ_CROSS_CHOP2
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BIG_ROCK_STAR_HEART, BATTLEANIMFUNC_FALL_AND_STOP, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHOP ; ANIM_OBJ_VERTICAL_CHOP
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BIG_ROCK_STAR_HEART, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHOP ; ANIM_OBJ_VERTICAL_CHOP_STILL
	...
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BIG_ROCK_STAR_HEART, BATTLEANIMFUNC_ROCK_SMASH, PAL_BATTLE_OB_GRAY, ANIM_GFX_SCREEN_DEBRIS ; ANIM_OBJ_SCREEN_DEBRIS
