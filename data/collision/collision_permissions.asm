CollisionPermissionTable::
	...
	db LAND_TILE  ; COLL_CAMPFIRE_GLOW
	db LAND_TILE  ; COLL_AQUARIUM_GLOW
	...
	db LAND_TILE  ; COLL_CAVE_MOUTH_GLOW
	db LAND_TILE  ; COLL_LADDER_GLOW
	...
	db LAND_TILE  ; COLL_RIGHT_WALL_GLOW
	db LAND_TILE  ; COLL_LEFT_WALL_GLOW
	db LAND_TILE  ; ba
	db LAND_TILE  ; bb
	db LAND_TILE  ; bc
	db LAND_TILE  ; bd
