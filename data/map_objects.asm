...
endm
	...
	sprite_movement_data SPRITEMOVEFN_STANDING,              UP,     PERSON_ACTION_STAND,    $0c,    $00,    %0000 ; 12
	...
	sprite_movement_data SPRITEMOVEFN_STRENGTH,              UP,     PERSON_ACTION_STAND,    $2e,    $00,    %0100 ; 19
