...
endm
	...
	sprite_movement_data SPRITEMOVEFN_STAND_DOWN_FLIP,       DOWN,   PERSON_ACTION_DOWN_FLIP,    $00,    $00,    %0000 ; SPRITEMOVEDATA_STANDING_DOWN_FLIP
	sprite_movement_data SPRITEMOVEFN_STAND_UP_FLIP,         UP,     PERSON_ACTION_UP_FLIP,      $00,    $00,    %0000 ; SPRITEMOVEDATA_STANDING_UP_FLIP
