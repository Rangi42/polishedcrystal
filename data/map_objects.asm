...
endm
	...
	sprite_movement_data SPRITEMOVEFN_POKECOM_NEWS,          DOWN,   PERSON_ACTION_POKECOM_NEWS,  $8e,    $02,    %0000 ; SPRITEMOVEDATA_POKECOM_NEWS_DOWN
	sprite_movement_data SPRITEMOVEFN_POKECOM_NEWS,          UP,     PERSON_ACTION_POKECOM_NEWS,  $8e,    $02,    %0000 ; SPRITEMOVEDATA_POKECOM_NEWS_UP
