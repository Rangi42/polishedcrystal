...
WaterAbsorb:   db "Wate", "r Absorb@"
Oblivious:     db "Oblivious@"
CloudNine:     db "Cloud Ni", "ne@"
...
Prankster:     db "Prankste", "r@"
SandForce:     db "Sa", "nd Force@"
FurCoat:       db "Fur Coat@"
Competitive:   db "Competitive@"
Pixilate:      db "Pixilate@"
TanglingHair:  db "Tangli", "ng Hair@"
