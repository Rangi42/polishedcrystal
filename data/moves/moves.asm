...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move ACROBATICS,   EFFECT_CONDITIONAL_BOOST,  60, FLYING,    100, 15,   0, PHYSICAL
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         55, FIGHTING,  100, 25,   0, PHYSICAL
	move DOUBLE_SLAP,  EFFECT_MULTI_HIT,          25, NORMAL,     95, 10,   0, PHYSICAL
	...
	move PAY_DAY,      EFFECT_PAY_DAY,            77, NORMAL,    100, 20,   0, PHYSICAL
	...
	move CUT,          EFFECT_FLINCH_HIT,         70, STEEL,     100, 25,  10, PHYSICAL
	...
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        100, ROCK,       90,  5,   0, PHYSICAL
	...
	move HEX,          EFFECT_CONDITIONAL_BOOST,  66, GHOST,     100, 10,   0, SPECIAL
	...
	move POISON_STING, EFFECT_POISON_HIT,         35, POISON,    100, 35,  30, PHYSICAL
	move U_TURN,       EFFECT_SWITCH_HIT,         70, BUG,       100, 20,   0, PHYSICAL
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          30, BUG,        95, 20,   0, PHYSICAL
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,     70, 20,   0, STATUS
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,      90,  5,   0, SPECIAL
	move SURF,         EFFECT_NORMAL_HIT,         90, WATER,     100, 15,   0, SPECIAL
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         90, ICE,       100, 10,  10, SPECIAL
	move BLIZZARD,     EFFECT_FREEZE_HIT,        100, ICE,        90,  5,  30, SPECIAL
	...
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    80, ICE,       100, 20,  25, SPECIAL
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         85, FIGHTING,  100, 15,   0, PHYSICAL
	...
	move THUNDER,      EFFECT_THUNDER,           100, ELECTRIC,   90, 10,  30, SPECIAL
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         60, ROCK,      100, 15,   0, PHYSICAL
	move EARTHQUAKE,   EFFECT_EARTHQUAKE,        100, GROUND,    100, 10,   0, PHYSICAL
	move AVALANCHE,    EFFECT_CONDITIONAL_BOOST,  70, ICE,       100, 10,   0, PHYSICAL
	...
	move RAGE,         EFFECT_RAGE,               30, NORMAL,    100, 20,   0, PHYSICAL
	...
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          25, ROCK,       95, 25,   0, PHYSICAL
	...
	move AQUA_TAIL,    EFFECT_NORMAL_HIT,         85, WATER,     100, 10,   0, PHYSICAL
	...
	move LICK,         EFFECT_PARALYZE_HIT,       40, GHOST,     100, 30,  10, PHYSICAL
	move GUNK_SHOT,    EFFECT_POISON_HIT,        110, POISON,     90,  5,  30, PHYSICAL
	...
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,       90,  5,  30, SPECIAL
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,     100, 15,  20, PHYSICAL
	move ICICLE_CRASH, EFFECT_FLINCH_HIT,         80, ICE,       100, 10,  30, PHYSICAL
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          70, BUG,       100, 15,   0, PHYSICAL
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  40, NORMAL,    100, 15, 100, SPECIAL
	...
	move CRABHAMMER,   EFFECT_PARALYZE_HIT,      100, WATER,     100, 10,  10, PHYSICAL
	move EXPLOSION,    EFFECT_EXPLOSION,         250, NORMAL,    100,  5,   0, PHYSICAL
	move FURY_STRIKES, EFFECT_MULTI_HIT,          20, NORMAL,     95, 15,   0, PHYSICAL
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,    100, 10,   0, PHYSICAL
	move REST,         EFFECT_HEAL,                0, PSYCHIC,   100, 5,    0, STATUS
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,       95, 10,  30, PHYSICAL
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,     95, 15,  10, PHYSICAL
	...
	move THIEF,        EFFECT_THIEF,              70, DARK,      100, 25, 100, PHYSICAL
	...
	move AEROBLAST,    EFFECT_SP_DEF_DOWN_HIT,   100, FLYING,    100,  5,  20, SPECIAL
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  90, WATER,     100, 10,  50, SPECIAL
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,   60,  5, 100, SPECIAL
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     60, ICE,       100, 15, 100, SPECIAL
	...
	move POWER_WHIP,   EFFECT_NORMAL_HIT,        120, GRASS,      90, 10,   0, PHYSICAL
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,   60,  5, 100, PHYSICAL
	move MEGAHORN,     EFFECT_NORMAL_HIT,        120, BUG,        90, 10,   0, PHYSICAL
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       70, DRAGON,    100, 20,  30, SPECIAL
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,      85, 15,  25, PHYSICAL
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         50, ROCK,      100,  5,  50, SPECIAL
...
endc
	move WHIRLPOOL,    EFFECT_TRAP,               70, WATER,      90, 15,   0, SPECIAL
