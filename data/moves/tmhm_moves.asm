TMHMMoves:
	...
	db FIRE_PUNCH   ; MT11 (Goldenrod City)
	db HEADBUTT     ; MT12 (Ilex Forest)
	db HYPER_VOICE  ; MT13 (Goldenrod Harbor)
	db ICE_PUNCH    ; MT14 (Goldenrod City)
	db ICY_WIND     ; MT15 (Ice Path)
	db IRON_HEAD    ; MT16 (Route 4)
	db KNOCK_OFF    ; MT17 (Route 40)
	db PAY_DAY      ; MT18 (Goldenrod Game Corner)
	db ROLLOUT      ; MT20 (Route 46)
	db SEED_BOMB    ; MT19 (Yellow Forest)
	db SEISMIC_TOSS ; MT21 (Pewter City)
	db SKILL_SWAP   ; MT22 (Route 27)
	db SLEEP_TALK   ; MT23 (Route 31)
