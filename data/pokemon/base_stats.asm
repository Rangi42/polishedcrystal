...
INCLUDE "data/pokemon/base_stats/cribnal.asm"
INCLUDE "data/pokemon/base_stats/cuardhart.asm"
...
INCLUDE "data/pokemon/base_stats/tidiposs.asm"
INCLUDE "data/pokemon/base_stats/scourposs.asm"
