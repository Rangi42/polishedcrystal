...
PidgeotEvosAttacks:
	...
	db 38, WING_ATTACK
	db 40, ROOST
	db 45, DRILL_PECK ; Tailwind → new move
	db 48, STEEL_WING ; Mirror Move → TM move
	db 51, AIR_SLASH
	db 60, HURRICANE
	db -1 ; no more level-up moves
...
ArbokEvosAttacks:
	...
	db 46, IRON_TAIL ; Belch → TM move
	db 51, HAZE
	db 52, BULK_UP ; Coil → TM move
	db 55, GUNK_SHOT
	db -1 ; no more level-up moves
...
SandshrewAlolanEvosAttacks:
	evo_data EVOLVE_LEVEL, 22, SANDSLASH, ALOLAN_FORM
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, DEFENSE_CURL
...
NidoqueenEvosAttacks:
	...
	db 45, POISON_JAB
	db 50, EARTH_POWER
	db 55, CLOSE_COMBAT ; Superpower → similar move
	db -1 ; no more level-up moves
...
NidokingEvosAttacks:
	...
	db 1, DOUBLE_KICK
	db 1, POISON_STING
	db 20, OUTRAGE ; Chip Away → HGSS tutor move
	db 21, HORN_ATTACK
	db 25, SWEET_KISS ; Helping Hand → event move
	db 31, TOXIC_SPIKES
	db 33, HEALINGLIGHT ; Flatter → event move (Morning Sun)
	...
	db 43, CHARM ; Captivate → egg move
	db 50, EARTH_POWER
	db 55, MEGAHORN ; Horn Drill → Nidoking move
	db -1 ; no more level-up moves
...
GolbatEvosAttacks:
	evo_data EVOLVE_LEVEL, 38, CROBAT
	db -1 ; no more evolutions
	db 1, SCREECH
	db 1, ABSORB
...
VileplumeEvosAttacks:
	...
	db 35, TOXIC
	db 39, GROWTH
	db 42, HYPER_VOICE ; Natural Gift → tutor move
...
PoliwrathEvosAttacks:
	...
	db 32, DYNAMICPUNCH
	db 37, BELLY_DRUM
	db 40, GROWTH ; Wake-Up Slap → event move
...
KadabraEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, ALAKAZAM
	db -1 ; no more evolutions
	db 1, TELEPORT
...
MachokeEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, MACHAMP
	db -1 ; no more evolutions
	db 1, LOW_KICK
	db 1, LEER
	db 3, FOCUS_ENERGY
...
VictreebelEvosAttacks:
	...
	db 24, ACID
	db 29, KNOCK_OFF
	db 30, SWEET_KISS ; Sweet Scent → event move
...
GravelerPlainEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, GOLEM, PLAIN_FORM
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, DEFENSE_CURL
	db 4, MUD_SLAP ; Mud Sport → TM move
...
GravelerAlolanEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, GOLEM, ALOLAN_FORM
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, DEFENSE_CURL
	db 4, THUNDERSHOCK ; Charge → new move
...
SlowpokePlainEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 32, SLOWBRO, PLAIN_FORM
	db -1 ; no more evolutions
	db 1, CURSE
	db 1, TACKLE
	db 5, GROWL
	...
	db 45, PSYCHIC_M
	db 49, RAIN_DANCE
	db 51, BELLY_DRUM ; Psych Up → egg move
	db 55, RECOVER ; Heal Pulse → similar move
	db -1 ; no more level-up moves

SlowpokeGalarianEvosAttacks:
	evo_data EVOLVE_HOLDING, KINGS_ROCK, TR_ANYTIME, SLOWKING, GALARIAN_FORM
	evo_data EVOLVE_LEVEL, 32, SLOWBRO, GALARIAN_FORM
	db -1 ; no more evolutions
	db 1, CURSE
	db 1, TACKLE
	db 5, GROWL
...
SlowbroPlainEvosAttacks:
	...
	db 46, PSYCHIC_M
	db 50, RAIN_DANCE
	db 52, BELLY_DRUM ; Psych Up → egg move
	db 54, RECOVER ; Heal Pulse → similar move
	db -1 ; no more level-up moves
...
MukPlainEvosAttacks:
	...
	db 40, GUNK_SHOT
	db 41, TOXIC
	db 42, TOXIC_SPIKES ; Belch → SV TM move
...
CloysterEvosAttacks:
	...
	db 28, ICE_SHARD ; Clamp → Ice Shard
	db 32, BUBBLE_BEAM ; Razor Shell → egg move
	db 33, PIN_MISSILE ; Sw/Sh TM move
	db 37, AURORA_BEAM
	db 40, WHIRLPOOL
	db 44, EXPLOSION ; Brine → RBY TM move
	db 49, BARRIER ; Iron Defense → egg move
...
HaunterEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, GENGAR
	db -1 ; no more evolutions
...
OnixEvosAttacks:
	...
	db 46, STONE_EDGE
	db 49, DOUBLE_EDGE
	db 50, EARTHQUAKE ; Sandstorm → TM move
	db -1 ; no more level-up moves
...
ExeggutorPlainEvosAttacks:
	...
	db 14, CONFUSION
	db 17, RAGE ; Bullet Seed → RBY TM move
	db 18, LOW_KICK ; Psyshock → HGSS tutor move
	db 19, STUN_SPORE
	db 21, POISONPOWDER
	db 23, SLEEP_POWDER
	db 27, PSYBEAM ; Confusion → LGPE move
	...
	db 33, ANCIENTPOWER ; Worry Seed → HGSS tutor move
	db 37, HEALINGLIGHT ; Natural Gift → new move
	db 39, POWER_WHIP ; Wood Hammer → new move
	db 43, SOLAR_BEAM
	db 47, EXTRASENSORY
	db 48, PETAL_DANCE ; Leaf Storm → new move
	db 50, PSYCHIC_M ; Bestow → TM move
	db -1 ; no more level-up moves
...
ExeggutorAlolanEvosAttacks:
	...
	db 40, HEALINGLIGHT ; Natural Gift → new move
	db 46, EXTRASENSORY
...
LickitungEvosAttacks:
	evo_data EVOLVE_LEVEL, 44, LICKILICKY
	db -1 ; no more evolutions
	db 1, LICK
	db 5, SUPERSONIC
	db 9, DEFENSE_CURL
...
RhyhornEvosAttacks:
	evo_data EVOLVE_LEVEL, 40, RHYDON
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, MUD_SLAP ; Sand-Attack → similar move
	db 1, LEER ; Tail Whip → similar move
...
RhydonEvosAttacks:
	evo_data EVOLVE_LEVEL, 60, RHYPERIOR
	db -1 ; no more evolutions
	...
	db 59, MEGAHORN ; Horn Drill → Megahorn
	db -1 ; no more level-up moves

ChanseyEvosAttacks:
	evo_data EVOLVE_LEVEL, 40, BLISSEY
	db -1 ; no more evolutions
	db 1, DEFENSE_CURL
	db 1, TACKLE ; Pound → similar move
	db 1, GROWL
...
TangelaEvosAttacks:
	evo_data EVOLVE_LEVEL, 42, TANGROWTH
	db -1 ; no more evolutions
...
TaurosPaldeanWaterEvosAttacks:
	...
	db 48, SWAGGER
	db 55, THRASH
	db 58, AQUA_TAIL ; Wave Crash → tutor move
	db 61, CLOSE_COMBAT
	db 70, OUTRAGE ; HGSS tutor move
	db -1 ; no more level-up moves
...
PorygonEvosAttacks:
	...
	db 10, AGILITY
	db 15, RECOVER
	db 20, GROWTH ; Magnet Rise → new move
	db 25, AURORA_BEAM ; Signal Beam → new move
	db 30, THUNDER_WAVE ; Recycle → TM move
	db 35, BARRIER ; Discharge → event move
	db 40, THUNDERBOLT ; Lock-On → TM move
	db 50, TRI_ATTACK
	db 55, MIRROR_COAT ; Magic Coat → new move
	db 60, ZAP_CANNON
	db -1 ; no more level-up moves
...
KabutopsEvosAttacks:
	...
	db 46, ANCIENTPOWER
	db 51, LEECH_LIFE ; Wring Out → LGPE move
	db 56, NIGHT_SLASH
	db 61, SHELL_SMASH ; new move
	db -1 ; no more level-up moves
...
SnorlaxEvosAttacks:
	...
	db 53, GUNK_SHOT ; Snatch → egg move
	db 56, DOUBLE_EDGE ; Last Resort → egg move
	db 60, GIGA_IMPACT	
	db -1 ; no more level-up moves
...
ArticunoPlainEvosAttacks:
	...
	db 57, HAIL
	db 60, ROOST
	db 61, REFLECT ; Tailwind → Reflect
	db 68, BRAVE_BIRD ; Sheer Cold → new move
	db 72, HURRICANE
	db 79, AEROBLAST ; new move
	db -1 ; no more level-up moves
...
ArticunoGalarianEvosAttacks:
	...
	db 50, AIR_SLASH ; Reflect → new move
	db 57, DREAM_EATER
	db 59, REFLECT ; Tailwind → Reflect
	db 60, FUTURE_SIGHT
	db 61, BRAVE_BIRD ; Sheer Cold → TR move
	db 68, RECOVER
	db 72, HURRICANE
	db 79, AEROBLAST ; new move
	db -1 ; no more level-up moves
...
ZapdosPlainEvosAttacks:
	...
	db 57, RAIN_DANCE
	db 59, LIGHT_SCREEN
	db 60, THUNDER ; Drill Peck → Thunder
	db 61, BRAVE_BIRD ; Thunder → new move
	db 68, ROOST
	db 72, HURRICANE ; Zap Cannon → new move
	db 79, ZAP_CANNON
	db -1 ; no more level-up moves
...
ZapdosGalarianEvosAttacks:
	...
	db 59, LIGHT_SCREEN
	db 60, CLOSE_COMBAT
	db 61, BRAVE_BIRD ; Counter → TR move
	db 68, HI_JUMP_KICK ; Quick Guard → new move
	db 72, HURRICANE
	db 79, REVERSAL
	db -1 ; no more level-up moves
...
MoltresPlainEvosAttacks:
	...
	db 50, AIR_SLASH
	db 57, SUNNY_DAY
	db 59, WILL_O_WISP ; Heat Wave → event move
	db 60, FIRE_BLAST ; Solar Beam → TM move
	db 61, BRAVE_BIRD ; Sky Attack → new move
	db 68, ROOST
	db 72, HURRICANE
	db 79, SOLAR_BEAM
	db -1 ; no more level-up moves
...
MoltresGalarianEvosAttacks:
	...
	db 59, DARK_PULSE ; Fiery Wrath → similar move
	db 60, HEX ; Nasty Plot → TR move
	db 61, BRAVE_BIRD ; Sky Attack → new move
	db 68, PAIN_SPLIT ; Memento → new move
	db 72, HURRICANE
	db 79, NIGHT_SLASH ; new move
	db -1 ; no more level-up moves
...
MewtwoEvosAttacks:
	...
	db 19, SWIFT
	db 25, FUTURE_SIGHT
	db 30, BARRIER ; Psych Up → Barrier
	db 40, RECOVER
	db 44, PSYCHIC_M
	db 50, POWER_GEM ; Barrier → SV TM move
	db 55, AURA_SPHERE
	db 58, AMNESIA
	db 61, NASTY_PLOT ; Mist → Mew move
	db 65, PSYSTRIKE
	db -1 ; no more level-up moves
...
MewEvosAttacks:
	...
	db 35, BARRIER
	db 40, ANCIENTPOWER
	db 45, BATON_PASS ; Amnesia → Baton Pass
	db 50, SAFEGUARD ; Me First → Mewtwo move
	db 55, AMNESIA ; Baton Pass → Amnesia
	db 60, NASTY_PLOT
	db 65, AURA_SPHERE
	db -1 ; no more level-up moves
...
BayleefEvosAttacks:
	...
	db 36, ENERGY_BALL ; Natural Gift → tutor move
...
MeganiumEvosAttacks:
	...
	db 46, BODY_SLAM
	db 50, SAFEGUARD
	db 52, PLAY_ROUGH ; Aromatherapy → new move
	db 55, SOLAR_BEAM
	db 57, HEAL_BELL ; Aromatherapy → similar move
	db 61, OUTRAGE ; HGSS tutor move
	db 68, MOONBLAST ; new move
	db -1 ; no more level-up moves
...
TyphlosionPlainEvosAttacks:
	...
	db 24, FLAME_CHARGE ; Defense Curl → Flame Charge
	db 31, SWIFT
	db 33, DIG ; Flame Charge → TM move
	db 38, REVERSAL ; Lava Plume → egg move
	db 42, FLAMETHROWER
	db 45, EARTH_POWER ; Inferno → new move
	db 48, ROLLOUT
	db 50, DOUBLE_EDGE
	db 53, EARTHQUAKE ; Burn Up → TM move
	db 55, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
TyphlosionHisuianEvosAttacks:
	...
	db 31, SWIFT
	db 35, HEX
	db 40, WILL_O_WISP ; Lava Plume → TM move
	db 42, FLAMETHROWER
	db 45, SHADOW_BALL
	db 48, ROLLOUT
	db 50, DOUBLE_EDGE
	db 53, DARK_PULSE ; Infernal Parade → new move
	db 55, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
CroconawEvosAttacks:
	evo_data EVOLVE_LEVEL, 32, FERALIGATR
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, LEER
	db 6, WATER_GUN
...
FeraligatrEvosAttacks:
	...
	db 50, CRABHAMMER
	db 52, THRASH
	db 55, OUTRAGE ; HGSS tutor move
	db 57, AQUA_TAIL
	db 61, CLOSE_COMBAT ; Superpower → similar move
	db 68, HYDRO_PUMP
	db -1 ; no more level-up moves
...
PichuEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 16, PIKACHU
	db -1 ; no more evolutions
	db 1, THUNDERSHOCK
	db 1, CHARM
	db 5, LEER ; Tail Whip → similar move
...
CleffaEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 16, CLEFAIRY
	db -1 ; no more evolutions
	db 1, SPLASH
	db 1, TACKLE ; Pound → similar move
...
IgglybuffEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 16, JIGGLYPUFF
	db -1 ; no more evolutions
	db 1, SING
	db 1, TACKLE ; Pound → similar move
...
TogepiEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 25, TOGETIC
	db -1 ; no more evolutions
	db 1, GROWL
	db 1, CHARM
	db 5, METRONOME
...
BellossomEvosAttacks:
	...
	db 59, PETAL_DANCE
	db 69, SOLAR_BEAM
	db 70, PLAY_ROUGH ; Leaf Storm → Sw/Sh move
	db -1 ; no more level-up moves
...
AipomEvosAttacks:
	evo_data EVOLVE_LEVEL, 36, AMBIPOM
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, LEER ; Tail Whip → similar move
...
SunkernEvosAttacks:
	evo_data EVOLVE_LEVEL, 26, SUNFLORA
	db -1 ; no more evolutions
...
YanmaEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 40, YANMEGA
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, FORESIGHT
	db 1, BUG_BITE
...
MurkrowEvosAttacks:
	evo_data EVOLVE_LEVEL, 34, HONCHKROW
	db -1 ; no more evolutions
	db 1, PECK
	db 1, ASTONISH
	db 5, PURSUIT
...
MisdreavusEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 41, MISMAGIUS
	db -1 ; no more evolutions
	db 1, GROWL
...
GirafarigEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 41, FARIGIRAF
...
GligarEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 46, GLISCOR
	db -1 ; no more evolutions
	db 1, POISON_STING
	db 4, MUD_SLAP ; Sand Attack → similar move
...
SneaselPlainEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 45, WEAVILE
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, LEER
...
SneaselHisuianEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 45, SNEASLER
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, LEER
	db 1, BITE ; Taunt → egg move
...
UrsaringEvosAttacks:
	...
	db 58, THRASH
	db 61, CLOSE_COMBAT ; Hammer Arm → new move
	db 66, DOUBLE_EDGE ; new move
	db -1 ; no more level-up moves

SlugmaEvosAttacks:
	evo_data EVOLVE_LEVEL, 32, MAGCARGO
	db -1 ; no more evolutions
...
PiloswineEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 46, MAMOSWINE
	db -1 ; no more evolutions
	db 1, ANCIENTPOWER
...
Porygon2EvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 50, PORYGON_Z
	db -1 ; no more evolutions
	db 1, TACKLE
	db 1, CONVERSION
	db 1, DEFENSE_CURL
...
StantlerEvosAttacks:
	evo_data EVOLVE_LEVEL, 40, WYRDEER
	db -1 ; no more evolutions
	db 1, TACKLE
	db 3, LEER
	db 7, ASTONISH
...
RaikouEvosAttacks:
	...
	db 36, REFLECT
	db 41, CRUNCH
	db 46, WILD_CHARGE ; Thunder Fang → TM move
	db 50, EXTREMESPEED ; Discharge → event move
	db 58, EXTRASENSORY
	db 60, RAIN_DANCE
	db 61, CALM_MIND
	db 65, AURA_SPHERE ; Thunder → event move
	db 68, THUNDER
	db 77, HIDDEN_POWER ; TM move
	db -1 ; no more level-up moves
...
EnteiEvosAttacks:
	...
	db 36, FLAMETHROWER
	db 43, SWAGGER
	db 46, FLAME_CHARGE ; Fire Fang → TM move
	db 50, EXTREMESPEED ; Lava Plume → event move
	db 58, EXTRASENSORY
	db 60, FIRE_BLAST
	db 61, CALM_MIND
...
SuicuneEvosAttacks:
	...
	db 43, MIRROR_COAT
	db 46, AIR_SLASH ; Ice Fang → event move
	db 50, EXTREMESPEED ; Tailwind → event move
	db 58, EXTRASENSORY
	db 60, HYDRO_PUMP
	db 61, CALM_MIND
	db 65, HYPER_BEAM ; Blizzard → TM move
	db 68, BLIZZARD
	db 77, HIDDEN_POWER ; TM move
	db -1 ; no more level-up moves
...
LugiaEvosAttacks:
	...
	db 60, RECOVER
	db 65, FUTURE_SIGHT
	db 66, REFLECT ; Natural Gift → TM move
	db 73, CALM_MIND
	db 79, HURRICANE ; Sky Attack → new move
	db -1 ; no more level-up moves
...
HoOhEvosAttacks:
	...
	db 60, RECOVER
	db 65, FUTURE_SIGHT
	db 66, LIGHT_SCREEN ; Natural Gift → TM move
	db 73, CALM_MIND
	db 79, BRAVE_BIRD ; Sky Attack → Brave Bird
	db -1 ; no more level-up moves
...
CelebiEvosAttacks:
	...
	db 25, ANCIENTPOWER
	db 30, BATON_PASS
	db 43, MOONBLAST ; Natural Gift → new move
	db 51, LIGHT_SCREEN ; Heal Block → TM move
	db 53, FUTURE_SIGHT
	db 55, HEAL_BELL ; Healing Wish → Heal Bell
	db 58, NASTY_PLOT ; Leaf Storm → event move
	db 60, PERISH_SONG
	db 66, AURA_SPHERE ; Sw/Sh move
	db -1 ; no more level-up moves

AzurillEvosAttacks:
	evo_data EVOLVE_HAPPINESS, TR_ANYTIME, MARILL
	evo_data EVOLVE_LEVEL, 16, MARILL
	db -1 ; no more evolutions
	db 1, SPLASH
	db 1, WATER_GUN
	db 2, GROWL ; Tail Whip → new move
...
HonchkrowEvosAttacks:
	...
	db 41, MEAN_LOOK
	db 45, BATON_PASS ; Foul Play → XD move
	db 47, NIGHT_SLASH ; Foul Play → Night Slash
	db 50, DRILL_PECK ; Tailwind → egg move
	db 55, SUCKER_PUNCH
	db 58, PERISH_SONG ; Torment → egg move
	db 60, BRAVE_BIRD ; Quash → egg move
	db 61, DARK_PULSE
	db -1 ; no more level-up moves
...
HappinyEvosAttacks:
	evo_data EVOLVE_HOLDING, OVAL_STONE, TR_ANYTIME, CHANSEY
	evo_data EVOLVE_LEVEL, 16, CHANSEY
	db -1 ; no more evolutions
	db 1, MINIMIZE
	db 1, TACKLE ; Pound → similar move
	db 1, METRONOME ; Copycat → egg move
...
MunchlaxEvosAttacks:
	...
	evo_data EVOLVE_LEVEL, 25, SNORLAX
	db -1 ; no more evolutions
...
MantykeEvosAttacks:
	evo_data EVOLVE_LEVEL, 25, MANTINE
	db -1 ; no more evolutions
	db 1, GUST ; event move
	db 1, TACKLE
	db 1, WATER_GUN ; Bubble → similar move
...
UrsalunaEvosAttacks:
	...
	db 49, CRUNCH ; Snore → egg move
	db 52, THRASH
	db 55, CLOSE_COMBAT ; Hammer Arm → SV TM move
	db 58, DOUBLE_EDGE ; new move
	db 60, GUNK_SHOT ; SV TM move
	db -1 ; no more level-up moves
