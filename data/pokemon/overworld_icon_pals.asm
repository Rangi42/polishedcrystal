...
OverworldMonIconColors::
	...
	iconpal RED, BLUE ; ARIADOS
	iconpal PURPLE, BLUE ; CROBAT
	...
	iconpal GRAY, BROWN ; SNEASLER
	iconpal PURPLE, GRAY ; OVERQWIL
...
endr
	...
	iconpal BLUE, RED ; DUDUNSPARCE, DUDUNSPARCE_THREE_SEGMENT_FORM

	iconpal GRAY, RED ; RATTATA, ALOLAN_FORM
	iconpal GRAY, RED ; RATICATE, ALOLAN_FORM
	iconpal RED, BROWN ; RAICHU, ALOLAN_FORM
	iconpal TEAL, GREEN ; SANDSHREW, ALOLAN_FORM
	iconpal TEAL, GREEN ; SANDSLASH, ALOLAN_FORM
	iconpal TEAL, RED ; VULPIX, ALOLAN_FORM
	iconpal TEAL, RED ; NINETALES, ALOLAN_FORM
	...
	iconpal GRAY, RED ; MOLTRES, GALARIAN_FORM
	...
	iconpal RED, GRAY ; VOLTORB, HISUIAN_FORM
	iconpal RED, GRAY ; ELECTRODE, HISUIAN_FORM
	iconpal PURPLE, BLUE ; TYPHLOSION, HISUIAN_FORM
	iconpal PURPLE, GRAY ; QWILFISH, HISUIAN_FORM
	iconpal GRAY, BLUE ; SNEASEL, HISUIAN_FORM

	iconpal BROWN, BLUE ; WOOPER, PALDEAN_FORM
	iconpal GRAY, BROWN ; TAUROS, PALDEAN_FORM
