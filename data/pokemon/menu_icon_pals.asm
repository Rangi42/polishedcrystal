...
MenuMonIconColors::
	...
	iconpal GRAY, GREEN ; RATTATA, ALOLAN_FORM
	iconpal GRAY, PURPLE ; RATICATE, ALOLAN_FORM
	iconpal BLUE, GREEN ; SANDSHREW, ALOLAN_FORM
	iconpal BLUE, RED ; SANDSLASH, ALOLAN_FORM
	iconpal BLUE, TEAL ; VULPIX, ALOLAN_FORM
	iconpal BLUE, PURPLE ; NINETALES, ALOLAN_FORM
