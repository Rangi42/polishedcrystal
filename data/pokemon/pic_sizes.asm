...
INCLUDE "gfx/pokemon/cribnal/front.dimensions"
INCLUDE "gfx/pokemon/cuardhart/front.dimensions"
...
INCLUDE "gfx/pokemon/tidiposs/front.dimensions"
INCLUDE "gfx/pokemon/scourposs/front.dimensions"
