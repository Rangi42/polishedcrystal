InitialEvents:
	...
	dw EVENT_KRISS_HOUSE_2F_CONSOLE
	dw EVENT_KRISS_HOUSE_2F_DOLL_1
	dw EVENT_KRISS_HOUSE_2F_DOLL_2
	dw EVENT_KRISS_HOUSE_2F_BIG_DOLL
	dw EVENT_DECO_BED_1
	...
	dw EVENT_KRISS_NEIGHBORS_HOUSE_NEIGHBOR
...
varspriteaddr EQUS "wVariableSprites - SPRITE_VARS +"
	...
	dwb wGoldenrodCityTrigger, $1
	dwb wBattleTowerOutsideTrigger, $1
	dwb wBellchimeTrailTrigger, $1
	dw -1
