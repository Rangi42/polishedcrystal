...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_STANDING,              DOWN,   PERSON_ACTION_STAND,           $0c,    $00,    %0000 ; SPRITEMOVEDATA_STILL
	...
	sprite_movement_data SPRITEMOVEFN_FRUIT,                 DOWN,   PERSON_ACTION_FRUIT,           $00,    $00,    %0000 ; SPRITEMOVEDATA_FRUIT
