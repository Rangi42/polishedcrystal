...
; entries correspond to SPRITEMOVEDATA_* constants
	...
	sprite_movement_data SPRITEMOVEFN_FOLLOWER_OBJ,          DOWN,   OBJECT_ACTION_STAND,       WONT_DELETE,    LOW_PRIORITY,    %0000 ; SPRITEMOVEDATA_FOLLOWEROBJ
	sprite_movement_data SPRITEMOVEFN_POKEBALL_OPENING,      DOWN,   OBJECT_ACTION_STAND,       WONT_DELETE | SLIDING | EMOTE_OBJECT,    HIGH_PRIORITY,    %0000 ; SPRITEMOVEDATA_POKEBALL_OPENING
	sprite_movement_data SPRITEMOVEFN_POKEBALL_CLOSING,      DOWN,   OBJECT_ACTION_STAND,       WONT_DELETE | SLIDING | EMOTE_OBJECT,    HIGH_PRIORITY,    %0000 ; SPRITEMOVEDATA_POKEBALL_CLOSING
