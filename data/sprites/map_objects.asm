...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER_HI,         DOWN,   PERSON_ACTION_RAIL_UPPER_HI,   $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER_HI
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER_LO,         DOWN,   PERSON_ACTION_RAIL_UPPER_LO,   $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER_LO
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER_HI,         DOWN,   PERSON_ACTION_RAIL_LOWER_HI,   $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER_HI
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER_LO,         DOWN,   PERSON_ACTION_RAIL_LOWER_LO,   $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER_LO
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER_HI_FLIP,    DOWN,   PERSON_ACTION_RAIL_UPPER_HI_FLIP, $80, $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER_HI_FLIP
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER_LO_FLIP,    DOWN,   PERSON_ACTION_RAIL_UPPER_LO_FLIP, $80, $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER_LO_FLIP
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER_HI_FLIP,    DOWN,   PERSON_ACTION_RAIL_LOWER_HI_FLIP, $80, $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER_HI_FLIP
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER_LO_FLIP,    DOWN,   PERSON_ACTION_RAIL_LOWER_LO_FLIP, $80, $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER_LO_FLIP
	sprite_movement_data SPRITEMOVEFN_EDGE_HI,               DOWN,   PERSON_ACTION_EDGE_HI,         $80,    $01,    %0000 ; SPRITEMOVEDATA_EDGE_HI
	sprite_movement_data SPRITEMOVEFN_EDGE_LO,               DOWN,   PERSON_ACTION_EDGE_LO,         $80,    $01,    %0000 ; SPRITEMOVEDATA_EDGE_LO
