...
SpriteMovementData::
	...
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER,            DOWN,   PERSON_ACTION_RAIL_UPPER,      $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER,            DOWN,   PERSON_ACTION_RAIL_LOWER,      $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER
	sprite_movement_data SPRITEMOVEFN_RAIL_UPPER_FLIP,       DOWN,   PERSON_ACTION_RAIL_UPPER_FLIP, $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_UPPER_FLIP
	sprite_movement_data SPRITEMOVEFN_RAIL_LOWER_FLIP,       DOWN,   PERSON_ACTION_RAIL_LOWER_FLIP, $80,    $02,    %0000 ; SPRITEMOVEDATA_RAIL_LOWER_FLIP
	sprite_movement_data SPRITEMOVEFN_EDGE,                  DOWN,   PERSON_ACTION_EDGE,            $80,    $01,    %0000 ; SPRITEMOVEDATA_EDGE
	sprite_movement_data SPRITEMOVEFN_ARCH_LEFT,             DOWN,   PERSON_ACTION_ARCH_LEFT,       $80,    $02,    %0000 ; SPRITEMOVEDATA_ARCH_LEFT
	sprite_movement_data SPRITEMOVEFN_ARCH_RIGHT,            DOWN,   PERSON_ACTION_ARCH_RIGHT,      $80,    $02,    %0000 ; SPRITEMOVEDATA_ARCH_RIGHT
	sprite_movement_data SPRITEMOVEFN_RAIL_LEFT,             DOWN,   PERSON_ACTION_RAIL_LEFT,       $80,    $02,    %1000 ; SPRITEMOVEDATA_RAIL_LEFT
	sprite_movement_data SPRITEMOVEFN_RAIL_RIGHT,            DOWN,   PERSON_ACTION_RAIL_RIGHT,      $80,    $02,    %1000 ; SPRITEMOVEDATA_RAIL_RIGHT
