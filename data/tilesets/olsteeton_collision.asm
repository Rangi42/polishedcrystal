	...
	tilecoll HEADBUTT_TREE, WALL, FLOOR, FLOOR ; 37
	...
	tilecoll WATER, WATER, WALL, WALL ; cc
	...
	tilecoll FLOOR, WALL, FLOOR, FLOOR ; d2
	...
	tilecoll WALL, LEDGE_DOWN_LEFT, WALL, WALL ; e1
